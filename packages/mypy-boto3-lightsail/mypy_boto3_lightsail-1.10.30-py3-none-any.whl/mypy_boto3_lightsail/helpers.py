...
def get_get_cloud_formation_stack_records_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_cloud_formation_stack_records')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_export_snapshot_records_paginator(client: Client) -> GetExportSnapshotRecordsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_instance_snapshots_paginator(client: Client) -> GetInstanceSnapshotsPaginator:
    """
...
def get_get_relational_database_blueprints_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_relational_database_blueprints')`, returns a correct
    type.
    """
...
def get_get_relational_database_parameters_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_relational_database_parameters')`, returns a correct
    type.
    """
...
def get_get_relational_database_snapshots_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_relational_database_snapshots')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_relational_databases_paginator(client: Client) -> GetRelationalDatabasesPaginator:
    """
