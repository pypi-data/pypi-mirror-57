...
Mypy-friendly auto-generated type annotations for `boto3 cognito-sync 1.10.33` service.
...
client: cognito_sync.Client = boto3.client("cognito-sync")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: cognito_sync.Client = session.client("cognito-sync")
