...
class Test(unittest.TestCase):
    ...
    def test_write_comments(self):
        ...
        self.assertEqual(ts._comments.loc[1, "from"], comments1.loc[1, "from"])
        self.assertEqual(ts._comments.loc[1, "until"], comments2.loc[1, "until"])
        self.assertEqual(ts._comments.loc[2, "from"], comments2.loc[2, "from"])
        self.assertEqual(ts._comments.loc[2, "until"], comments1.loc[2, "until"])
