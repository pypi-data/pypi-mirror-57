...
from .common import (CopiedTableWarning, MixedTypeWarning,
                     _raise_must_compute_error, default_session)
...
from .utils import (ORCA_COLUMN_NAME_FORMAT, ORCA_INDEX_NAME_FORMAT,
                    _infer_axis, _infer_level, _merge_where_expr,
                    ...
                    dolphindb_numeric_types, is_dolphindb_identifier,
...
class DataFrame(DataFrameLike, _Frame, IOOpsMixin):
    ...
    def merge(self, right, how='inner', on=None, left_on=None, right_on=None,
        ...
        if left_index and not right_index:
            select_list = itertools.chain(
                (f"tmp2.{col} as {col}" for col in right_ref._index_columns),
    ...
    def droplevel(self, level, axis=0):
        ...
        _, __, __, level_idx = _infer_level(level, self._index_map)
