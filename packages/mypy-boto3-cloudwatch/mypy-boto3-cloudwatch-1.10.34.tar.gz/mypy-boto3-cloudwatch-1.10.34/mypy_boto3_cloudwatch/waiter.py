...
class AlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [alarm_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudwatch.html#CloudWatch.Waiter.alarm_exists.wait)
        """
