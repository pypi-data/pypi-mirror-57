...
def setup_terrier():
    if not os.path.isfile("terrier-assemblies-5.1-jar-with-dependencies.jar"):
        print('JAR file not found, downloading')
        url = 'terrier-assemblies-5.1-jar-with-dependencies.jar'
        wget.download(url, '.')
    # import jnius_config
    # jnius_config.add_classpath("./terrier-assemblies-5.1-jar-with-dependencies.jar")
    # from jnius import autoclass, cast
