...
setup(
    ...
    description="Type annotations for boto3.RDSDataService 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 rds-data type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
