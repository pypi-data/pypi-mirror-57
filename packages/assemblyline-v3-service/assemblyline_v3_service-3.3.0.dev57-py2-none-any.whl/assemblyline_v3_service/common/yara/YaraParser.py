...
class YaraParser(object):
    ...
    VALID_YARA_VERSION = ["1.6", "1.7", "2.0", "2.1", "3.0", "3.1", "3.2", "3.3", "3.4", "3.5", "3.6", "3.7", "3.8.1"]
    ...
    YARA_MODULES = {"1.6": [],
                    ...
                    "3.8.1": ["pe", "cuckoo", "magic", "math", "hash", "elf", "dotnet"]}

    CURRENT_YARA_VERSION = "3.8.1"
        ...
        for line in data.splitlines():
            ...
            if not line.startswith("//") and not self.in_meta and not self.in_strings:
                ...
                if self.got_open and self.open_bracket == 0:
                    ...
                    yara_version = self.cur_rule.get('meta', {}).get('yara_version', "3.8.1")
