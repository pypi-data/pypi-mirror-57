...
def parse_includes(include_str):
    return include_str.split(",")
...
def run_metaexp(name, config):
    ...
    includes = parse_includes(config['includes']) if 'includes' in config else []
