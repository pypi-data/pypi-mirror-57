...
Mypy-friendly auto-generated type annotations for `boto3 cloudhsmv2 1.10.34` service.
...
client: cloudhsmv2.Client = boto3.client("cloudhsmv2")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: cloudhsmv2.Client = session.client("cloudhsmv2")
