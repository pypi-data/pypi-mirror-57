...
setup(
    ...
    description="Type annotations for boto3.IoT 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 iot type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
