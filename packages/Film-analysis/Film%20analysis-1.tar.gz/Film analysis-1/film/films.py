...
num_films = 100
rating_df = pd.read_csv("rating.tsv", sep = '\t')
directors_df = pd.read_csv("directors.tsv", sep = '\t')
titles_df = pd.read_csv("title_basics.tsv", sep = '\t', dtype={"startYear": object, "endYear": object})
names_df = pd.read_csv("names.tsv", sep = '\t')
