...
@LastEditTime: 2019-11-03 13:53:53
...
def parse_plot_density_for_CDS_metagene():
	...
	(data,in_regionLengthParma,in_extendRegionLengthParma,output_prefix,group_names,replicate_names,output_format,ymin,ymax,unit,axvline,start,window,step,slideWindow,CI,mode)=(options.density_file,
	...
	options.output_format,options.ymin,options.ymax,options.unit,options.axvline,options.start_position,options.window,options.step,options.slideWindow,options.CI,options.mode)
	if window%2 == 0:
