...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_assessment_run_agents_paginator(client: Client) -> ListAssessmentRunAgentsPaginator:
    """
...
def get_list_assessment_runs_paginator(client: Client) -> ListAssessmentRunsPaginator:
    ...
    """
    return client.get_paginator("list_assessment_runs")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_assessment_targets_paginator(client: Client) -> ListAssessmentTargetsPaginator:
    """
    Equivalent of `client.get_paginator('list_assessment_targets')`, returns a correct type.
    """
    return client.get_paginator("list_assessment_targets")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_assessment_templates_paginator(client: Client) -> ListAssessmentTemplatesPaginator:
    """
    Equivalent of `client.get_paginator('list_assessment_templates')`, returns a correct type.
    """
    return client.get_paginator("list_assessment_templates")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_event_subscriptions_paginator(client: Client) -> ListEventSubscriptionsPaginator:
    """
    Equivalent of `client.get_paginator('list_event_subscriptions')`, returns a correct type.
    """
    return client.get_paginator("list_event_subscriptions")
...
def get_list_exclusions_paginator(client: Client) -> ListExclusionsPaginator:
    ...
    """
    return client.get_paginator("list_exclusions")
...
def get_list_rules_packages_paginator(client: Client) -> ListRulesPackagesPaginator:
    ...
    """
    return client.get_paginator("list_rules_packages")
...
def get_preview_agents_paginator(client: Client) -> PreviewAgentsPaginator:
    ...
    """
    return client.get_paginator("preview_agents")
