...
def get_describe_aggregate_compliance_by_config_rules_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_aggregate_compliance_by_config_rules')`, returns a
    correct type.
    """
...
def get_describe_aggregation_authorizations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_aggregation_authorizations')`, returns a correct
    type.
    """
...
def get_describe_compliance_by_config_rule_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_compliance_by_config_rule')`, returns a correct
    type.
    """
...
def get_describe_config_rule_evaluation_status_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_config_rule_evaluation_status')`, returns a
    correct type.
    """
...
def get_describe_configuration_aggregator_sources_status_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_configuration_aggregator_sources_status')`,
...
def get_describe_configuration_aggregators_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_configuration_aggregators')`, returns a correct
    type.
    """
...
def get_describe_pending_aggregation_requests_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_pending_aggregation_requests')`, returns a correct
    type.
    """
...
def get_describe_remediation_execution_status_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_remediation_execution_status')`, returns a correct
    type.
    """
...
def get_describe_retention_configurations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_retention_configurations')`, returns a correct
    type.
    """
...
def get_get_aggregate_compliance_details_by_config_rule_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_aggregate_compliance_details_by_config_rule')`, returns
    a correct type.
    """
...
def get_get_compliance_details_by_config_rule_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_compliance_details_by_config_rule')`, returns a correct
    type.
    """
...
def get_get_compliance_details_by_resource_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_compliance_details_by_resource')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_resource_config_history_paginator(client: Client) -> GetResourceConfigHistoryPaginator:
    """
...
def get_list_aggregate_discovered_resources_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_aggregate_discovered_resources')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_discovered_resources_paginator(client: Client) -> ListDiscoveredResourcesPaginator:
    """
