...
Mypy-friendly auto-generated type annotations for `boto3 codestar-notifications 1.10.34` service.
...
client: codestar_notifications.Client = boto3.client("codestar-notifications")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: codestar_notifications.Client = session.client("codestar-notifications")
