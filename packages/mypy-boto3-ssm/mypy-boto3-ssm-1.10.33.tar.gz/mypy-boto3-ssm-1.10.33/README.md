...
Mypy-friendly auto-generated type annotations for `boto3 ssm 1.10.33` service.
...
client: ssm.Client = boto3.client("ssm")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: ssm.Client = session.client("ssm")
