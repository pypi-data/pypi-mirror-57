...
# TODO: [#C] Ensure the DAG model also appears in the API documentation,
#            Add something like, marshall_with to DagCollection.get
# TODO: [#C] Remove 'message' field from Flask-RestPlus error response. See also:
#            https://github.com/noirbizarre/flask-restplus/pull/377
...
class DagRunCollection(Resource):
    ...
    def post(self, dag_id):
        try:
            ...
            log.info("Info %s", json.dumps(payload))
