...
class BatchPredictionAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [batch_prediction_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/machinelearning.html#MachineLearning.Waiter.batch_prediction_available.wait)
        """
...
class DataSourceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [data_source_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/machinelearning.html#MachineLearning.Waiter.data_source_available.wait)
        """
...
class EvaluationAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [evaluation_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/machinelearning.html#MachineLearning.Waiter.evaluation_available.wait)
        """
...
class MLModelAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ml_model_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/machinelearning.html#MachineLearning.Waiter.ml_model_available.wait)
        """
