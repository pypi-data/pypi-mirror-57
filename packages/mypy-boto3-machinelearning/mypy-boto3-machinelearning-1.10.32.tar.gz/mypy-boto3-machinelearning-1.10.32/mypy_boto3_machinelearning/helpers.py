...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_batch_predictions_paginator(client: Client) -> DescribeBatchPredictionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_batch_prediction_available_waiter(client: Client) -> BatchPredictionAvailableWaiter:
    """
