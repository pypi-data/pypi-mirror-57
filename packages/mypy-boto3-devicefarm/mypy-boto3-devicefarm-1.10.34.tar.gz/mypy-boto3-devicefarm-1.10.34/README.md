...
Mypy-friendly auto-generated type annotations for `boto3 devicefarm 1.10.34` service.
...
client: devicefarm.Client = boto3.client("devicefarm")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: devicefarm.Client = session.client("devicefarm")
