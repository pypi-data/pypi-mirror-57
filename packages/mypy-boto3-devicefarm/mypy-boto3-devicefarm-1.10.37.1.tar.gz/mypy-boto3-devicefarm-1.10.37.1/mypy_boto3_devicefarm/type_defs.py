...
DeviceSelectionConfigurationTypeDef = TypedDict(
    "DeviceSelectionConfigurationTypeDef", {"filters": List[DeviceFilterTypeDef], "maxDevices": int}
)
...
GetDeviceResultTypeDef = TypedDict("GetDeviceResultTypeDef", {"device": DeviceTypeDef}, total=False)
...
GetUploadResultTypeDef = TypedDict("GetUploadResultTypeDef", {"upload": UploadTypeDef}, total=False)
