...
class StreamExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stream_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/kinesis.html#Kinesis.Waiter.stream_exists.wait)
        """
...
class StreamNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stream_not_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/kinesis.html#Kinesis.Waiter.stream_not_exists.wait)
        """
