...
Mypy-friendly auto-generated type annotations for `boto3 polly 1.10.33` service.
...
client: polly.Client = boto3.client("polly")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: polly.Client = session.client("polly")
