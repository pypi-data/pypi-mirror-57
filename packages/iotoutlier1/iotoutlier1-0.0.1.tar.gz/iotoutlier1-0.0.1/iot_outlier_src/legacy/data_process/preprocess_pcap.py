...
sys.path.append(path.dirname(path.dirname(path.abspath(__file__))))  # add project path to sys path.
...
from utils.tool import check_n_generate_path, execute_time, pprint
