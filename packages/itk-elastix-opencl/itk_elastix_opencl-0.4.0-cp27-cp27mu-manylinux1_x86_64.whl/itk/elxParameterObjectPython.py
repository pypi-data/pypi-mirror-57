...
class elastixParameterObject(ITKCommonBasePython.itkDataObject):
    ...
    def WriteParameterFile(self, *args):
        """
...
def elastixParameterObject___New_orig__():
    """elastixParameterObject___New_orig__() -> elastixParameterObject_Pointer"""
    return _elxParameterObjectPython.elastixParameterObject___New_orig__()

def elastixParameterObject_GetDefaultParameterMap(transformName, numberOfResolutions=4, finalGridSpacingInPhysicalUnits=10.):
    """
    GetDefaultParameterMap(std::string const & transformName, unsigned int const & numberOfResolutions=4, double const & finalGridSpacingInPhysicalUnits=10.) -> std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > const
    GetDefaultParameterMap(std::string const & transformName, unsigned int const & numberOfResolutions=4) -> std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > const
...
def elastixParameterObject_cast(obj):
