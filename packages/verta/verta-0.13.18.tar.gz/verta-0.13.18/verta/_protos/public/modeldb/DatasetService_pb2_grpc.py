...
class DatasetServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.deleteDatasets = channel.unary_unary(
        '/com.mitdbg.modeldb.DatasetService/deleteDatasets',
        request_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.DeleteDatasets.SerializeToString,
        response_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.DeleteDatasets.Response.FromString,
        )
...
def add_DatasetServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'deleteDatasets': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.DeleteDatasets.FromString,
          response_serializer=protos_dot_public_dot_modeldb_dot_DatasetService__pb2.DeleteDatasets.Response.SerializeToString,
      ),
