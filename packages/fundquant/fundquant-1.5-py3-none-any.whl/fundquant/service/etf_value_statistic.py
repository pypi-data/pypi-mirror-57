...
class EtfStatistic:
    def __init__(self, etf_tack: EtfTrackConfig):
        ...
        self.pe_less_prob_10y_3m_ago = None
    ...
    def compute(self):
        ...
        pe_less_prob_10y_3m_ago = len(pe_df[pe_df['pe'] <= pe_df.iloc[-66]['pe']]) / len(pe_df)
        ...
        self.pe_less_prob_10y_3m_ago = round(pe_less_prob_10y_3m_ago * 100, 1)
