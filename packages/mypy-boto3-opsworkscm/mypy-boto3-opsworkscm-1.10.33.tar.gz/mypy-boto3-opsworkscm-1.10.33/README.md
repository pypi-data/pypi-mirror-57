...
Mypy-friendly auto-generated type annotations for `boto3 opsworkscm 1.10.33` service.
...
client: opsworkscm.Client = boto3.client("opsworkscm")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: opsworkscm.Client = session.client("opsworkscm")
