...
class RpmPackageCategory(object):
    ...
    def __init__(self, id=None, name=None, description=None, display_order=None, group_ids=None, desc_by_lang=None, name_by_lang=None, digest=None, packagegroups=None, local_vars_configuration=None):  # noqa: E501
