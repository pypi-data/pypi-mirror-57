...
setup(
    ...
    description="Type annotations for boto3.Neptune 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 neptune type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
