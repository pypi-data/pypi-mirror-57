...
Mypy-friendly auto-generated type annotations for `boto3 neptune 1.10.33` service.
...
client: neptune.Client = boto3.client("neptune")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: neptune.Client = session.client("neptune")
