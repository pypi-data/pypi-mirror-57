...
setup(
    ...
    description="Type annotations for boto3.PI 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 pi type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
