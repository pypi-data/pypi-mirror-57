...
Mypy-friendly auto-generated type annotations for `boto3 qldb-session 1.10.33` service.
...
client: qldb_session.Client = boto3.client("qldb-session")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: qldb_session.Client = session.client("qldb-session")
