...
packages = \
['non_admin_draftail',
 'non_admin_draftail.static_src.node_modules.node-gyp.gyp.pylib.gyp',
 'non_admin_draftail.static_src.node_modules.node-gyp.gyp.pylib.gyp.generator']
...
{'': ['*'],
 'non_admin_draftail': ['static/non_admin_draftail/draftail/*',
                        ...
                        'static_src/.babelrc',
                        'static_src/.babelrc',
                        'static_src/.gitignore',
                        'static_src/.gitignore',
                        'static_src/.gitignore',
                        'static_src/.gitignore',
                        'static_src/.gitignore',
                        'static_src/README.md',
                        'static_src/README.md',
                        'static_src/README.md',
                        'static_src/README.md',
                        'static_src/README.md',
                        'static_src/package-lock.json',
                        'static_src/package-lock.json',
                        'static_src/package-lock.json',
                        'static_src/package-lock.json',
                        'static_src/package-lock.json',
                        ...
                        'static_src/src/index.js',
                        'static_src/src/sources/*',
