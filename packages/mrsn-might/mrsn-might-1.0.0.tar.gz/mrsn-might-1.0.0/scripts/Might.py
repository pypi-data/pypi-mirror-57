...
from amr_methods import amr_precheck, ariba_run, amrfinderplus_run, summarize_amr_finder_output
from assembly_methods import assembly_precheck, adapter_trimming, run_unicycler_assembly, assembly_file_formatting, \
    filter_long_reads
from database_methods import database_check
from kraken_methods import kraken2_precheck, run_kraken2
from miscellaneous import parse_arguments, compression_handler, file_check, ascii_art
