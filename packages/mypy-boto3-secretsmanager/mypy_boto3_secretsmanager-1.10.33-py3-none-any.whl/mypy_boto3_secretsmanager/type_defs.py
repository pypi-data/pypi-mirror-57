...
ListSecretsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSecretsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSecretsPaginateResponseSecretListRotationRulesTypeDef = TypedDict(
    "ListSecretsPaginateResponseSecretListRotationRulesTypeDef",
    {"AutomaticallyAfterDays": int},
    total=False,
)

ListSecretsPaginateResponseSecretListTagsTypeDef = TypedDict(
    "ListSecretsPaginateResponseSecretListTagsTypeDef", {"Key": str, "Value": str}, total=False
)

ListSecretsPaginateResponseSecretListTypeDef = TypedDict(
...
ListSecretsPaginateResponseTypeDef = TypedDict(
