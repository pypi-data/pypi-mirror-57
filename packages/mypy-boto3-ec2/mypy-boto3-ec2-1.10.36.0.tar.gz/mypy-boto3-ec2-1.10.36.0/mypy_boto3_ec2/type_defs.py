...
EgressOnlyInternetGatewayTypeDef = TypedDict(
    ...
    {"Attachments": List[InternetGatewayAttachmentTypeDef], "EgressOnlyInternetGatewayId": str},
    total=False,
)
...
LaunchTemplateElasticInferenceAcceleratorResponseTypeDef = TypedDict(
    "LaunchTemplateElasticInferenceAcceleratorResponseTypeDef", {"Type": str}, total=False
)
...
KeyPairInfoTypeDef = TypedDict(
    "KeyPairInfoTypeDef", {"KeyFingerprint": str, "KeyName": str}, total=False
)
...
ElasticInferenceAcceleratorTypeDef = TypedDict("ElasticInferenceAcceleratorTypeDef", {"Type": str})
...
KeyPairTypeDef = TypedDict(
    "KeyPairTypeDef", {"KeyFingerprint": str, "KeyMaterial": str, "KeyName": str}, total=False
)
...
LaunchTemplateElasticInferenceAcceleratorTypeDef = TypedDict(
    "LaunchTemplateElasticInferenceAcceleratorTypeDef", {"Type": str}
)
