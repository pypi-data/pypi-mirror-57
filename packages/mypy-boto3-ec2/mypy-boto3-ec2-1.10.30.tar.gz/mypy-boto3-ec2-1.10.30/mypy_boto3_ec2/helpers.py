...
def get_describe_client_vpn_authorization_rules_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_client_vpn_authorization_rules')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_client_vpn_routes_paginator(client: Client) -> DescribeClientVpnRoutesPaginator:
    """
...
def get_describe_client_vpn_target_networks_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_client_vpn_target_networks')`, returns a correct
    type.
    """
...
def get_describe_egress_only_internet_gateways_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_egress_only_internet_gateways')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_export_image_tasks_paginator(client: Client) -> DescribeExportImageTasksPaginator:
    """
...
def get_describe_host_reservation_offerings_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_host_reservation_offerings')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_host_reservations_paginator(client: Client) -> DescribeHostReservationsPaginator:
    """
...
def get_describe_iam_instance_profile_associations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_iam_instance_profile_associations')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_import_image_tasks_paginator(client: Client) -> DescribeImportImageTasksPaginator:
    """
...
def get_describe_instance_credit_specifications_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_instance_credit_specifications')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_instance_status_paginator(client: Client) -> DescribeInstanceStatusPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_internet_gateways_paginator(client: Client) -> DescribeInternetGatewaysPaginator:
    """
...
def get_describe_launch_template_versions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_launch_template_versions')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_launch_templates_paginator(client: Client) -> DescribeLaunchTemplatesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_moving_addresses_paginator(client: Client) -> DescribeMovingAddressesPaginator:
    """
...
def get_describe_network_interface_permissions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_network_interface_permissions')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_network_interfaces_paginator(client: Client) -> DescribeNetworkInterfacesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_public_ipv4_pools_paginator(client: Client) -> DescribePublicIpv4PoolsPaginator:
    """
...
def get_describe_reserved_instances_modifications_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_reserved_instances_modifications')`, returns a
    correct type.
    """
...
def get_describe_reserved_instances_offerings_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_reserved_instances_offerings')`, returns a correct
    type.
    """
...
def get_describe_scheduled_instance_availability_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_scheduled_instance_availability')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_security_groups_paginator(client: Client) -> DescribeSecurityGroupsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_spot_price_history_paginator(client: Client) -> DescribeSpotPriceHistoryPaginator:
    """
...
def get_describe_traffic_mirror_sessions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_traffic_mirror_sessions')`, returns a correct
    type.
    """
...
def get_describe_transit_gateway_attachments_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_transit_gateway_attachments')`, returns a correct
    type.
    """
...
def get_describe_transit_gateway_route_tables_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_transit_gateway_route_tables')`, returns a correct
    type.
    """
...
def get_describe_transit_gateway_vpc_attachments_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_transit_gateway_vpc_attachments')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_transit_gateways_paginator(client: Client) -> DescribeTransitGatewaysPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_volume_status_paginator(client: Client) -> DescribeVolumeStatusPaginator:
    """
...
def get_describe_vpc_classic_link_dns_support_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_classic_link_dns_support')`, returns a correct
    type.
    """
...
def get_describe_vpc_endpoint_connection_notifications_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_endpoint_connection_notifications')`, returns
    a correct type.
    """
...
def get_describe_vpc_endpoint_connections_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_endpoint_connections')`, returns a correct
    type.
    """
...
def get_describe_vpc_endpoint_service_configurations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_endpoint_service_configurations')`, returns a
    correct type.
    """
...
def get_describe_vpc_endpoint_service_permissions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_endpoint_service_permissions')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_vpc_endpoints_paginator(client: Client) -> DescribeVpcEndpointsPaginator:
    """
...
def get_describe_vpc_peering_connections_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_vpc_peering_connections')`, returns a correct
    type.
    """
...
def get_get_transit_gateway_attachment_propagations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_transit_gateway_attachment_propagations')`, returns a
    correct type.
    """
...
def get_get_transit_gateway_route_table_associations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_transit_gateway_route_table_associations')`, returns a
    correct type.
    """
...
def get_get_transit_gateway_route_table_propagations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('get_transit_gateway_route_table_propagations')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_conversion_task_cancelled_waiter(client: Client) -> ConversionTaskCancelledWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_conversion_task_completed_waiter(client: Client) -> ConversionTaskCompletedWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_customer_gateway_available_waiter(client: Client) -> CustomerGatewayAvailableWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_network_interface_available_waiter(client: Client) -> NetworkInterfaceAvailableWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_vpc_peering_connection_deleted_waiter(client: Client) -> VpcPeeringConnectionDeletedWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_vpc_peering_connection_exists_waiter(client: Client) -> VpcPeeringConnectionExistsWaiter:
    """
