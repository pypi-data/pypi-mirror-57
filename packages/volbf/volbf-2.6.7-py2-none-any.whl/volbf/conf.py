...
class ConfObject(object):
    ...
    def __getattr__(self, attr):
        ...
        try:
            return os.environ["volbf_" + attr.upper()]
        except KeyError:
            pass
...
if os.access(default_config, os.R_OK):
    ...
    config.add_file("volbfrc")

default_conf_path = ".volbfrc"
try:
    default_conf_path = os.environ['HOME'] + '/.volbfrc'
except KeyError:
    pass
