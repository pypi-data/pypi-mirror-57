...
import volbf.plugins as plugins
...
import volbf.plugins.addrspaces.amd64 as amd64
import volbf.plugins.addrspaces.intel as intel
...
class volbfMacIntelValidAS(obj.volbfMagic):
...
class MacObjectClasses(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.object_classes.update({
            'volbfDTB': volbfDTB,
            'volbfMacIntelValidAS' : volbfMacIntelValidAS,
            'proc'  : proc,
            'thread'  : thread,
...
mac_overlay = {
    'volbf_MAGIC': [None, {
        ...
        'IA32ValidAS'   : [ 0x0, ['volbfMacIntelValidAS']],
        'AMD64ValidAS'  : [ 0x0, ['volbfMacIntelValidAS']],
        }],
