...
import volbf.timefmt as timefmt
...
class volbf_MAGIC(obj.CType):
    """Class representing a volbf_MAGIC namespace
...
class volbfMaxAddress(obj.volbfMagic):
    ...
    We use a volbfMagic to calculate this 
...
class BasicObjectClasses(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.object_classes.update({
            ...
            'volbf_MAGIC': volbf_MAGIC,
            'volbfDTB': volbfDTB,
            'UnixTimeStamp': UnixTimeStamp,
            'volbfMaxAddress': volbfMaxAddress,
            })

        profile.merge_overlay({'volbf_MAGIC': [None, {
            'MaxAddress': [0x0, ['volbfMaxAddress']],
            }]})
