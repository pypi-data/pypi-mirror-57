...
import volbf.constants as constants
import volbf.utils as utils
import volbf.debug as debug #pylint: disable-msg=W0611
import volbf.addrspace as addrspace
import volbf.plugins.malware.malfind as malfind
import volbf.plugins.overlays.windows.pe_vtypes as pe_vtypes
import volbf.plugins.overlays.windows.ssdt_vtypes as ssdt_vtypes
import volbf.plugins.overlays.windows.win7 as win7
import volbf.plugins.overlays.windows.vista as vista
...
class Win8KDBG(windows.AbstractKDBGMod):
    ...
    def modification(self, profile):
        ...
        profile.merge_overlay({
            'volbf_MAGIC': [ None, {
            'KDBGHeader': [ None, ['volbfMagic', dict(value = signature)]]
            }]})
...
class Win8x86DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.merge_overlay({
            'volbf_MAGIC': [ None, {
            'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\x28\x00")]],
            }]})
...
class Win8x64MaxCommit(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.merge_overlay({
            'volbf_MAGIC': [ 0x0, {
            'MM_MAX_COMMIT': [ 0x0, ['volbfMagic', dict(value = 0x7fffffff)]],
             }]})
...
class Win8x64DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.merge_overlay({
            'volbf_MAGIC': [ None, {
            'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\xb2\x00")]],
            }]})
...
class Win8SP0x64(obj.Profile):
    ...
    _md_minor = 2
    _md_build = 9200
    _md_vtype_module = 'volbf.plugins.overlays.windows.win8_sp0_x64_vtypes'
...
class Win8SP1x64(obj.Profile):
    ...
    _md_minor = 3
    _md_build = 9600
    _md_vtype_module = 'volbf.plugins.overlays.windows.win8_sp1_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win8SP1x64_18340(obj.Profile):
    ...
    _md_minor = 3
    _md_build = 9600
    _md_vtype_module = 'volbf.plugins.overlays.windows.win8_sp1_x64_54B5A1C6_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win8SP0x86(obj.Profile):
    ...
    _md_minor = 2
    _md_build = 9200
    _md_vtype_module = 'volbf.plugins.overlays.windows.win8_sp0_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win8SP1x86(obj.Profile):
    ...
    _md_minor = 3
    _md_build = 9600
    _md_vtype_module = 'volbf.plugins.overlays.windows.win8_sp1_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win81U1x64(obj.Profile):
    ...
    _md_minor = 3
    _md_build = 17031 
    _md_vtype_module = 'volbf.plugins.overlays.windows.win81_u1_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win81U1x86(obj.Profile):
    ...
    _md_minor = 3
    _md_build = 17031 
    _md_vtype_module = 'volbf.plugins.overlays.windows.win81_u1_x86_vtypes'
    _md_product = ["NtProductWinNt"]
