...
class XPOverlay(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        ...
                        'KDBGHeader'   : [ None, ['volbfMagic', dict(value = '\x00\x00\x00\x00\x00\x00\x00\x00KDBG\x90\x02')]],
...
class WinXPSP2x86(obj.Profile):
    ...
    _md_vtype_module = 'volbf.plugins.overlays.windows.xp_sp2_x86_vtypes'
...
class WinXPSP3x86(obj.Profile):
    ...
    _md_os = 'windows'
    _md_memory_model = '32bit'
    _md_vtype_module = 'volbf.plugins.overlays.windows.xp_sp3_x86_vtypes'
    _md_product = ["NtProductWinNt"]
