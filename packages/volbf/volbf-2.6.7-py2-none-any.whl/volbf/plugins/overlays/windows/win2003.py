...
class Win2003x86Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x2)]],
...
class Win2003SP0x86DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'DTBSignature': [ None, ['volbfMagic', dict(value = "\x03\x00\x1b\x00")]]}
                                        ]}
        profile.merge_overlay(overlay)
...
class Win2003x86DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'DTBSignature': [ None, ['volbfMagic', dict(value = "\x03\x00\x1e\x00")]]}
                                        ]}
        profile.merge_overlay(overlay)
...
class Win2003x64DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        ...
                        'DTBSignature': [ None, ['volbfMagic', dict(value = "\x03\x00\x2e\x00")]]}
                                        ]}
        profile.merge_overlay(overlay)
...
class Win2003SP0x86(obj.Profile):
    ...
    _md_vtype_module = 'volbf.plugins.overlays.windows.win2003_sp0_x86_vtypes'
...
class Win2003SP1x86(obj.Profile):
    ...
    _md_build = 3790
    _md_memory_model = '32bit'
    _md_vtype_module = 'volbf.plugins.overlays.windows.win2003_sp1_x86_vtypes'
    _md_product = ["NtProductLanManNt", "NtProductServer"]
...
class Win2003SP2x86(obj.Profile):
    ...
    _md_build = 3791 
    _md_memory_model = '32bit'
    _md_vtype_module = 'volbf.plugins.overlays.windows.win2003_sp2_x86_vtypes'
    _md_product = ["NtProductLanManNt", "NtProductServer"]
...
class Win2003SP1x64(obj.Profile):
    ...
    _md_minor = 2
    _md_build = 3790
    _md_vtype_module = 'volbf.plugins.overlays.windows.win2003_sp1_x64_vtypes'
    _md_product = ["NtProductLanManNt", "NtProductServer"]
...
class Win2003SP2x64(obj.Profile):
    ...
    # This is a fake build number. See the comment in Win2003SP0x86
    _md_build = 3791
    _md_vtype_module = 'volbf.plugins.overlays.windows.win2003_sp2_x64_vtypes'
    _md_product = ["NtProductLanManNt", "NtProductServer"]
