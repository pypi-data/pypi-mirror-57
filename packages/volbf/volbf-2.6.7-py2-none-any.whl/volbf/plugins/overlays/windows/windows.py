...
import volbf.plugins.kpcrscan as kpcr
import volbf.plugins.kdbgscan as kdbg
...
import volbf.plugins.vadinfo as vadinfo
...
windows_overlay = {
    ...
    'DTBSignature' : [ 0x0, ['volbfMagic', dict(value = "volbf DTBSignature unspecified")]],
    'KUSER_SHARED_DATA' : [ 0x0, ['volbfMagic', dict(value = 0xFFDF0000)]],
    'KDBGHeader' : [ 0x0, ['volbfMagic', dict(value = 'volbf KDBGHeader unspecified')]],
    # Configuration options
    'DTB' : [ 0x0, ['volbfDTB', dict(configname = "DTB")]],
    'KPCR' : [ 0x0, ['volbfMagic', dict(value = 0xffdff000, configname = "KPCR")]],
    'KDBG' : [ 0x0, ['volbfKDBG', dict(configname = "KDBG")]],
    'IA32ValidAS': [ 0x0, ['volbfIA32ValidAS']],
    'AMD64ValidAS': [ 0x0, ['volbfAMD64ValidAS']],
    # Pool allocations are aligned to this many bytes.
    'PoolAlignment': [0x0, ['volbfMagic', dict(value = 8)]],
    #hibrfil.sys values
    'HibrProcPage': [0x0, ['volbfMagic', dict(value = 0x0)]],
    'HibrEntryCount': [0x0, ['volbfMagic', dict(value = 0x0)]],
    'MM_MAX_COMMIT': [ 0x0, ['volbfMagic', dict(value = 0x7ffffffffffff)]],
    'PolicyKey': [0x0, ['volbfMagic', dict(value = "PolSecretEncryptionKey")]],
    }],
...
class _OBJECT_HEADER(obj.CType):
    """A volbf object to handle Windows object headers.
...
class volbfKPCR(obj.volbfMagic):
...
class volbfIA32ValidAS(obj.volbfMagic):
...
class volbfAMD64ValidAS(obj.volbfMagic):
    def generate_suggestions(self):
...
class WindowsObjectClasses(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.object_classes.update({
            ...
            'volbfKPCR': volbfKPCR,
            'volbfKDBG': volbfKDBG,
            'volbfIA32ValidAS': volbfIA32ValidAS,
            'volbfAMD64ValidAS': volbfAMD64ValidAS,
...
class VolMagicPoolTag(obj.volbfMagic):
