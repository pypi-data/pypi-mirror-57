...
# This causes the config.PLUGINS paths to be treated as extensions of the volbf.plugins package
# Meaning that each directory is search for module when import volbf.plugins.module is requested
