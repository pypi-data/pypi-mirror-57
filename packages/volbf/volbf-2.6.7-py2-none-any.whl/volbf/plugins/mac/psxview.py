...
import volbf.plugins.mac.pid_hash_table as pid_hash_table
import volbf.plugins.mac.pgrp_hash_table as pgrp_hash_table
import volbf.plugins.mac.session_hash_table as session_hash_table
