...
if sys.version_info < (2, 6, 0):
    sys.stderr.write("volbf requires python version 2.6, please upgrade your python installation.")
    sys.exit(1)
...
def main():
    ...
    sys.stderr.write("volbf Foundation volbf Framework {0}\n".format("2.6.7"))
    sys.stderr.flush()
    ...
    try:
        if module in cmds.keys():
            ...
            command.execute()
    except exceptions.volbfException, e:
        print e

if __name__ == "__main__":
    config.set_usage(usage = "volbf - A memory forensics analysis platform.")
