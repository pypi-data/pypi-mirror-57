...
def generate_profile(temp_dir, volbf_dir, profile_dir, profile):
    """Generate a profile. 

    @param temp_dir: temporary working directory
    @param volbf_dir: path to volbf installation 
    ...
    convert_py = os.path.join(volbf_dir, "tools/mac/convert.py")
