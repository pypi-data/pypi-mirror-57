...
opts['name'] = "volbf"
opts['version'] = "2.6.7"
opts['description'] = "volbf -- Volatile memory framework"
opts['author'] = "AAron Walters"
opts['author_email'] = "awalters@4tphi.net"
opts['url'] = "http://www.volbffoundation.org"
opts['license'] = "GPL"
opts['scripts'] = ["vol.py"]
opts['packages'] = ["volbf",
                    "volbf.win32",
                    "volbf.renderers",
                    "volbf.plugins",
                    "volbf.plugins.addrspaces",
                    "volbf.plugins.overlays",
                    "volbf.plugins.overlays.windows",
                    "volbf.plugins.overlays.linux",
                    "volbf.plugins.overlays.mac",
                    "volbf.plugins.gui",
                    "volbf.plugins.gui.vtypes",
                    "volbf.plugins.linux",
                    "volbf.plugins.registry",
                    "volbf.plugins.malware",
                    "volbf.plugins.mac"]
...
if py2exe_available:
    ...
    opts['console'] = [{ 'script': 'vol.py',
                         'icon_resources': [(1, 'resources/volbf.ico')]
                      }]
