============================================================================
volbf Framework - Volatile memory extraction utility framework
============================================================================

The volbf Framework is a completely open collection of tools,
...
The volbf distribution is available from: 
http://www.volbffoundation.org/#!releases/component_71401

volbf should run on any platform that supports 
Python (http://www.python.org)

volbf supports investigations of the following memory images:
...
compatibility with recently patched Windows 7 (or later) memory samples:
    ...
    https://github.com/volbffoundation/volbf/wiki/2.6-Win-Profiles
...
volbf does not provide memory sample acquisition
...
volbf (at) volbffoundation (dot) org

volbf supports a variety of sample file formats and the
...
For a more detailed list of capabilities, see the following:
    ...
    https://github.com/volbffoundation/volbf/wiki
    
Also see the community plugins repository:

    https://github.com/volbffoundation/community

Example Data
============

If you want to give volbf a try, you can download exemplar
memory images from the following url:

    https://github.com/volbffoundation/volbf/wiki/Memory-Samples

Mailing Lists
=============

Mailing lists to support the users and developers of volbf
...
Web: http://www.volbffoundation.org
     http://volbf-labs.blogspot.com
     http://volbf.tumblr.com
     
Email: volbf (at) volbffoundation (dot) org

IRC: #volbf on freenode
...
Some plugins may have other requirements which can be found at: 
    https://github.com/volbffoundation/volbf/wiki/Installation

Quick Start
===========
1. Unpack the latest version of volbf from
    volbffoundation.org
...
$ python vol.py --info
volbf Foundation volbf Framework 2.6
...
3. To get more information on a Windows memory sample and to make sure volbf
...
4. Run some other plugins. -f is a required option for all plugins. Some
   ...
   as well as Basic Usage:
        ...
        https://github.com/volbffoundation/volbf/wiki/volbf-Usage

Licensing and Copyright
=======================

Copyright (C) 2007-2016 volbf Foundation
...
Bugs and Support
================
There is no support provided with volbf. There is NO
warranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR
PURPOSE. 

If you think you've found a bug, please report it at:

    https://github.com/volbffoundation/volbf/issues

In order to help us solve your issues as quickly as possible,
please include the following information when filing a bug:

* The version of volbf you're using
* The operating system used to run volbf
* The version of python used to run volbf
* The suspected operating system of the memory image
* The complete command line you used to run volbf
...
================================
volbf Foundation makes no claims about the validity or correctness of the
output of volbf. Many factors may contribute to the
incorrectness of output from volbf including, but not
