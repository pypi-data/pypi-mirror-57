...
class VistaWin7KPCR(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                    'KPCR' : [ None, ['volbfKPCR', dict(configname = "KPCR")]],
                                          }]}
...
class Vistax86DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                    'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\x20\x00")]],
                                          }]}
        profile.merge_overlay(overlay)
...
class Vistax64DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                    'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\x30\x00")]],
                                          }]}
        profile.merge_overlay(overlay)
...
class VistaPolicyKey(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'PolicyKey': [0x0, ['volbfMagic', dict(value = "PolEKList")]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP0x86Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x4)]],
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0xff)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP1x86Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x1)]],
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0xff)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP2x86Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x1)]],
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0x1fe)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP0x64Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x4)]],
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0x7f)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP2x64Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        'HibrProcPage' : [ None, ['volbfMagic', dict(value = 0x1)]],
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0xfe)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class VistaSP0x86(obj.Profile):
    ...
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp0_x86_vtypes'
...
class VistaSP0x64(obj.Profile):
    ...
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp0_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class VistaSP1x86(obj.Profile):
    ...
    _md_memory_model = '32bit'
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp1_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class VistaSP1x64(obj.Profile):
    ...
    _md_memory_model = '64bit'
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp1_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class VistaSP2x86(obj.Profile):
    ...
    _md_memory_model = '32bit'
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp2_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class VistaSP2x64(obj.Profile):
    ...
    _md_memory_model = '64bit'
    _md_os = 'windows'
    _md_vtype_module = 'volbf.plugins.overlays.windows.vista_sp2_x64_vtypes'
    _md_product = ["NtProductWinNt"]
