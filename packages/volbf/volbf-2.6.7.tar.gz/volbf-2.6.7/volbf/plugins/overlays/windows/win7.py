...
class Win7x86DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                    'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\x26\x00")]],
                                          }]}
...
class Win7x64DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                    'DTBSignature' : [ None, ['volbfMagic', dict(value = "\x03\x00\x58\x00")]],
                                          }]}
        profile.merge_overlay(overlay)

class _OBJECT_HEADER(windows._OBJECT_HEADER):
    """A volbf object to handle Windows 7 object headers.
...
class Win7x86Hiber(obj.ProfileModification):
    ...
    def modification(self, profile):
        overlay = {'volbf_MAGIC': [ None, {
                        ...
                        'HibrEntryCount' : [ None, ['volbfMagic', dict(value = 0x1ff)]],
                                        }]}
        profile.merge_overlay(overlay)
...
class Win7SP0x86(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7600
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp0_x86_vtypes'
...
class Win7SP1x86(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP1x86_23418(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x86_BBA98F40_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP1x86_24000(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x86_24000_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP0x64(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7600
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp0_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP1x64(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x64_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP1x64_23418(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x64_632B36E0_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win7SP1x64_24000(obj.Profile):
    ...
    _md_minor = 1
    _md_build = 7601
    _md_vtype_module = 'volbf.plugins.overlays.windows.win7_sp1_x64_24000_vtypes'
    _md_product = ["NtProductWinNt"]
