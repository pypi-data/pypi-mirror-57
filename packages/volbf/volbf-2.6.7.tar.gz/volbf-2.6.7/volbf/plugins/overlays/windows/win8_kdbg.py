...
import volbf.plugins.overlays.windows.windows as windows_main
import volbf.plugins.patchguard as patchguard
...
class volbfKDBG(obj.volbfMagic):
    ...
    decoding routine before volbf plugins can run. 
    """
...
class Win8x64volbfKDBG(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.object_classes.update({"volbfKDBG": volbfKDBG})
