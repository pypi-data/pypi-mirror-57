# volbf
# Copyright (c) 2008-2015 volbf Foundation
#
...
import volbf.plugins.overlays.windows.windows as windows
import volbf.obj as obj
import volbf.win32.tasks as tasks 
import volbf.debug as debug
import volbf.plugins.overlays.windows.win8 as win8
from volbf.win32.rawreg import KEY_FLAGS
...
class Win10x64DTB(obj.ProfileModification):
    ...
    def modification(self, profile):
        ...
        profile.merge_overlay({
            'volbf_MAGIC': [ None, {
            'DTBSignature' : [ None, ['volbfMagic', dict(value = signature)]],
            }]})
...
class ObHeaderCookieStore(object):
    ...
    def findcookie(self, kernel_space):
        ...
        NOTE: this cannot be implemented as a volbf "magic" class,
...
class volbfCookie(obj.volbfMagic):
...
class Win10Cookie(obj.ProfileModification):
    ...
    def modification(self, profile):
        profile.merge_overlay({
            'volbf_MAGIC': [ None, {
            'ObHeaderCookie' : [ 0x0, ['volbfCookie', dict(configname = "COOKIE")]],
            }]})
        profile.object_classes.update({'volbfCookie': volbfCookie})
...
class Win10x64(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 9841
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_vtypes'
...
class Win10x64_10240_17770(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 10240
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_10240_17770_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_10586(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 10586
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_1AC738FB_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_14393(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 14393
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_DD08DD42_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 9841
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_10240_17770(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 10240
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_10240_17770_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_10586(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 10586
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_44B89EEA_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_14393(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 14393
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_9619274A_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_15063(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 15063
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_15063_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_16299(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 16299
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_16299_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_17134(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 17134
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_17134_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_17763(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 17763
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_17763_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x86_18362(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 18362
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x86_18362_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_15063(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 15063
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_15063_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_16299(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 16299
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_16299_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_17134(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 17134
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_17134_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_17763(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 17763
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_17763_vtypes'
    _md_product = ["NtProductWinNt"]
...
class Win10x64_18362(obj.Profile):
    ...
    _md_minor = 4
    _md_build = 18362
    _md_vtype_module = 'volbf.plugins.overlays.windows.win10_x64_18362_vtypes'
    _md_product = ["NtProductWinNt"]