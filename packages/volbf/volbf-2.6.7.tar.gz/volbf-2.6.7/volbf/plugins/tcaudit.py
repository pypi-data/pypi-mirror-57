# volbf
# Copyright (c) 2008-2014 volbf Foundation
...
import volbf.plugins.malware.devicetree as devicetree
import volbf.plugins.malware.svcscan as svcscan
...
class TrueCryptMaster(common.AbstractWindowsCommand):
    ...
    def apply_types(addr_space, ver):
        ...
        @param addr_space: <volbf.BaseAddressSpace>
