...
import volbf.plugins.linux.lsmod  as linux_lsmod
...
from volbf.plugins.linux.slab_info import linux_slabinfo
import volbf.plugins.linux.find_file as find_file
...
class linux_check_inline_kernel(linux_common.AbstractLinuxCommand):
    ...
    def _check_inetsw(self, modules):
        try:
            ...
            debug.warning("You are using an old Linux profile. Please recreate the profile using the latest volbf version.")
            return
