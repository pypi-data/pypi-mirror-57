# volbf
# Copyright (C) 2009-2013 volbf Foundation
...
import volbf.plugins.imagecopy as imagecopy
...
class Raw2dmp(imagecopy.ImageCopy):
    ...
    def convert_to_crash(config, output):
        ...
        headerspace.write(CommentOffset, "File was converted with volbf" + "\x00")
        ...
        # Reset the config so volbf opens the crash dump 
