...
import volbf.win32.modules as modules
import volbf.plugins.common as common
import volbf.utils as utils
import volbf.plugins.malware.apihooks as apihooks
import volbf.debug as debug #pylint: disable-msg=W0611
from volbf.cache import CacheDecorator
...
def find_tables(nt_base, start_addr, vm):
    ...
    in x64 format. If distorm3 is not available, we use volbf's
