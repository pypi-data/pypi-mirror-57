...
import cPickle as pickle # pickle implementation must match that in volbf.cache
import struct, copy, operator
import volbf.debug as debug
import volbf.fmtspec as fmtspec
...
class InvalidOffsetError(exceptions.volbfException):
...
class BaseObject(object):
    ...
    def __nonzero__(self):
        ...
        Object. In volbf we consider an object to have True truth
...
class volbfMagic(BaseObject):
    """Class to contain volbf Magic value"""
...
def VolMagic(vm):
    ...
    return Object("volbf_MAGIC", 0x0, vm = vm)
...
class Profile(object):
    ...
    def clear(self):
        ...
        self.object_classes = {'BitField': BitField,
                               ...
                               'Array': Array,
                               'CType': CType,
                               'volbfMagic': volbfMagic}
        # Ensure volbf_MAGIC is always present in vtypes
        self.vtypes = {'volbf_MAGIC' : [0x0, {}]}
