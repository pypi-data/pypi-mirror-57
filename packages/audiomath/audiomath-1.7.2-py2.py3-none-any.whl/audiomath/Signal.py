...
__all__ = [
	...
	'Click', 'SineWave', 'SquareWave', 'TriangleWave', 'SawtoothWave',
...
def GenerateWaveform(freq_hz=1.0,phase_rad=None,phase_deg=None,amplitude=1.0,dc=0.0,samplingfreq_hz=None,duration_msec=None,duration_samples=None,axis=None,waveform=cos,waveform_domain='auto',container=None,**kwargs):
	"""
...
def Click( milliseconds, positivePulseWidth=0.5, negativePulseWidth=None ):
	"""
	...
	If you specify `negativePulseWidth=None`, the width of the
	negative pulse is made the same as `positivePulseWidth`.
