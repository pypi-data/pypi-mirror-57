...
from .task_grpc_wrapper import TaskGRPCWrapper


class GrpcServer(object):
    _ONE_DAY_IN_SECONDS = 60 * 60 * 24

    def __init__(self, stdout_file: IO, stderr_file: IO, pidfile_path: str, execution_task: Any,
                 max_workers: int, port: int, add_servicer_method: Any):
    ...
    def serve(self):
        ...
        self.add_servicer_to_server(TaskGRPCWrapper(self.execution_task), server)
