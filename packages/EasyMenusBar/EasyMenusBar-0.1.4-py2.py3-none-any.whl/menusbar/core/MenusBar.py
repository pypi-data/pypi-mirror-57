...
class MemusBar(QWidget):
    ...
    def actionHandler(self):
        ...
        if type == "create_dir":
            ...
            if text:
                if self.handlerBeforeEvent(self.HANLDER_CREATE_DIR, os.path.join(self.getDir(fileInfo), text)):
            ...
            if self.handlerBeforeEvent(self.HANLDER_DELETE_DIR, fileInfo.filePath()):
            ...
            if len(temp) < 2:
                ...
                if self.defualtSuffixList:
                    ...
                    text = text + "." + self.defualtSuffix
            if text:
                if self.handlerBeforeEvent(self.HANLDER_CREATE_FILE, os.path.join(self.getDir(fileInfo), text)):
            ...
            if self.handlerBeforeEvent(self.HANLDER_DELETE_FILE, file):
                deleteFile(file)
