...
class EndpointDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [endpoint_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.endpoint_deleted.wait)
        """
...
class ReplicationInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_instance_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_instance_available.wait)
        """
...
class ReplicationInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_instance_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_instance_deleted.wait)
        """
...
class ReplicationTaskDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_task_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_task_deleted.wait)
        """
...
class ReplicationTaskReadyWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_task_ready.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_task_ready.wait)
        """
...
class ReplicationTaskRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_task_running.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_task_running.wait)
        """
...
class ReplicationTaskStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [replication_task_stopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.replication_task_stopped.wait)
        """
...
class TestConnectionSucceedsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [test_connection_succeeds.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dms.html#DatabaseMigrationService.Waiter.test_connection_succeeds.wait)
        """
