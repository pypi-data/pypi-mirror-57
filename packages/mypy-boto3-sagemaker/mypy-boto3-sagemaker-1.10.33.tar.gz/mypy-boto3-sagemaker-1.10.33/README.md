...
Mypy-friendly auto-generated type annotations for `boto3 sagemaker 1.10.33` service.
...
client: sagemaker.Client = boto3.client("sagemaker")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: sagemaker.Client = session.client("sagemaker")
