...
setup(
    ...
    url='https://github.com/aliza-miller/datamodelz',  # Provide either the link to your github or to your website
    download_url='https://github.com/aliza-miller/datamodelz/archive/v0.1.1.tar.gz',  # I explain this later on
