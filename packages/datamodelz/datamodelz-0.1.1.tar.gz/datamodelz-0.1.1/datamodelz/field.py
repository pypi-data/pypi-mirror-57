...
class DateField(Field):
    ...
    def add_frequency(self, frequency):
        if frequency == daily_string:
            return self.value + relativedelta(days=+1)
        if frequency == weekly_string:
            return self.value + relativedelta(days=+7)
        if frequency == monthly_string:
            return self.value + relativedelta(months=+1)
        if frequency == quarterly_string:
            return self.value + relativedelta(months=+3)
        if frequency == annually_string:
            return self.value + relativedelta(years=+1)
        return self.value
