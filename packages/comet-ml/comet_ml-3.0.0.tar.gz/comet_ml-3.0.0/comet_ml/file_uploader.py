...
def send_file_like(
    post_endpoint, api_key, experiment_id, project_id, file_like, additional_params=None
):
    params = {"experimentId": experiment_id, "projectId": project_id, "apiKey": api_key}
...
class BaseUploadProcessor(object):
    ...
    def _process_upload_by_filepath(self, upload_filepath):
        ...
        upload_message = UploadFileMessage(
            upload_filepath, self.UPLOAD_TYPE, self.url_params, clean=clean
        )
    ...
    def _process_upload_io(self, io_object):
        ...
        return UploadInMemoryMessage(io_object, self.UPLOAD_TYPE, self.url_params)
    ...
    def _process_upload_text(self, user_text):
        ...
        return UploadInMemoryMessage(user_text, self.UPLOAD_TYPE, self.url_params)
...
class AssetUploadProcessor(BaseUploadProcessor):
    ...
    def __init__(
        ...
        super(AssetUploadProcessor, self).__init__(
            user_input, upload_limit, url_params, copy_to_tmp, error_message_identifier
        )
