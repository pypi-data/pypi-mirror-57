**ATTENTION**: Please do not use this package, it is just a temporary release of a fork. Go to [https://pypi.org/project/big_O/](https://pypi.org/project/big_O/) to get the official release.
