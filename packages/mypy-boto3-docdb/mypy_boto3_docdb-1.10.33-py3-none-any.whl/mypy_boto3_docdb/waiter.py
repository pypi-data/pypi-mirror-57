...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_instance_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/docdb.html#DocDB.Waiter.db_instance_available.wait)
        """
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_instance_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/docdb.html#DocDB.Waiter.db_instance_deleted.wait)
        """
