        ...
        try:
            ...
            if NSEARCH == 1:
                ...
                if not os.path.exists(model_file):
                    ...
                    print('SHERLOCK model_file',model_file)
                    try:
                        stry = Bioinformatics3.get_structure("test", model_file)
                        print('SHERLOCK stry',stry)
...
distribute_computing: multiprocessing
""")
        print(colored("""#""", 'blue') + colored('\tNOTE', 'yellow') + colored(': other modes are:', 'blue'), end=' ')
        print(colored("""
#distribute_computing: local_grid
#setup_bor_path: /path/to/setup.bor
...
""", 'blue'))
        print(colored("""#""", 'blue') + colored('\tNOTE', 'yellow') + colored(
            ': if the RSA private key is not found or invalid, a password is required', 'blue'), end=' ')
        print(colored("""
#distribute_computing: remote_grid
#setup_bor_path: /path/to/setup.bor
#remote_frontend_passkey: ~/.ssh/id_rsa
...
""", 'blue'))
        print(colored("""#""", 'blue') + colored('\tNOTE', 'yellow') + colored(
            ': to use a specific pdb model as search fragment, comment out "helix_length" and set:', 'blue'), end=' ')
        print(colored("""
#model_file: /path/to/the/file.pdb
""", 'blue'))
        print(colored("""#""", 'blue') + colored('\tNOTE', 'yellow') + colored(
            ': to use a different model for each search fragment, specify "model_file_n"', 'blue'), end=' ')
        print(colored("""
#    for EACH fragment
#model_file_1: /path/to/file1.pdb
#model_file_2: /path/to/file2.pdb
