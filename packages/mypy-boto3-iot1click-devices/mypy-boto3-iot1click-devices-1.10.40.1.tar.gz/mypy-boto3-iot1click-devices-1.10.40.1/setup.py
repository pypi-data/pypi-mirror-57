...
setup(
    ...
    description="Type annotations for boto3.IoT1ClickDevicesService 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 iot1click-devices type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
