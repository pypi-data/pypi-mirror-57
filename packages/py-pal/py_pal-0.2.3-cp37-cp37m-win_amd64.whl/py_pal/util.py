...
def save_plots(output_dir, data_frame):
    data_frame = data_frame[[isinstance(x, Complexity) for x in data_frame[Columns.COMPLEXITY]]]

    for index, data_frame in data_frame.iterrows():
