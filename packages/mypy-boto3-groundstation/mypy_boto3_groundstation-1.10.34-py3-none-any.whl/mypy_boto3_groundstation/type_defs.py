...
ListConfigsPaginatePaginationConfigTypeDef = TypedDict(
    "ListConfigsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListConfigsPaginateResponseconfigListTypeDef = TypedDict(
...
ListConfigsPaginateResponseTypeDef = TypedDict(
    "ListConfigsPaginateResponseTypeDef",
    {"configList": List[ListConfigsPaginateResponseconfigListTypeDef], "NextToken": str},
    total=False,
)

ListContactsPaginatePaginationConfigTypeDef = TypedDict(
    "ListContactsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListContactsPaginateResponsecontactListmaximumElevationTypeDef = TypedDict(
    "ListContactsPaginateResponsecontactListmaximumElevationTypeDef",
    {"unit": Literal["DEGREE_ANGLE", "RADIAN"], "value": float},
    total=False,
)

ListContactsPaginateResponsecontactListTypeDef = TypedDict(
...
ListContactsPaginateResponseTypeDef = TypedDict(
    "ListContactsPaginateResponseTypeDef",
    {"contactList": List[ListContactsPaginateResponsecontactListTypeDef], "NextToken": str},
    total=False,
)

ListDataflowEndpointGroupsPaginatePaginationConfigTypeDef = TypedDict(
    "ListDataflowEndpointGroupsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListDataflowEndpointGroupsPaginateResponsedataflowEndpointGroupListTypeDef = TypedDict(
    "ListDataflowEndpointGroupsPaginateResponsedataflowEndpointGroupListTypeDef",
    {"dataflowEndpointGroupArn": str, "dataflowEndpointGroupId": str},
    total=False,
)

ListDataflowEndpointGroupsPaginateResponseTypeDef = TypedDict(
...
ListGroundStationsPaginatePaginationConfigTypeDef = TypedDict(
    "ListGroundStationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListGroundStationsPaginateResponsegroundStationListTypeDef = TypedDict(
    "ListGroundStationsPaginateResponsegroundStationListTypeDef",
    {"groundStationId": str, "groundStationName": str, "region": str},
    total=False,
)

ListGroundStationsPaginateResponseTypeDef = TypedDict(
...
ListMissionProfilesPaginatePaginationConfigTypeDef = TypedDict(
    "ListMissionProfilesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListMissionProfilesPaginateResponsemissionProfileListTypeDef = TypedDict(
    "ListMissionProfilesPaginateResponsemissionProfileListTypeDef",
    {"missionProfileArn": str, "missionProfileId": str, "name": str, "region": str},
    total=False,
)

ListMissionProfilesPaginateResponseTypeDef = TypedDict(
...
ListSatellitesPaginatePaginationConfigTypeDef = TypedDict(
    "ListSatellitesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSatellitesPaginateResponsesatellitesTypeDef = TypedDict(
    "ListSatellitesPaginateResponsesatellitesTypeDef",
    {"noradSatelliteID": int, "satelliteArn": str, "satelliteId": str},
    total=False,
)

ListSatellitesPaginateResponseTypeDef = TypedDict(
