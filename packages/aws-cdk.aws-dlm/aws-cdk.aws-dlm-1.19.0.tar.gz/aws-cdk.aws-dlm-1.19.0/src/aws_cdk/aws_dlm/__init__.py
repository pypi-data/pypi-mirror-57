...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dlm", "1.19.0", __name__, "aws-dlm@1.19.0.jsii.tgz")
...
class CfnLifecyclePolicy(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dlm.CfnLifecyclePolicy"):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-dlm.CfnLifecyclePolicy.FastRestoreRuleProperty", jsii_struct_bases=[], name_mapping={'count': 'count', 'availability_zones': 'availabilityZones'})
    class FastRestoreRuleProperty():
        def __init__(self, *, count: jsii.Number, availability_zones: typing.Optional[typing.List[str]]=None):
            """
