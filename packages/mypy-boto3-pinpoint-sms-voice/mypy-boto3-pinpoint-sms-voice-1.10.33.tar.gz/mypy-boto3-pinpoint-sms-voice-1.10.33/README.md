...
Mypy-friendly auto-generated type annotations for `boto3 pinpoint-sms-voice 1.10.33` service.
...
client: pinpoint_sms_voice.Client = boto3.client("pinpoint-sms-voice")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: pinpoint_sms_voice.Client = session.client("pinpoint-sms-voice")
