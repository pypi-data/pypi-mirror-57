...
class ProtocolSocket(object):
    ...
    def map_response(self, response_body, property_group=None):
        response_body_param = Type.Param()
        response_body_param.name = BuiltinProcedure.Args.RESPONSE_BODY
        response_body_param.value = str(response_body)
        params = [response_body_param]
