...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v0.0.1-alpha.1575637991+g14ce5fd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v0.0.1-alpha.1575637991+g14ce5fd`
                """)
            else:
                raise
