...
from ._internal.ffi.ctypes_utils import byref, c_double_p, pointer_offset, to_double_ptr, NULLPTR
...
def create_trajectory(time, position, velocity=None, acceleration=None):
  ...
  if velocity is not None:
    ...
    velocity_c = _ctypes.cast(NULLPTR, _c_double_p)
  ...
  if acceleration is not None:
    ...
    acceleration_c = _ctypes.cast(NULLPTR, _c_double_p)
