...
class EnumTraits(object):
  ...
  def __repr__(self):
    return f'{self._name} (value={self._value}, type={self.type})'
...
class MessageEnumTraits(EnumTraits):
  ...
  def __repr__(self):
    if self.__allow_broadcast:
      return f'{self._name} (value={self._value}, type={self.type}), broadcastable'
    return f'{self._name} (value={self._value}, type={self.type}), not broadcastable ({self.__not_broadcastable_reason})'
