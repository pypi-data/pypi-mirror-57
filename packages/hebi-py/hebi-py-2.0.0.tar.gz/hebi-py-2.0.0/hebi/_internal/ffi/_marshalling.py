...
def _fmt_io_bank_pin(pins, indent=4):
  ...
  return f'{indent_str}Int:   {pins_i_str}\n' +\
         f'{indent_str}Float: {pins_f_str}'
...
def create_led_group_getter(refs, field, getter):
  ...
  def ret_getter():
    ...
    return [Color(val) for val in output[0:size]]
  return ret_getter
...
def __check_broadcastable(group_type, field, value):
  if group_type.size > 1:
    if not field.allow_broadcast:
      raise ValueError(f'Cannot broadcast scalar value \'{value}\' '.format(value) +
                       f'to the field \'{0}\' '.format(field.name) +
                       'in all modules of the group.' +
                       f'\nReason: {field.not_broadcastable_reason}')


def __check_broadcastable_field(field, value):
  if not field.allow_broadcast:
    raise ValueError(f'Cannot broadcast scalar value \'{value}\' ' +\
                     f'to the field \'{field.name}\' ' +\
                     'in all modules of the group.' +\
                     f'\nReason: {field.not_broadcastable_reason}')
...
def __get_field_single(message, field, ret, getter):
...
get_command_flag = lambda msg, field: __get_field_single(msg, field, _tls.c_bool, api.hwCommandGetFlag)
get_command_bool = lambda msg, field: __get_field_single(msg, field, _tls.c_bool, api.hwCommandGetBool)
get_command_enum = lambda msg, field: __get_field_single(msg, field, _tls.c_int32, api.hwCommandGetEnum)
get_command_float = lambda msg, field: __get_field_single(msg, field, _tls.c_float, api.hwCommandGetFloat)
get_command_highresangle = lambda msg, field: __get_field_single(msg, field, _tls.c_double, api.hwCommandGetHighResAngle)
...
get_feedback_vector3f = lambda msg, field: __get_field_single(msg, field, _tls.c_vector3f, api.hwFeedbackGetVector3f)
get_feedback_quaternionf = lambda msg, field: __get_field_single(msg, field, _tls.c_quaternionf, api.hwFeedbackGetQuaternionf)
get_feedback_uint64 = lambda msg, field: __get_field_single(msg, field, _tls.c_uint64, api.hwFeedbackGetUInt64)
get_feedback_enum = lambda msg, field: __get_field_single(msg, field, _tls.c_int, api.hwFeedbackGetEnum)
get_feedback_float = lambda msg, field: __get_field_single(msg, field, _tls.c_float, api.hwFeedbackGetFloat)
get_feedback_highresangle = lambda msg, field: __get_field_single(msg, field, _tls.c_double, api.hwFeedbackGetHighResAngle)
...
get_info_flag = lambda msg, field: __get_field_single(msg, field, _tls.c_bool, api.hwInfoGetFlag)
get_info_bool = lambda msg, field: __get_field_single(msg, field, _tls.c_bool, api.hwInfoGetBool)
get_info_enum = lambda msg, field: __get_field_single(msg, field, _tls.c_int, api.hwInfoGetEnum)
get_info_float = lambda msg, field: __get_field_single(msg, field, _tls.c_float, api.hwInfoGetFloat)
get_info_highresangle = lambda msg, field: __get_field_single(msg, field, _tls.c_double, api.hwInfoGetHighResAngle)
...
def __map_input_setter_delegate(group_message, values, setter, setter_field):
  ...
  try:
    ...
    print(f'{key} is not a valid string parameter.')
...
def setter_input_parser_delegate(group_message, values, setter, setter_field):
  ...
  if not hasattr(setter_field, 'substrates'):
    raise RuntimeError(f'Field {setter_field} has no substrates map field')
