...
S3DestinationSettingsTypeDef = TypedDict(
    ...
    {"AccessControl": S3DestinationAccessControlTypeDef, "Encryption": S3EncryptionSettingsTypeDef},
    total=False,
)
...
MsSmoothEncryptionSettingsTypeDef = TypedDict(
    "MsSmoothEncryptionSettingsTypeDef", {"SpekeKeyProvider": SpekeKeyProviderTypeDef}, total=False
)
...
H264QvbrSettingsTypeDef = TypedDict(
    "H264QvbrSettingsTypeDef", {"MaxAverageBitrate": int, "QvbrQualityLevel": int}, total=False
)
...
H265QvbrSettingsTypeDef = TypedDict(
    "H265QvbrSettingsTypeDef", {"MaxAverageBitrate": int, "QvbrQualityLevel": int}, total=False
)
...
GetQueueResponseTypeDef = TypedDict("GetQueueResponseTypeDef", {"Queue": QueueTypeDef}, total=False)
