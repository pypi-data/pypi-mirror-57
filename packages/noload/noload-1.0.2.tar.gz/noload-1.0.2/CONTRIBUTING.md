...
Please, feel free to contribute to PyDES library.
...
In order to contribute to PyDES, you must fork the project then use
https://gricad-gitlab.univ-grenoble-alpes.fr/design_optimization/pydes
...
time of integrating your code in PyDES
