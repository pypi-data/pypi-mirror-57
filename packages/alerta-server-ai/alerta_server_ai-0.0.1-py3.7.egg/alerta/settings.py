...
MONGO_URI = 'mongodb://mesos:mesos@192.168.122.75:57018/monitoring?authSource=admin&readPreference=primary&connectTimeoutMS=300000'
...
ADMIN_USERS = ["aa@aa.com"]  # type: List[str]
...
# Plugins
PLUGINS = ['remote_ip', 'notify_test', 'reject', 'heartbeat', 'blackout']
