...
Mypy-friendly auto-generated type annotations for `boto3 cloudhsm 1.10.34` service.
...
client: cloudhsm.Client = boto3.client("cloudhsm")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: cloudhsm.Client = session.client("cloudhsm")
