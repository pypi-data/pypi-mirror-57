...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_event_source_mappings_paginator(client: Client) -> ListEventSourceMappingsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_function_event_invoke_configs_paginator(
    client: Client,
) -> ListFunctionEventInvokeConfigsPaginator:
    """
    Equivalent of `client.get_paginator('list_function_event_invoke_configs')`, returns a correct
    type.
    """
    return client.get_paginator("list_function_event_invoke_configs")
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_provisioned_concurrency_configs_paginator(
    client: Client,
) -> ListProvisionedConcurrencyConfigsPaginator:
    """
    Equivalent of `client.get_paginator('list_provisioned_concurrency_configs')`, returns a correct
    type.
    """
    return client.get_paginator("list_provisioned_concurrency_configs")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_versions_by_function_paginator(client: Client) -> ListVersionsByFunctionPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_function_active_waiter(client: Client) -> FunctionActiveWaiter:
    """
    Equivalent of `client.get_waiter('function_active')`, returns a correct type.
    """
    return client.get_waiter("function_active")
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_function_updated_waiter(client: Client) -> FunctionUpdatedWaiter:
    """
    Equivalent of `client.get_waiter('function_updated')`, returns a correct type.
    """
    return client.get_waiter("function_updated")
