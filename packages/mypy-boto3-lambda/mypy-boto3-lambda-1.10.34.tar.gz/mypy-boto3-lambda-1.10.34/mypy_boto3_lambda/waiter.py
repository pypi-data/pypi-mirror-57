...
class FunctionActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [function_active.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/lambda.html#Lambda.Waiter.function_active.wait)
        """
...
class FunctionExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [function_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/lambda.html#Lambda.Waiter.function_exists.wait)
        """
...
class FunctionUpdatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [function_updated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/lambda.html#Lambda.Waiter.function_updated.wait)
        """
