...
id = "1041b27296c4930499a1b40ed617c2c416725edb"
date = "2019-12-9 15:33:56 +0000"
branch = "None"
tag = "lalsuite-v6.63"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "1041b27296c4930499a1b40ed617c2c416725edb":
        return
    msg = "Program id (1041b27296c4930499a1b40ed617c2c416725edb) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
