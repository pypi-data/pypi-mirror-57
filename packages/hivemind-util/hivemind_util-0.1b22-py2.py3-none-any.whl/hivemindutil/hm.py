...
def addAnnotation(taskId, baseUrl, apiKey, instanceId, key, value):
    ...
    with requests.Session() as s:
        ...
        createInstance = checkHttpResponse(s.post('{0}/api/tasks/{1}/instances/{2}/annotations'.format(baseUrl, taskId, instanceId), json = data))
...
def deleteAnnotation(taskId, baseUrl, apiKey, instanceId, key):
    ...
    with requests.Session() as s:
        s.headers.update(authHeader)
        baseUrl = cleanBaseUrl(baseUrl)           
        createInstance = checkHttpResponse(s.delete('{0}/api/tasks/{1}/instances/{2}/annotations/{3}'.format(baseUrl, taskId, instanceId, key)))
