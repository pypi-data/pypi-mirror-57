...
Mypy-friendly auto-generated type annotations for `boto3 mediatailor 1.10.33` service.
...
client: mediatailor.Client = boto3.client("mediatailor")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: mediatailor.Client = session.client("mediatailor")
