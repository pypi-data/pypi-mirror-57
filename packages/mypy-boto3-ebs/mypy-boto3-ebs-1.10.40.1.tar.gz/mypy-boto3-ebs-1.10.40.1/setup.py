...
setup(
    ...
    description="Type annotations for boto3.EBS 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 ebs type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
