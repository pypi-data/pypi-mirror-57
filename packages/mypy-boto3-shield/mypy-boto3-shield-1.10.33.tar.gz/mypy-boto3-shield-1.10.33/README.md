...
Mypy-friendly auto-generated type annotations for `boto3 shield 1.10.33` service.
...
client: shield.Client = boto3.client("shield")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: shield.Client = session.client("shield")
