...
class OE2Axona(object):
	...
	def makeLFPData(self, hdf5_continuous_data: np.array, eeg_type='eeg', gain=1000):
		...
		nsamples = int(np.floor((self.last_pos_ts-self.first_pos_ts)*dst_rate))
		print("num samples = {}".format(nsamples))
		hdf5_continuous_data = hdf5_continuous_data[0:nsamples]
