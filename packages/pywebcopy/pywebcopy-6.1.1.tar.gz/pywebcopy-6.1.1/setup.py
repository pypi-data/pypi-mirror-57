...
# Package meta-data.
NAME = 'pywebcopy'
DESCRIPTION = 'Python package for cloning complete web-pages and web-sites to local storage.'
...
REQUIRED = [
    'requests', 'lxml', 'fire', 'six'
]
EXTRAS = {'MultiParser': ['pyquery', 'parse', 'w3lib', 'bs4']}
