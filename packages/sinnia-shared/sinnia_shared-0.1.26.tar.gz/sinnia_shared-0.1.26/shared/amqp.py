...
class AMQPUtil():
    ...
    def __init__(self, with_helper=False):
        ...
        self.helper = AMQPHelper(hconf['helper_sleeptime'], hconf['host'], 
                                 hconf['user'],hconf['pass'],hconf['ram_limit'])
