...
web services <https://cdaweb.sci.gsfc.nasa.gov/WebServices/REST/>.<br>
...
class CdasWs:
    ...
    def __init__(
        ...
        endpoint
            ...
            'https://cdaweb.sci.gsfc.nasa.gov/WS/cdasr/1/dataviews/sp_phys/'.
        timeout
        ...
        if endpoint is None:
            self._endpoint = 'https://cdaweb.sci.gsfc.nasa.gov/WS/cdasr/1/dataviews/sp_phys/'
        else:
    ...
    def get_observatory_groups(
        ...
        List
            ...
            <https://cdaweb.sci.gsfc.nasa.gov/WebServices/REST/CDAS.xsd>.
        """
    ...
    def get_data_file(
        ...
        keywords
            ...
            interpolateMissingValues, and/or sigmaMultiplier with
            values that override the defaults.<br>
    ...
    def get_graph(
        ...
        keywords
            ...
            the given binning parameter values.  binData is a Dict that
            may contain the following keys: interval,
            interpolateMissingValues, and/or sigmaMultiplier with values
            that override the defaults.<br>
            progressCallback - is a
            typing.Callable[[float, str, typing.Any], int]
            function that is called repeatedly to report the progress
            of getting the data.  The function should return 0 if it
