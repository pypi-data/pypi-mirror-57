...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_query_logging_configs_paginator(client: Client) -> ListQueryLoggingConfigsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_resource_record_sets_paginator(client: Client) -> ListResourceRecordSetsPaginator:
    """
...
def get_list_vpc_association_authorizations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_vpc_association_authorizations')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_resource_record_sets_changed_waiter(client: Client) -> ResourceRecordSetsChangedWaiter:
    """
