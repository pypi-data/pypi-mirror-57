...
class Okex(UXPatch, ccxt.okex3):
        ...
        return self.deep_extend(super().describe(), {
            ...
            'wsapi': {
                'spot': {
                    ...
                    'kline': 'spot/candle{period_in_sec}s:{symbol}',
                ...
                'futures': {
                    ...
                    'kline': 'futures/candle{period_in_sec}s:{symbol}',
                ...
                'swap': {
                    ...
                    'kline': 'swap/candle{period_in_sec}s:{symbol}',
                ...
                'index': {
                    ...
                    'kline': 'index/candle{period_in_sec}s:{symbol}',
                }
            }
        })
    ...
    def wshandler(self, feed):
        return OkexWSHandler(self, self.urls['wsapi'], feed)
    ...
    def convert_topic(self, uxtopic):
        ...
        if maintype == 'account':
            ...
            if maintype == 'kline':
                params['period_in_sec'] = self.timeframes[uxtopic.subtype]
            if maintype == 'orderbook':
                params['level'] = uxtopic.subtype or '5'
