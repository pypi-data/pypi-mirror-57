...
package_version = Version(major=0, minor=6, patch=3, prerelease=('alpha', '1'))
...
setup(
    ...
    entry_points={
        'console_scripts': ["xd-cwl-validate=xd_cwl_utils.validate_metadata.__main__:main", "xd-cwl-add=xd_cwl_utils.add_content.__main__:main"]
                  },
    classifiers=[
