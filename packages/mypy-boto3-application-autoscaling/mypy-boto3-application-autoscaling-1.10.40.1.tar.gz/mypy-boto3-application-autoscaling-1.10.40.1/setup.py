...
setup(
    ...
    description="Type annotations for boto3.ApplicationAutoScaling 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 application-autoscaling type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
