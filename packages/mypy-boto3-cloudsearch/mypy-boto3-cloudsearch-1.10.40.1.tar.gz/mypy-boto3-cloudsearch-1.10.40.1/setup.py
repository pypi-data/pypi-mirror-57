...
setup(
    ...
    description="Type annotations for boto3.CloudSearch 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 cloudsearch type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
