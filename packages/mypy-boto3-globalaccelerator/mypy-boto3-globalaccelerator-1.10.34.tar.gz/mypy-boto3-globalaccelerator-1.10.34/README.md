...
Mypy-friendly auto-generated type annotations for `boto3 globalaccelerator 1.10.34` service.
...
client: globalaccelerator.Client = boto3.client("globalaccelerator")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: globalaccelerator.Client = session.client("globalaccelerator")
