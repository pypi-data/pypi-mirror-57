...
setup(
    ...
    description="Type annotations for boto3.GlobalAccelerator 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 globalaccelerator type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
