...
def n101():
    ...
    ret = o.write_excel()
    if ret:
        t.insert(END,"| EXCEL样本生成 OK |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
    else:
        t.insert(END,"| EXCEL样本生成 FAIL |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
def n11():
    try:
        os.system("python Windows.py -4")
    except Exception as e:
...
def n17():
    try:
        os.system("python Windows.py -a")
    except Exception as e:
        t.insert(END,"| CreateContentWindow FAIL |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
    finally:
        t.insert(END,"| CreateContentWindow OK |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
def n18():
    try:
        os.system("python createuser\\create_user.py")
    except Exception as e:
        t.insert(END,"| CreateUser FAIL |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
    finally:
        t.insert(END,"| CreateUser OK |\n")
        t.insert(END,"|--------------------------------------------------------------------------------------------------------------------------------|\n")
        t.update()
def o1():
    ret = True
...
netmenu.add_command(label="随机生成EXCEL样本文件(文件输出位置DLP\Result)", command=n101)
...
netmenu.add_command(label="随机文章并生成TXT文件(文件输出位置DLP\Result)", command=n17)
netmenu.add_command(label="随机生成30万天擎用户(文件输出位置DLP\Result)", command=n18)
