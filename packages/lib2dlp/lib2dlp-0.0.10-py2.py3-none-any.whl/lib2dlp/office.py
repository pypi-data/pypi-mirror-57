...
class office:
    ...
    def write_excel(self):
        ...
        o = office()
        faker = Faker("zh_CN")
        sheet1 = f.add_sheet(u'样本',cell_overwrite_ok=True)

        row0 = [u"姓名",u"电话号码",u"18位身份证号码",u"信用卡号","MAC","IPV4","URL",u"公司",u"地址",u"文件后缀"]
        #写第一行
        for i in range(0,len(row0)):
            sheet1.write(0,i,row0[i],o.set_style('Times New Roman',300,True))

        #设置第一列列宽
        first_col=sheet1.col(0)
        first_col.width = 500*6 #8个英文字符
        colum0 = [faker.name(),faker.name(),faker.name(),faker.name(),faker.name()\
        ...
        for i in range(0,len(colum0)):
            sheet1.write(i+1,0,colum0[i],o.set_style('Times New Roman',220,False))

        #设置第二列列宽
        first_col=sheet1.col(1)
        first_col.width = 500*8
        colum1 = [faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
                  ,faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
                  ,faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
                  ,faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
                  ,faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
                  ,faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number(),faker.phone_number()\
        ...
        colum2 = [faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
                  ,faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
                  ,faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
                  ,faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
                  ,faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
                  ,faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn(),faker.ssn()\
        ...
        for i in range(0,len(colum2)):
            sheet1.write(i+1,2,colum2[i])

        #设置第四列列宽
        first_col=sheet1.col(3)
        first_col.width = 500*11
        colum3 = [faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
                  ,faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
                  ,faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
                  ,faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
                  ,faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
                  ,faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None),faker.credit_card_number(card_type=None)\
        ...
        colum4 = [faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
                  ,faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
                  ,faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
                  ,faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
                  ,faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
                  ,faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address(),faker.mac_address()\
        ...
        first_col.width = 500*8
        colum5 = [faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
                  ,faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
                  ,faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
                  ,faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
                  ,faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
                  ,faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4(),faker.ipv4()\
        ...
        #写第六列
        for i in range(0,len(colum5)):
            sheet1.write(i+1,5,colum5[i])

        #设置第七列列宽
        first_col=sheet1.col(6)
        first_col.width = 500*14
        colum6 = [faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
                  ,faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
                  ,faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
                  ,faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
                  ,faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
                  ,faker.url(),faker.url(),faker.url(),faker.url(),faker.url()\
        ...
        #写第七列
        for i in range(0,len(colum6)):
            sheet1.write(i+1,6,colum6[i])

        
        #设置第八列列宽
        first_col=sheet1.col(7)
        first_col.width = 500*14
        colum7 = [faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
                  ,faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
                  ,faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
                  ,faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
                  ,faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
                  ,faker.company(),faker.company(),faker.company(),faker.company(),faker.company()\
        ...
        #写第八列
        for i in range(0,len(colum7)):
            sheet1.write(i+1,7,colum7[i])

        #设置第九列列宽
        first_col=sheet1.col(8)
        first_col.width = 500*23
        colum8 = [faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
                  ,faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
                  ,faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
                  ,faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
                  ,faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
                  ,faker.address(),faker.address(),faker.address(),faker.address(),faker.address()\
        ...
        #写第九列
        for i in range(0,len(colum8)):
            sheet1.write(i+1,8,colum8[i])

        #设置第十列列宽
        first_col=sheet1.col(9)
        first_col.width = 500*8
        colum9 = [faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
                  ,faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
                  ,faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
                  ,faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
                  ,faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
                  ,faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None),faker.file_extension(category=None)\
        ...
        #写第十列
        for i in range(0,len(colum9)):
            sheet1.write(i+1,9,colum9[i])

        
        f.save(u"Result\\样本.xls")
