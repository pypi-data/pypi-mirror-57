...
class WalletAddress(object):
    ...
    @property
    def addr(self):
        """Gets the addr of this WalletAddress.  # noqa: E501

        Wallet address for the payment in the network  # noqa: E501

        :return: The addr of this WalletAddress.  # noqa: E501
        :rtype: str
        """
        return self._addr
    ...
    @addr.setter
    def addr(self, addr):
        """Sets the addr of this WalletAddress.

        Wallet address for the payment in the network  # noqa: E501

        :param addr: The addr of this WalletAddress.  # noqa: E501
        :type: str
        """
        if addr is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WalletAddress, dict):
