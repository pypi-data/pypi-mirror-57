...
class PaymentsApi(object):
    ...
    def create_payment(self, body, **kwargs):  # noqa: E501
        """Generate a unique wallet address in the specified network to accept payment  # noqa: E501
        ...
        :param Chain chain: Ethereum network in which payment is to be created. Please refer documentation for Supported Networks
    ...
    def get_payment(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: Unique identifier of the payment (specified during [Create a Payment](#createPayment)) to retrieve (required)
        :return: Payment
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def refund_payment(self, body, id, **kwargs):  # noqa: E501
        ...
        :param str id: Unique identifier of the payment (specified during [Create a Payment](#createPayment)) (required)
        :param Chain chain: Ethereum network in which payment is to be created.
