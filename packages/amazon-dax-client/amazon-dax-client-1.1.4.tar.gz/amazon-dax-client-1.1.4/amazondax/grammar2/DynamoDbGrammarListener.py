...
class DynamoDbGrammarListener(ParseTreeListener):
    ...
    def enterFunctionCondition(self, ctx):
        pass

    # Exit a parse tree produced by DynamoDbGrammarParser#FunctionCondition.
    def exitFunctionCondition(self, ctx):
        pass
