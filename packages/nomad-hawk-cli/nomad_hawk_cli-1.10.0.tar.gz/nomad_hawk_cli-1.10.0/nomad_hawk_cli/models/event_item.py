...
class EventItem(object):
    ...
    def __init__(self, item_name=None, item_price=None, item_quantity=None, item_category=None, item_barcode=None, item_currency=None, item_brand=None, item_brand_type=None, item_sku=None, item_variant=None, item_cost=None):  # noqa: E501
