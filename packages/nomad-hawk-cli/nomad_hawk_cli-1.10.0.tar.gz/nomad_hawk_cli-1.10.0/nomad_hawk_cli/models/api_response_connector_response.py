...
class ApiResponseConnectorResponse(object):
    ...
    def __init__(self, input=None, operation_name=None, api=None, http_request_raw_data=None, code=None, response=None, response_en=None, platform=None, request_count=None):  # noqa: E501
