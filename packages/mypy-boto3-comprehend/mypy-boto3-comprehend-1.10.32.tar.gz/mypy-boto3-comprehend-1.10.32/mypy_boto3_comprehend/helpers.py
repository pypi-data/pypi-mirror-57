...
def get_list_document_classification_jobs_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_document_classification_jobs')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_document_classifiers_paginator(client: Client) -> ListDocumentClassifiersPaginator:
    """
...
def get_list_dominant_language_detection_jobs_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_dominant_language_detection_jobs')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_entity_recognizers_paginator(client: Client) -> ListEntityRecognizersPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_topics_detection_jobs_paginator(client: Client) -> ListTopicsDetectionJobsPaginator:
    """
