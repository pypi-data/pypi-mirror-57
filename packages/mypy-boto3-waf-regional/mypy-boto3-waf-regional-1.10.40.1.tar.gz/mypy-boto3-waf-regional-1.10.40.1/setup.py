...
setup(
    ...
    description="Type annotations for boto3.WAFRegional 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 waf-regional type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
