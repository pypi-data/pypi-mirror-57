...
class OptiHistoric(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.collection_devices = Collection(filename=filename_devices)
        self.collection_logOpti = Collection(filename=filename_logopti)
        self.collection_devices_results = Collection(filename=filename_results)
        self.collection_convergence = Collection(filename=filename_convergence)
        if self.autosave:
            self.collection_devices.start_autosave(autosaveTimer)
            self.collection_logOpti.start_autosave(autosaveTimer)
            self.collection_convergence.start_autosave(autosaveTimer)
