...
BioSAK NetEnzymes -ec Ecoli_ko_stats_D_GeneNumber.txt -ko 00010 -to_skip skip.txt -plot -NoHyphen
...
if __name__ == '__main__':
    ...
    NetEnzymes_parser.add_argument('-to_skip',  required=False,                          help='substrate/products to ignore (e.g. H2O, CO2, H+, ATP, ADP)')
