...
ListGrantsPaginatePaginationConfigTypeDef = TypedDict(
    "ListGrantsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListGrantsPaginateResponseGrantsConstraintsTypeDef = TypedDict(
    "ListGrantsPaginateResponseGrantsConstraintsTypeDef",
    {"EncryptionContextSubset": Dict[str, str], "EncryptionContextEquals": Dict[str, str]},
    total=False,
)

ListGrantsPaginateResponseGrantsTypeDef = TypedDict(
...
ListGrantsPaginateResponseTypeDef = TypedDict(
    "ListGrantsPaginateResponseTypeDef",
    {"Grants": List[ListGrantsPaginateResponseGrantsTypeDef], "Truncated": bool, "NextToken": str},
    total=False,
)

ListKeyPoliciesPaginatePaginationConfigTypeDef = TypedDict(
    "ListKeyPoliciesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListKeyPoliciesPaginateResponseTypeDef = TypedDict(
    "ListKeyPoliciesPaginateResponseTypeDef",
    {"PolicyNames": List[str], "Truncated": bool, "NextToken": str},
    total=False,
)

ListKeysPaginatePaginationConfigTypeDef = TypedDict(
    "ListKeysPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListKeysPaginateResponseKeysTypeDef = TypedDict(
    "ListKeysPaginateResponseKeysTypeDef", {"KeyId": str, "KeyArn": str}, total=False
)

ListKeysPaginateResponseTypeDef = TypedDict(
