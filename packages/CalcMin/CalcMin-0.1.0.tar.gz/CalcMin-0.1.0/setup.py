...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['pandas', 'pdsql', 'hydrointerp', 'pyyaml']
...
setup(
    ...
    url='https://github.com/Data-to-Knowledge/CalcMin',  # Optional
