...
from pytorchjob.models.v1_replica_spec import V1ReplicaSpec  # noqa: F401,E501
...
class V1PyTorchJobSpec(object):
    ...
    def __init__(self, active_deadline_seconds=None, backoff_limit=None, clean_pod_policy=None, pytorch_replica_specs=None, ttl_seconds_after_finished=None):  # noqa: E501
        """V1PyTorchJobSpec - a model defined in Swagger"""  # noqa: E501
    ...
    def active_deadline_seconds(self):
        """Gets the active_deadline_seconds of this V1PyTorchJobSpec.  # noqa: E501
        ...
        :return: The active_deadline_seconds of this V1PyTorchJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def active_deadline_seconds(self, active_deadline_seconds):
        """Sets the active_deadline_seconds of this V1PyTorchJobSpec.

        Specifies the duration (in seconds) since startTime during which the job can remain active before it is terminated. Must be a positive integer. This setting applies only to pods where restartPolicy is OnFailure or Always.  # noqa: E501

        :param active_deadline_seconds: The active_deadline_seconds of this V1PyTorchJobSpec.  # noqa: E501
        :type: int
        """
    ...
    def backoff_limit(self):
        """Gets the backoff_limit of this V1PyTorchJobSpec.  # noqa: E501

        Number of retries before marking this job as failed.  # noqa: E501

        :return: The backoff_limit of this V1PyTorchJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def backoff_limit(self, backoff_limit):
        """Sets the backoff_limit of this V1PyTorchJobSpec.

        Number of retries before marking this job as failed.  # noqa: E501

        :param backoff_limit: The backoff_limit of this V1PyTorchJobSpec.  # noqa: E501
        :type: int
        """
    ...
    def clean_pod_policy(self):
        """Gets the clean_pod_policy of this V1PyTorchJobSpec.  # noqa: E501

        Defines the policy for cleaning up pods after the PyTorchJob completes. Defaults to None.  # noqa: E501

        :return: The clean_pod_policy of this V1PyTorchJobSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def clean_pod_policy(self, clean_pod_policy):
        """Sets the clean_pod_policy of this V1PyTorchJobSpec.

        Defines the policy for cleaning up pods after the PyTorchJob completes. Defaults to None.  # noqa: E501

        :param clean_pod_policy: The clean_pod_policy of this V1PyTorchJobSpec.  # noqa: E501
        :type: str
        """
    ...
    def ttl_seconds_after_finished(self):
        """Gets the ttl_seconds_after_finished of this V1PyTorchJobSpec.  # noqa: E501

        Defines the TTL for cleaning up finished PyTorchJobs (temporary before Kubernetes adds the cleanup controller). It may take extra ReconcilePeriod seconds for the cleanup, since reconcile gets called periodically. Defaults to infinite.  # noqa: E501

        :return: The ttl_seconds_after_finished of this V1PyTorchJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def ttl_seconds_after_finished(self, ttl_seconds_after_finished):
        """Sets the ttl_seconds_after_finished of this V1PyTorchJobSpec.

        Defines the TTL for cleaning up finished PyTorchJobs (temporary before Kubernetes adds the cleanup controller). It may take extra ReconcilePeriod seconds for the cleanup, since reconcile gets called periodically. Defaults to infinite.  # noqa: E501

        :param ttl_seconds_after_finished: The ttl_seconds_after_finished of this V1PyTorchJobSpec.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1PyTorchJobSpec, dict):
