...
def generate_metadata():
    ...
    extractors = []
    # TODO: Initial implementation expects each directory to only contain 1 feature extractor
    # Will need to add work to return multiple extractors
    ...
    return feature_extractor_metadata
