from decorators import feature_extractor

@feature_extractor(name = 'test_feature_extractor')
def feature_extractor_func(node_metadata, node_output_table):
    '''
    Extract out feature from node_output_table
    :param str column1: Column Input Description #1
    :param int column2: Column Input Description #2
    '''
