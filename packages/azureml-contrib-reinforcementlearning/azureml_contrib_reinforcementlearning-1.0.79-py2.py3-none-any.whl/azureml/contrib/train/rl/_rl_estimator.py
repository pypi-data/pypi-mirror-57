...
class ReinforcementLearningEstimator(_RLBaseEstimator):
    ...
    :param job_queue_timeout: The maximum time the job can spend in queued state in seconds. Jobs stay in the compute
        state while they are waiting for the compute target to be ready to start the job.
