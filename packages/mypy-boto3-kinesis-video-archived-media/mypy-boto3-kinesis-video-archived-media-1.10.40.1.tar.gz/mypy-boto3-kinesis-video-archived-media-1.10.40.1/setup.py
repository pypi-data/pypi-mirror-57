...
setup(
    ...
    description="Type annotations for boto3.KinesisVideoArchivedMedia 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 kinesis-video-archived-media type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
