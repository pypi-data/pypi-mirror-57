...
setup(
    ...
    description="Mypy-friendly boto3 1.10.39 type annotations for kinesis-video-archived-media service.",
    classifiers=[
    ...
    install_requires=["typing_extensions; python_version < '3.8'", "mypy-boto3==1.10.39.1",],
    zip_safe=False,
