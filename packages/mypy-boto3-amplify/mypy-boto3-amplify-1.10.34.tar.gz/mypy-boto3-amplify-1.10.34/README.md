...
Mypy-friendly auto-generated type annotations for `boto3 amplify 1.10.34` service.
...
client: amplify.Client = boto3.client("amplify")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: amplify.Client = session.client("amplify")
