...
def boto3_client(
    ...
    if session is not None:
        return session.client("amplify", **kwargs)
    return boto3.client("amplify", **kwargs)
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_domain_associations_paginator(client: Client) -> ListDomainAssociationsPaginator:
    """
