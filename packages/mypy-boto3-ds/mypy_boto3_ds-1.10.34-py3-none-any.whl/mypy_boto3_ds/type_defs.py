...
DescribeDirectoriesPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeDirectoriesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeDirectoriesPaginateResponseDirectoryDescriptionsConnectSettingsTypeDef = TypedDict(
...
DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionRadiusSettingsTypeDef = TypedDict(
...
DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionVpcSettingsTypeDef = TypedDict(
    "DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionVpcSettingsTypeDef",
    {"VpcId": str, "SubnetIds": List[str], "SecurityGroupId": str, "AvailabilityZones": List[str]},
    total=False,
)

DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionTypeDef = TypedDict(
...
DescribeDirectoriesPaginateResponseDirectoryDescriptionsRadiusSettingsTypeDef = TypedDict(
...
DescribeDirectoriesPaginateResponseDirectoryDescriptionsVpcSettingsTypeDef = TypedDict(
    "DescribeDirectoriesPaginateResponseDirectoryDescriptionsVpcSettingsTypeDef",
    {"VpcId": str, "SubnetIds": List[str], "SecurityGroupId": str, "AvailabilityZones": List[str]},
    total=False,
)

DescribeDirectoriesPaginateResponseDirectoryDescriptionsTypeDef = TypedDict(
...
DescribeDirectoriesPaginateResponseTypeDef = TypedDict(
...
DescribeDomainControllersPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeDomainControllersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeDomainControllersPaginateResponseDomainControllersTypeDef = TypedDict(
...
DescribeDomainControllersPaginateResponseTypeDef = TypedDict(
...
DescribeSharedDirectoriesPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeSharedDirectoriesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeSharedDirectoriesPaginateResponseSharedDirectoriesTypeDef = TypedDict(
...
DescribeSharedDirectoriesPaginateResponseTypeDef = TypedDict(
...
DescribeTrustsPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeTrustsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeTrustsPaginateResponseTrustsTypeDef = TypedDict(
...
DescribeTrustsPaginateResponseTypeDef = TypedDict(
    "DescribeTrustsPaginateResponseTypeDef",
    {"Trusts": List[DescribeTrustsPaginateResponseTrustsTypeDef]},
    total=False,
)

ListIpRoutesPaginatePaginationConfigTypeDef = TypedDict(
    "ListIpRoutesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListIpRoutesPaginateResponseIpRoutesInfoTypeDef = TypedDict(
...
ListIpRoutesPaginateResponseTypeDef = TypedDict(
    "ListIpRoutesPaginateResponseTypeDef",
    {"IpRoutesInfo": List[ListIpRoutesPaginateResponseIpRoutesInfoTypeDef]},
    total=False,
)

ListLogSubscriptionsPaginatePaginationConfigTypeDef = TypedDict(
    "ListLogSubscriptionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListLogSubscriptionsPaginateResponseLogSubscriptionsTypeDef = TypedDict(
    "ListLogSubscriptionsPaginateResponseLogSubscriptionsTypeDef",
    {"DirectoryId": str, "LogGroupName": str, "SubscriptionCreatedDateTime": datetime},
    total=False,
)

ListLogSubscriptionsPaginateResponseTypeDef = TypedDict(
...
ListSchemaExtensionsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSchemaExtensionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSchemaExtensionsPaginateResponseSchemaExtensionsInfoTypeDef = TypedDict(
...
ListSchemaExtensionsPaginateResponseTypeDef = TypedDict(
