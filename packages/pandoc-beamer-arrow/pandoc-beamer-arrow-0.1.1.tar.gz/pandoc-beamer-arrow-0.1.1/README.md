# pandoc-beamer-arrow
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-beamer-arrow/0.1.1.svg?logo=travis)](https://travis-ci.org/chdemko/pandoc-beamer-arrow/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-beamer-arrow/0.1.1.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-beamer-arrow?branch=0.1.1)
...
See the [Read the docs pages](http://pandoc-beamer-arrow.readthedocs.io/en/0.1.1/).
