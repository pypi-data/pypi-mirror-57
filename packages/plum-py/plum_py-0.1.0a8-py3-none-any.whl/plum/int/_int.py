...
class Int(int, Plum, metaclass=IntType):
    ...
    def __unpack__(cls, buffer, offset, limit, dump, parent):
        ...
        self = int.from_bytes(chunk, cls._byteorder, signed=cls.__signed__)
    ...
    def __pack__(cls, buffer, offset, value, dump):
        ...
        if cls.__strict_enum__ and type(value) is not cls:
            value = cls(value)
        ...
        chunk = to_bytes(nbytes, cls._byteorder, signed=cls.__signed__)
