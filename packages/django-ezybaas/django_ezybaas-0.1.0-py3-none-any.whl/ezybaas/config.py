...
EZYBAAS_RELEASE_AUTHOR = 'SusthitSoft Technologies'
EZYBAAS_RELEASE_VERSION = '0.1.0'
EZYBAAS_RELEASE_DATE = '2019-07-20'
EZYBAAS_RELEASE_NOTES = 'http://github.com/susthitsoft'
EZYBAAS_RELEASE_STANDALONE = True
EZYBAAS_RELEASE_LICENSE = 'http://github.com/susthitsoft'
