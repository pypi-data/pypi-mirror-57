...
def main():
    ...
    min_length_song=args.min_length_song
    ...
    df = process_lyrics.main(api_key=api_key, df=df, check_lyrics_state=check_lyrics_state, save_path=save_processed_df_path, hdf_key=save_processed_hdf_key, min_length_song=min_length_song)
