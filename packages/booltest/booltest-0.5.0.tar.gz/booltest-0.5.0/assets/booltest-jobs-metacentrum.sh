...
export EACIRC_ESTREAM="${HOMEDIR}/crypto-streams-v3.0-ph4-61331d0228ea2e"
cd $HOMEDIR
...
# Ref, 20kx 10MB AES, 3 combinations high orders
python ../booltest/booltest/testjobs.py  \
    --generator-path ../crypto-streams-v3.0 \
    --data-dir $RESDIR --job-dir $JOBDIR --result-dir=$RESDIR \
    --top 128 --matrix-size 10 --matrix-comb-deg 1 2 3 --matrix-deg 1 2 3 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --skip-finished --ref-only --test-rand-runs 20000 --skip-existing \
    --counters-only --no-sac --no-rpcs --no-reinit --check-json 0 --aggregation-factor 0.35
...
# Security margins experiment 4 for booltest, 10, 100 MB, origseed, max 2 ord
python ../booltest/booltest/testjobs.py  \
    --generator-path ../crypto-streams-v3.0 \
    --generator-folder ../bool-cfgs/exp4/ \
    --data-dir $RESDIR --job-dir $JOBDIR --result-dir=$RESDIR \
    --top 128 --matrix-comb-deg 1 2 --matrix-deg 1 2 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --no-functions --check-json 0 --aggregation-factor 0.25


# Security margins experiment 5 for booltest, 10, 100 MB, origseed, max 2 ord
python ../booltest/booltest/testjobs.py  \
    --generator-path ../crypto-streams-v3.0 \
    --generator-folder ../bool-cfgs/exp5/ \
    --data-dir $RESDIR --job-dir $JOBDIR --result-dir=$RESDIR \
    --top 128 --matrix-comb-deg 1 2 --matrix-deg 1 2 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --no-functions --check-json 0 --aggregation-factor 0.25
...
# Security margins
python ../booltest/booltest/testjobs.py  \
    --generator-path ../crypto-streams-v3.0-ph4-61331d0228ea2e \
    --generator-folder ../bool-conf-margins/exp25-26-27 \
    --data-dir $RESDIR --job-dir $JOBDIR --result-dir=$RESDIR \
    --top 128 --matrix-comb-deg 1 2 --matrix-deg 1 2 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --no-functions --check-json 0 --aggregation-factor 0.25 --skip-finished
...
python ../booltest/booltest/testjobs.py  \
    ...
    --top 128 --matrix-comb-deg 1 2 3 --matrix-deg 1 2 3 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --no-functions --check-json 0 --aggregation-factor 0.20 --skip-finished


# Ref, 80kx 10MB AES, 3 combinations high orders
python ../booltest/booltest/testjobs.py  \
    --generator-path ../crypto-streams-v3.0 \
    --data-dir $RESDIR --job-dir $JOBDIR --result-dir=$RESDIR \
    --top 128 --matrix-size 10 --matrix-comb-deg 1 2 3 --matrix-deg 1 2 3 --matrix-block 128 256 384 512 \
    --no-comb-and --only-top-comb --only-top-deg --no-term-map --topterm-heap \
    --topterm-heap-k 256 --skip-finished --ref-only --test-rand-runs 10000 --skip-existing \
    --counters-only --no-sac --no-rpcs --no-reinit --check-json 0 --aggregation-factor 0.40
...
python booltest/testjobsproc.py ../bool-res.tar --aes-ref --checkpoint
