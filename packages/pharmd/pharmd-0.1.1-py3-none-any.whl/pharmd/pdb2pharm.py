...
def create_parser():
    ...
    parser.add_argument('-i', '--input', metavar='input.pdb', required=True, type=str,
                        help='Input PDB file with a ligand-protein complex.')
    parser.add_argument('-g', '--lig_id', metavar='STRING', required=True, type=str,
                        help='three-letter ligand ID')
    parser.add_argument('-o', '--output', metavar='output.xyz', required=True, type=str,
                        help='output pharmacophore in xyz format.')
    return parser
