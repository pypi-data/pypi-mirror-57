...
def find_sift_2(im_source, im_search):
    ...
    # print(kp1[goodMatches[0].queryIdx].pt)
    # print(kp1[goodMatches[len(goodMatches)-1].queryIdx].pt)
    totalX = 0
    totoalY = 0
    ...
    if length > 0:
        ...
        # midX,midY = kp1[goodMatches[length/2].queryIdx].pt
        point = (int(midX), int(midY))
        return point
