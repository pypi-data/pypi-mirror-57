...
from miscnn.neural_network.metrics import dice_soft_loss, dice_crossentropy, tversky_loss

from keras import backend as K

unet_plain = Architecture()
model = Neural_Network(preprocessor=pp,
                       architecture=Architecture(activation='softmax'),
                       loss=tversky_loss,
                       metrics=[dice_crossentropy, dice_soft_loss, K.categorical_crossentropy])
