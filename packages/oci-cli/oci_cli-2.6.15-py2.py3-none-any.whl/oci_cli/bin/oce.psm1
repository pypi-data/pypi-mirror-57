...
function GetOciCommandsToLongParams_oce() {
    $ociCommandsToLongParams = @{
        ...
        'oce oce-instance create' = 'admin-email compartment-id defined-tags description freeform-tags from-json help idcs-access-token max-wait-seconds name object-storage-namespace tenancy-id tenancy-name wait-for-state wait-interval-seconds'
        'oce oce-instance delete' = 'force from-json help idcs-access-token if-match max-wait-seconds oce-instance-id wait-for-state wait-interval-seconds'
        ...
        'oce oce-instance update' = 'defined-tags description force freeform-tags from-json help if-match max-wait-seconds oce-instance-id wait-for-state wait-interval-seconds'
