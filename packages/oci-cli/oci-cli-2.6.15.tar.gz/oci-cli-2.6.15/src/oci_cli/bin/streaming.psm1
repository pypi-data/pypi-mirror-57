...
function GetOciSubcommands_streaming() {
    $ociSubcommands = @{
        ...
        'streaming admin' = 'archiver connect-harness stream stream-pool'
...
function GetOciCommandsToLongParams_streaming() {
    $ociCommandsToLongParams = @{
        ...
        'streaming admin stream-pool create' = 'compartment-id defined-tags freeform-tags from-json help kafka-settings max-wait-seconds name wait-for-state wait-interval-seconds'
        ...
        'streaming admin stream-pool update' = 'defined-tags force freeform-tags from-json help if-match kafka-settings max-wait-seconds stream-pool-id wait-for-state wait-interval-seconds'
