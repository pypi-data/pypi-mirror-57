...
ReportExportConfigTypeDef = TypedDict(
    ...
    {"exportConfigType": Literal["S3", "NO_EXPORT"], "s3Destination": S3ReportExportConfigTypeDef},
    total=False,
)
...
StartBuildOutputTypeDef = TypedDict("StartBuildOutputTypeDef", {"build": BuildTypeDef}, total=False)
