...
Mypy-friendly auto-generated type annotations for `boto3 codebuild 1.10.33` service.
...
client: codebuild.Client = boto3.client("codebuild")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: codebuild.Client = session.client("codebuild")
