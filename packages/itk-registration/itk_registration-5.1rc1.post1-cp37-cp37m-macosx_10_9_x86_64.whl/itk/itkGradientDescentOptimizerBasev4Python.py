...
class itkGradientDescentOptimizerBasev4TemplateD(itkObjectToObjectOptimizerBasePython.itkObjectToObjectOptimizerBaseTemplateD):
    ...
    __repr__ = _swig_repr
    StopConditionEnum_MAXIMUM_NUMBER_OF_ITERATIONS = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_MAXIMUM_NUMBER_OF_ITERATIONS
    StopConditionEnum_COSTFUNCTION_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_COSTFUNCTION_ERROR
    StopConditionEnum_UPDATE_PARAMETERS_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_UPDATE_PARAMETERS_ERROR
    StopConditionEnum_STEP_TOO_SMALL = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_STEP_TOO_SMALL
    StopConditionEnum_CONVERGENCE_CHECKER_PASSED = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_CONVERGENCE_CHECKER_PASSED
    StopConditionEnum_GRADIENT_MAGNITUDE_TOLEARANCE = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_GRADIENT_MAGNITUDE_TOLEARANCE
    StopConditionEnum_OTHER_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_StopConditionEnum_OTHER_ERROR
    ...
    def GetStopCondition(self) -> "itkGradientDescentOptimizerBasev4TemplateD::StopConditionEnum const &":
        """GetStopCondition(itkGradientDescentOptimizerBasev4TemplateD self) -> itkGradientDescentOptimizerBasev4TemplateD::StopConditionEnum const &"""
...
class itkGradientDescentOptimizerBasev4TemplateF(itkObjectToObjectOptimizerBasePython.itkObjectToObjectOptimizerBaseTemplateF):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    StopConditionEnum_MAXIMUM_NUMBER_OF_ITERATIONS = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_MAXIMUM_NUMBER_OF_ITERATIONS
    StopConditionEnum_COSTFUNCTION_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_COSTFUNCTION_ERROR
    StopConditionEnum_UPDATE_PARAMETERS_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_UPDATE_PARAMETERS_ERROR
    StopConditionEnum_STEP_TOO_SMALL = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_STEP_TOO_SMALL
    StopConditionEnum_CONVERGENCE_CHECKER_PASSED = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_CONVERGENCE_CHECKER_PASSED
    StopConditionEnum_GRADIENT_MAGNITUDE_TOLEARANCE = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_GRADIENT_MAGNITUDE_TOLEARANCE
    StopConditionEnum_OTHER_ERROR = _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_StopConditionEnum_OTHER_ERROR
    ...
    def GetStopCondition(self) -> "itkGradientDescentOptimizerBasev4TemplateF::StopConditionEnum const &":
        """GetStopCondition(itkGradientDescentOptimizerBasev4TemplateF self) -> itkGradientDescentOptimizerBasev4TemplateF::StopConditionEnum const &"""
