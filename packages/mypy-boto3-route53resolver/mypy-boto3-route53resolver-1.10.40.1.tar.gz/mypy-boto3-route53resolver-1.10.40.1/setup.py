...
setup(
    ...
    description="Type annotations for boto3.Route53Resolver 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 route53resolver type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
