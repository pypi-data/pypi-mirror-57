...
Mypy-friendly auto-generated type annotations for `boto3 managedblockchain 1.10.33` service.
...
client: managedblockchain.Client = boto3.client("managedblockchain")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: managedblockchain.Client = session.client("managedblockchain")
