...
class ChartsMixin(object):
    ...
    def barchart(self, key: AnyStr, data: pd.DataFrame, x: AnyStr, y: AnyStr, hue: AnyStr, title: AnyStr=None, x_axis: AnyStr=None, y_axis: AnyStr=None, y_ticks: List=None):
