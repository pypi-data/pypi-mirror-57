    ...
    def validate(self):
        ...
        .. remarks::
            ...
            * pipeline steps that form a loop or cycle
            ...
            pipelines <https://docs.microsoft.com/azure/machine-learning/service/how-to-debug-pipelines>`_.
    ...
    def load_yaml(workspace, filename, _workflow_provider=None, _service_endpoint=None):
        ...
        .. remarks::
            ...
            .. code-block:: python
                ...
                pipeline:
                    description: SamplePipelineFromYaml #NOTE: This parameter was named 'name' in a previous
                    release (now deprecated)
                    parameters:
                    ...
                    steps:
                        PrepareStep:
                            type:  ModuleStep #NOTE: step format is changed.
                            name: "TestModule"
                            ...
                            inputs:
                                in1:
                                    source: Dataset
                                    bind_mode: mount #NOTE: This parameter was named 'type' in a previous
                                     release (now deprecated)
                                in2:
