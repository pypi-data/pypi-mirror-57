...
class ChronopostService:
    ...
    def __init__(self, username, password, email, tipoEtiqueta=0,
    ...
    def create_xml_string(self, data):
        str1 = f'''
                ...
                <soap:Body>
                    <tem:RegistarExpedicao3 xmlns:ns0="http://tempuri.org/">
                        ...
                        <tem:expedicao>
                            ...
                            <tem:OrigemMoradaLinha2>{data['expedicao']['OrigemMoradaLinha2']}</tem:OrigemMoradaLinha2>
                            ...
                            <tem:DestinoMoradaLinha2>{data['expedicao']['DestinoMoradaLinha2']}</tem:DestinoMoradaLinha2>
    ...
    def dispatch(self, delivery: Delivery):
        ...
        data_string = self.create_xml_string(data)
