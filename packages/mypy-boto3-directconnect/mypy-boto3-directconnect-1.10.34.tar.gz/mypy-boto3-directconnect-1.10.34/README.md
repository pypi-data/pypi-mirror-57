...
Mypy-friendly auto-generated type annotations for `boto3 directconnect 1.10.34` service.
...
client: directconnect.Client = boto3.client("directconnect")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: directconnect.Client = session.client("directconnect")
