...
setup(
    ...
    description="Type annotations for boto3.EC2InstanceConnect 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 ec2-instance-connect type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
