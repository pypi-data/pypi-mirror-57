...
Mypy-friendly auto-generated type annotations for `boto3 ec2-instance-connect 1.10.33` service.
...
client: ec2_instance_connect.Client = boto3.client("ec2-instance-connect")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: ec2_instance_connect.Client = session.client("ec2-instance-connect")
