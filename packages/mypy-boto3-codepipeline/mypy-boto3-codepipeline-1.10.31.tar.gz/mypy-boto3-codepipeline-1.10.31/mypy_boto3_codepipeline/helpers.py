...
def boto3_client(
    ...
    if session is not None:
        return session.client("codepipeline", **kwargs)
    return boto3.client("codepipeline", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_action_executions_paginator(client: Client) -> ListActionExecutionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_action_types_paginator(client: Client) -> ListActionTypesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_pipeline_executions_paginator(client: Client) -> ListPipelineExecutionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_webhooks_paginator(client: Client) -> ListWebhooksPaginator:
    """
