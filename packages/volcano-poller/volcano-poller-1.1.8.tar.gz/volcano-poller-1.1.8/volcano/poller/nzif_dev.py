...
class NzifDevice(base_dev.BaseDevice):
    ...
    def __init__(self, my_xml_node, proposed_aux_name, parent_log):
        ...
        self.time_sync_delta_sec_ = p.get_int('timeSyncDeltaSec', min_val=0, max_val=600, default=0)
    ...
    def time_sync(self, ctx):
        ...
        # байтов валидно.
        req = bytes([self.addr_, 0x03, 0x0b, hi_bt(secs_to_add), lo_bt(secs_to_add)])
        comment = 'Adjust time'
