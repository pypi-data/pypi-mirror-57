...
class Conv2D(Layer):
    ...
    def forward_pass(self, x, training=True):
        ...
        self.X_col = image_to_column(self.x.data, self.filter_shape, stride=self.stride, output_shape=self.padding)
        ...
        if requires_grad:
            ...
            if x.requires_grad:
                depends_on.append(Dependency(self.x, self.grad_a_conv2D))
        else:
            depends_on = []
