...
class ApiCluster(object):
    ...
    def __init__(self, name=None, display_name=None, version=None, full_version=None, maintenance_mode=None, maintenance_owners=None, services=None, parcels=None, cluster_url=None, hosts_url=None, entity_status=None, uuid=None, data_context_refs=None, cluster_type=None):
        """
