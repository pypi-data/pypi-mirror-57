...
class Dolar():
  ...
  def get_cotacao(self):
    """
    Retorna a cotação atual do dólar em http://dolarhoje.com/ .
    Exemplo: 4.33
    """
  ...
  def get_cotacao_str(self):
    """"
    Retorna a cotação atual do dólar em String e adiciona formatação.
    Exemplo: R$4,33
    """
  ...
  def converter(self, value: float):
    """
    Converte :value: de dólar para real.
    $ -> R$
    """
  ...
  def converter_str(self, value:float):
    """
    Converte :value: de dólar para real em String e adiciona formatação.
    $ -> R$
    """
