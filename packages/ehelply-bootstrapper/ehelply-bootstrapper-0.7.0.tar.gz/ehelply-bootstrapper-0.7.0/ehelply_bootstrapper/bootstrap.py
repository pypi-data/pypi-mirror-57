...
class Bootstrap:
    ...
    def __init__(
        ...
        self.logger: Logger = Logger(debug_mode=self.verbosity)
        ...
        Environment(path=self.environment_path)
        ...
        self.logger.info(" * Verbosity: " + str(self.verbosity))
        self.logger.info(" * Environment path: " + str(self.environment_path))
        self.logger.info(" * Stage: " + str(Environment.stage()))
        self.logger.info(" * Configuration path: " + str(self.config_path))
        self.logger.info(" * Loading configs: " + str(self.configs))
        ...
        if (LOADABLE_FASTAPI in self.loadables) and self.dev_server:
    ...
    def sentry_init(self):
        ...
        :return:
        """
        Sentry(service_meta=self.service_meta, service_process=self.service_process).init()
