...
class TableExistsWaiter(Boto3Waiter):
    ...
    def wait(self, TableName: str, WaiterConfig: TableExistsWaitWaiterConfigTypeDef = None) -> None:
        """
        [table_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dynamodb.html#DynamoDB.Waiter.table_exists.wait)
        """
...
class TableNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [table_not_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/dynamodb.html#DynamoDB.Waiter.table_not_exists.wait)
        """
