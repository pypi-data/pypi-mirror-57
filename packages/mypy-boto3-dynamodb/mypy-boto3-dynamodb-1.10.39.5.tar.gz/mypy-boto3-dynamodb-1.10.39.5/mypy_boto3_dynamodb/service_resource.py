...
class DynamoDBServiceResource(Boto3ServiceResource):
    """
    [DynamoDB.ServiceResource documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource)
    """
    ...
    def Table(self, name: str) -> service_resource_scope.Table:
        """
        [ServiceResource.Table documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.Table)
        """
    ...
    def batch_get_item(
        ...
        """
        [ServiceResource.batch_get_item documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.batch_get_item)
        """
    ...
    def batch_write_item(
        ...
        """
        [ServiceResource.batch_write_item documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.batch_write_item)
        """
    ...
    def create_table(
        ...
        """
        [ServiceResource.create_table documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.create_table)
        """

    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_available_subresources(self) -> List[str]:
        """
        [ServiceResource.get_available_subresources documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.get_available_subresources)
        """


class Table(Boto3ServiceResource):
    """
    [Table documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.Table)
    """
...
class ServiceResourceTablesCollection(ResourceCollection):
    """
    [ServiceResource.tables documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.39/reference/services/dynamodb.html#DynamoDB.ServiceResource.tables)
    """
