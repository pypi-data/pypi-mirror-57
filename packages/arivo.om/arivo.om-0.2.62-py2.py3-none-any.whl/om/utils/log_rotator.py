...
class LogRotator(object):
    def __init__(self, directory, prefix="hour_", flush_interval=60.0):
    ...
    def filename(self, hour):
        return "{}{}.log".format(self.prefix, datetime.datetime.utcfromtimestamp(hour*self.rotation_time).strftime("%Y%m%d%H%M%S"))
