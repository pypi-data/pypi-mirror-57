...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_hours_of_operations_paginator(client: Client) -> ListHoursOfOperationsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_user_hierarchy_groups_paginator(client: Client) -> ListUserHierarchyGroupsPaginator:
    """
