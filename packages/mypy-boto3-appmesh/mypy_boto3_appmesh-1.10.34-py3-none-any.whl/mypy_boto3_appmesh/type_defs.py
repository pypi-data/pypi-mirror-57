...
ListMeshesPaginatePaginationConfigTypeDef = TypedDict(
    "ListMeshesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListMeshesPaginateResponsemeshesTypeDef = TypedDict(
    "ListMeshesPaginateResponsemeshesTypeDef", {"arn": str, "meshName": str}, total=False
)

ListMeshesPaginateResponseTypeDef = TypedDict(
    "ListMeshesPaginateResponseTypeDef",
    {"meshes": List[ListMeshesPaginateResponsemeshesTypeDef], "NextToken": str},
    total=False,
)

ListRoutesPaginatePaginationConfigTypeDef = TypedDict(
    "ListRoutesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRoutesPaginateResponseroutesTypeDef = TypedDict(
    "ListRoutesPaginateResponseroutesTypeDef",
    {"arn": str, "meshName": str, "routeName": str, "virtualRouterName": str},
    total=False,
)

ListRoutesPaginateResponseTypeDef = TypedDict(
...
ListVirtualNodesPaginatePaginationConfigTypeDef = TypedDict(
    "ListVirtualNodesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListVirtualNodesPaginateResponsevirtualNodesTypeDef = TypedDict(
    "ListVirtualNodesPaginateResponsevirtualNodesTypeDef",
    {"arn": str, "meshName": str, "virtualNodeName": str},
    total=False,
)

ListVirtualNodesPaginateResponseTypeDef = TypedDict(
...
ListVirtualRoutersPaginatePaginationConfigTypeDef = TypedDict(
    "ListVirtualRoutersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListVirtualRoutersPaginateResponsevirtualRoutersTypeDef = TypedDict(
    "ListVirtualRoutersPaginateResponsevirtualRoutersTypeDef",
    {"arn": str, "meshName": str, "virtualRouterName": str},
    total=False,
)

ListVirtualRoutersPaginateResponseTypeDef = TypedDict(
...
ListVirtualServicesPaginatePaginationConfigTypeDef = TypedDict(
    "ListVirtualServicesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListVirtualServicesPaginateResponsevirtualServicesTypeDef = TypedDict(
    "ListVirtualServicesPaginateResponsevirtualServicesTypeDef",
    {"arn": str, "meshName": str, "virtualServiceName": str},
    total=False,
)

ListVirtualServicesPaginateResponseTypeDef = TypedDict(
