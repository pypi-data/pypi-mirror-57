...
class ClusterActiveWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: ClusterActiveWaitWaiterConfigTypeDef = None) -> None:
        """
        [cluster_active.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/eks.html#EKS.Waiter.cluster_active.wait)
        """
...
class ClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(self, name: str, WaiterConfig: ClusterDeletedWaitWaiterConfigTypeDef = None) -> None:
        """
        [cluster_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/eks.html#EKS.Waiter.cluster_deleted.wait)
        """
...
class NodegroupActiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [nodegroup_active.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/eks.html#EKS.Waiter.nodegroup_active.wait)
        """
...
class NodegroupDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [nodegroup_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/eks.html#EKS.Waiter.nodegroup_deleted.wait)
        """
