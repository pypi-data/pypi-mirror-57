...
ClusterActiveWaitWaiterConfigTypeDef = TypedDict(
    "ClusterActiveWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)
...
ListClustersPaginateResponseTypeDef = TypedDict(
    "ListClustersPaginateResponseTypeDef", {"clusters": List[str], "NextToken": str}, total=False
)

ListFargateProfilesPaginatePaginationConfigTypeDef = TypedDict(
    "ListFargateProfilesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListFargateProfilesPaginateResponseTypeDef = TypedDict(
    "ListFargateProfilesPaginateResponseTypeDef",
    {"fargateProfileNames": List[str], "NextToken": str},
    total=False,
)

ListNodegroupsPaginatePaginationConfigTypeDef = TypedDict(
    "ListNodegroupsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListNodegroupsPaginateResponseTypeDef = TypedDict(
    "ListNodegroupsPaginateResponseTypeDef",
    {"nodegroups": List[str], "NextToken": str},
    total=False,
)

ListUpdatesPaginatePaginationConfigTypeDef = TypedDict(
    "ListUpdatesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListUpdatesPaginateResponseTypeDef = TypedDict(
    "ListUpdatesPaginateResponseTypeDef", {"updateIds": List[str], "NextToken": str}, total=False
)

NodegroupActiveWaitWaiterConfigTypeDef = TypedDict(
    "NodegroupActiveWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)

NodegroupDeletedWaitWaiterConfigTypeDef = TypedDict(
    "NodegroupDeletedWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)
