...
Mypy-friendly auto-generated type annotations for `boto3 eks 1.10.33` service.
...
client: eks.Client = boto3.client("eks")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: eks.Client = session.client("eks")
