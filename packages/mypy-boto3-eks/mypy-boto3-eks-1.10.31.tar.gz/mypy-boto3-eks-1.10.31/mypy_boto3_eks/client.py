...
class Client(BaseClient):
    ...
    def create_fargate_profile(
        ...
        Fargate profile in a cluster to be able to schedule pods on Fargate infrastructure.

        The Fargate profile allows an administrator to declare which pods run on Fargate
        infrastructure and specify which pods run on which Fargate profile. This declaration is done
        through the profile’s selectors. Each profile can have up to five selectors that contain a
        namespace and labels. A namespace is required for every selector. The label field consists
        of multiple optional key-value pairs. Pods that match the selectors are scheduled on Fargate
        infrastructure. If a to-be-scheduled pod matches any of the selectors in the Fargate
        ...
        `Role Based Access Control <https://kubernetes.io/docs/admin/authorization/rbac/>`__ (RBAC)
        for authorization so that the ``kubelet`` that is running on the Fargate infrastructure can
        register with your Amazon EKS cluster. This role is what allows Fargate infrastructure to
        appear in your cluster as nodes. The pod execution role also provides IAM permissions to the
        Fargate infrastructure to allow read access to Amazon ECR image repositories. For more
        information, see `Pod Execution Role
        <https://docs.aws.amazon.com/eks/latest/userguide/pod-execution-role.html>`__ in the *Amazon
        EKS User Guide* .
        ...
        <https://docs.aws.amazon.com/eks/latest/userguide/fargate-profile.html>`__ in the *Amazon
        EKS User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/CreateFargateProfile>`_
        ...
        **Request Syntax**
        ...
        :param podExecutionRoleArn: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/eks/latest/userguide/pod-execution-role.html>`__ in the
          *Amazon EKS User Guide* .
          ...
          - *(dict) --*
            ...
            - **fargateProfile** *(dict) --*
              ...
              - **podExecutionRoleArn** *(string) --*
                ...
                the selectors in the Fargate profile. For more information, see `Pod Execution Role
                <eks/latest/userguide/pod-execution-role.html>`__ in the *Amazon EKS User Guide* .
              ...
              - **tags** *(dict) --*
                ...
                the Fargate profile, such as the pods that are scheduled with it.
    ...
    def create_nodegroup(
        ...
        **Request Syntax**
        ...
        :param subnets: **[REQUIRED]**
          ...
          The subnets to use for the Auto Scaling group that is created for your node group. These
        ...
        :param remoteAccess:
          ...
          - **sourceSecurityGroups** *(list) --*
            ...
            specify an Amazon EC2 SSH key but do not specify a source security group when you create
            a managed node group, then port 22 on the worker nodes is opened to the internet
          ...
          - *(dict) --*
            ...
            - **nodegroup** *(dict) --*
                  ...
                  - *(dict) --*
                    ...
                    - **code** *(string) --*
                      ...
                      * **NodeCreationFailure** : Your launched instances are unable to register
                      ...
                      <https://docs.aws.amazon.com/eks/latest/userguide/worker_node_IAM_role.html>`__
              ...
              - **tags** *(dict) --*
                ...
                organization. Each tag consists of a key and an optional value, both of which you
                define. Node group tags do not propagate to any other resources associated with the
    ...
    def delete_fargate_profile(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/DeleteFargateProfile>`_
    ...
    def describe_fargate_profile(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/DescribeFargateProfile>`_
    ...
    def list_fargate_profiles(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/eks-2017-11-01/ListFargateProfiles>`_
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          between 1 and 100. If you don't use this parameter, ``ListFargateProfiles`` returns up to
    ...
    def update_nodegroup_version(
        ...
        **Request Syntax**
        ...
        :param force:
          ...
          disruption budget issue. If an update fails because pods could not be drained, you can
          force the update after it fails to terminate the old node whether or not any pods are
          running on the node.
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_fargate_profiles` operation.
        """
