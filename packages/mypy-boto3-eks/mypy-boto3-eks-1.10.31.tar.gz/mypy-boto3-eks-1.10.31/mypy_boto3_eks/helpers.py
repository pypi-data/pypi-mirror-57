...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_fargate_profiles_paginator(client: Client) -> ListFargateProfilesPaginator:
    """
    Equivalent of `client.get_paginator('list_fargate_profiles')`, returns a correct type.
    """
    return client.get_paginator("list_fargate_profiles")
