...
"}")
        ...
        self.subcallbutton_17.setFocusPolicy(QtCore.Qt.NoFocus)
...
"}")
        ...
        self.load_current_tool.setFocusPolicy(QtCore.Qt.NoFocus)
...
"")
        ...
        self.store_current_tool.setFocusPolicy(QtCore.Qt.NoFocus)
...
"}")
        ...
        self.m6_button_atc.setFocusPolicy(QtCore.Qt.NoFocus)
...
"}")
        ...
        self.load_current_tool_2 = MDIButton(self.frame_17)
        self.load_current_tool_2.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.load_current_tool_2.sizePolicy().hasHeightForWidth())
        self.load_current_tool_2.setSizePolicy(sizePolicy)
        self.load_current_tool_2.setMinimumSize(QtCore.QSize(120, 45))
        self.load_current_tool_2.setMaximumSize(QtCore.QSize(16777215, 45))
        self.load_current_tool_2.setFocusPolicy(QtCore.Qt.NoFocus)
        self.load_current_tool_2.setStyleSheet("MDIButton {\n"
"       font: 16pt \"Bebas Kai\";\n"
"}")
        self.load_current_tool_2.setCheckable(False)
        self.load_current_tool_2.setAutoExclusive(True)
        self.load_current_tool_2.setObjectName("load_current_tool_2")
        self.horizontalLayout_79.addWidget(self.load_current_tool_2)
...
"}")
        ...
        self.atc_tool_number_entry_box_2 = VCPLineEdit(self.frame_17)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.atc_tool_number_entry_box_2.sizePolicy().hasHeightForWidth())
        self.atc_tool_number_entry_box_2.setSizePolicy(sizePolicy)
        self.atc_tool_number_entry_box_2.setMinimumSize(QtCore.QSize(60, 43))
        self.atc_tool_number_entry_box_2.setMaximumSize(QtCore.QSize(16777215, 43))
        self.atc_tool_number_entry_box_2.setSizeIncrement(QtCore.QSize(0, 40))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.HighlightedText, brush)
        self.atc_tool_number_entry_box_2.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Bebas Kai")
        ...
        font.setItalic(False)
        font.setWeight(50)
        self.atc_tool_number_entry_box_2.setFont(font)
        self.atc_tool_number_entry_box_2.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.atc_tool_number_entry_box_2.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.atc_tool_number_entry_box_2.setStyleSheet("font: 16pt;")
        self.atc_tool_number_entry_box_2.setFrame(True)
        self.atc_tool_number_entry_box_2.setAlignment(QtCore.Qt.AlignCenter)
        self.atc_tool_number_entry_box_2.setObjectName("atc_tool_number_entry_box_2")
        self.horizontalLayout_145.addWidget(self.atc_tool_number_entry_box_2)
        self.m6_button_atc_2 = MDIButton(self.frame_17)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.m6_button_atc_2.sizePolicy().hasHeightForWidth())
        self.m6_button_atc_2.setSizePolicy(sizePolicy)
        self.m6_button_atc_2.setMinimumSize(QtCore.QSize(120, 45))
        self.m6_button_atc_2.setMaximumSize(QtCore.QSize(16777215, 45))
        self.m6_button_atc_2.setSizeIncrement(QtCore.QSize(0, 45))
        self.m6_button_atc_2.setFocusPolicy(QtCore.Qt.NoFocus)
        self.m6_button_atc_2.setStyleSheet("QPushButton {\n"
"       font: 16pt \"Bebas Kai\";\n"
"}")
        self.m6_button_atc_2.setObjectName("m6_button_atc_2")
        self.horizontalLayout_145.addWidget(self.m6_button_atc_2)
...
"}")
        ...
        self.m01_break_button_29 = ActionButton(self.frame_18)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.m01_break_button_29.sizePolicy().hasHeightForWidth())
        self.m01_break_button_29.setSizePolicy(sizePolicy)
        self.m01_break_button_29.setMinimumSize(QtCore.QSize(150, 45))
        self.m01_break_button_29.setMaximumSize(QtCore.QSize(16777215, 45))
        self.m01_break_button_29.setFocusPolicy(QtCore.Qt.NoFocus)
        self.m01_break_button_29.setStyleSheet("QPushButton {\n"
"       font: 16pt \"Bebas Kai\";\n"
"}")
        self.m01_break_button_29.setObjectName("m01_break_button_29")
        self.horizontalLayout_100.addWidget(self.m01_break_button_29)
...
"}")
        ...
        self.offset_table.horizontalHeader().setDefaultSectionSize(78)
...
"")
        ...
        self.horizontalLayout_61.setContentsMargins(90, 3, 90, 3)
...
"")
        ...
        self.tabWidget_24.setMinimumSize(QtCore.QSize(251, 600))
...
"}")
        ...
        self.m6_button_main.setFocusPolicy(QtCore.Qt.NoFocus)
        self.m6_button_main.setToolTipDuration(3)
...
"}")
        ...
        self.main_dro_qframe.setMinimumSize(QtCore.QSize(486, 340))
        self.main_dro_qframe.setMaximumSize(QtCore.QSize(486, 340))
...
"}")
        ...
        self.zero_all_button = MDIButton(self.main_dro_qframe)
...
"}")
        ...
        self.ref_all_button = ActionButton(self.main_dro_qframe)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.statuslabel_75.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTop|QtCore.Qt.AlignTrailing)
...
"}")
        ...
        self.atc_tool_number_entry_box.returnPressed.connect(self.m6_button_atc.click)
        self.atc_tool_number_entry_box_2.returnPressed.connect(self.m6_button_atc_2.click)
        self.load_spindle_tool_number_2.returnPressed.connect(self.load_current_tool_2.click)
...
"USB"))
        ...
        self.load_current_tool_2.setText(_translate("Form", "LOAD SPINDLE"))
        self.load_current_tool_2.setProperty("rules", _translate("Form", "[]"))
        self.load_current_tool_2.setProperty("MDICommand", _translate("Form", "M61 Q#<load_spindle_tool_number_2>"))
        ...
        self.atc_tool_number_entry_box_2.setText(_translate("Form", "0"))
        self.atc_tool_number_entry_box_2.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"tooltable:current_tool?tool_number\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"str(ch[0])\", \"name\": \"update tool num\"}, {\"channels\": [{\"url\": \"status:task_state?text\", \"trigger\": true}, {\"url\": \"status:interp_state?text\", \"trigger\": true}], \"property\": \"Enable\", \"expression\": \"ch[0] == \'On\' and ch[1] == \'Idle\'\", \"name\": \"enable/disable\"}]"))
        self.m6_button_atc_2.setText(_translate("Form", "M6"))
        self.m6_button_atc_2.setProperty("MDICommand", _translate("Form", "T#<atc_tool_number_entry_box_2> M6"))
        self.machine_column_header_8.setText(_translate("Form", "ELECTRONIC TOOL SETTER"))
        self.m01_break_button_29.setText(_translate("Form", "TOUCH OFF CURRENT TOOL"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tool_tab), _translate("Form", "          TOOL          "))
        self.offset_table.setProperty("displayColumns", _translate("Form", "XYZABR"))
...
"]"))
        ...
        self.x_tool_change_position.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"status:aout\", \"trigger\": true}], \"property\": \"Value\", \"expression\": \"ch[0][13]\", \"name\": \"x_axis_g30_set_position\"}]"))
        self.x_tool_change_position.setProperty("settingName", _translate("Form", "tool-change-position.x-tool-change-position"))
        self.x_tool_change_position.setProperty("textFormat", _translate("Form", "{:0.4f}"))
        self.label_57.setText(_translate("Form", "Y"))
        self.y_tool_change_position.setPlaceholderText(_translate("Form", "0.0000"))
        self.y_tool_change_position.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"status:aout\", \"trigger\": true}], \"property\": \"Value\", \"expression\": \"ch[0][14]\", \"name\": \"y_axis_g30_set_position\"}]"))
        self.y_tool_change_position.setProperty("settingName", _translate("Form", "tool-change-position.y-tool-change-position"))
        self.y_tool_change_position.setProperty("textFormat", _translate("Form", "{:0.4f}"))
        self.label_58.setText(_translate("Form", "Z"))
        self.z_tool_change_position.setPlaceholderText(_translate("Form", "0.0000"))
        self.z_tool_change_position.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"status:aout\", \"trigger\": true}], \"property\": \"Value\", \"expression\": \"ch[0][15]\", \"name\": \"z_axis_g30_set_position\"}]"))
        self.z_tool_change_position.setProperty("settingName", _translate("Form", "tool-change-position.z-tool-change-position"))
        self.z_tool_change_position.setProperty("textFormat", _translate("Form", "{:0.4f}"))
        ...
        self.calibration_offset.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"status:aout\", \"trigger\": true}], \"property\": \"Value\", \"expression\": \"ch[0][12]\", \"name\": \"auto_cal_offset\"}]"))
        self.calibration_offset.setProperty("settingName", _translate("Form", "touch-probe.calibration-offset"))
        self.calibration_offset.setProperty("textFormat", _translate("Form", "{:0.6f}"))
        ...
        self.m6_button_main.setToolTip(_translate("Form", "M6 Tool Change command that will perform a tool change to the tool specified in the adjacent \'T\' Box"))
        self.m6_button_main.setWhatsThis(_translate("Form", "M6 Tool Change command that will perform a tool change to the tool specified in the adjacent \'T\' Box"))
