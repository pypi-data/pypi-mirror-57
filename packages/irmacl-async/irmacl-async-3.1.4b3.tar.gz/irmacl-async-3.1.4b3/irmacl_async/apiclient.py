...
class FilesAAPI(AAPIView):
    ...
    async def search(
        ...
        submitter_type=None, tags=None, sort=None, offset=None, limit=None,
        ...
        None)
        :param submitter_type: string, filter results with specific
            submitter_type. (default None)
        ...
        if submitter_type is not None:
            query["submitter_type"] = submitter_type
