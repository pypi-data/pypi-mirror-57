...
def boto3_client(
    ...
    if session is not None:
        return session.client("forecast", **kwargs)
    return boto3.client("forecast", **kwargs)
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_dataset_import_jobs_paginator(client: Client) -> ListDatasetImportJobsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_forecast_export_jobs_paginator(client: Client) -> ListForecastExportJobsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_forecasts_paginator(client: Client) -> ListForecastsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_predictors_paginator(client: Client) -> ListPredictorsPaginator:
    """
