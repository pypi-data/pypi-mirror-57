...
def main():
    ...
    while True:
        ...
        numberOfHeadlines = input()
        if not numberOfHeadlines.isdecimal():
    ...
    website = random.choice(['wobsite', 'blag', 'Facebuck', 'Googles', 'Facesbook', 'Wikipedia entry', 'Tweedie', 'Pastagram'])
    when = random.choice(WHEN).lower()
    print('Post these to our {} {} or you\'re fired!'.format(website, when))
