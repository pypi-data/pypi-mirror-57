...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, name=None, base_path=None, pulp_created=None, pulp_href=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
