...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, name=None, base_path=None, content_guard=None, pulp_created=None, repository_version=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
