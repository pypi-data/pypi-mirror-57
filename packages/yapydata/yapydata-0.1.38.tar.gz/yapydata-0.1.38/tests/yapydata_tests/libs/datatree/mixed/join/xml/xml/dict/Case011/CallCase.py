...
class CallUnits(unittest.TestCase):
 ...
 #       sys.path.insert(0, mypath) 
    ...
    def testCase010(self):
        _cap = DataTreeXML()
        _cap.import_data(os.path.dirname(__file__) + os.sep + 'data', striproot=True)
        
        _cap1 = DataTreeXML()
        _cap1.import_data(os.path.dirname(__file__) + os.sep + 'data1', striproot=True)
        
        _cap.join(_cap1.data)
