...
from yapydata.datatree.synyaml import DataTreeYAML, YapyDataYAMLError, readout_data
...
#       sys.path.insert(0, mypath) 
    ...
    def testCase010(self):
        ...
        with open(os.path.dirname(__file__) + os.sep + 'res.json') as data_file:
            ydata = json.load(data_file)
        
        resx =  readout_data(ydata)
