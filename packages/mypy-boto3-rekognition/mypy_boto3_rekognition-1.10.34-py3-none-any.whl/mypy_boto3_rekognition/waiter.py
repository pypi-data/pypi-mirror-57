...
class ProjectVersionRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [project_version_running.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rekognition.html#Rekognition.Waiter.project_version_running.wait)
        """
...
class ProjectVersionTrainingCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [project_version_training_completed.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rekognition.html#Rekognition.Waiter.project_version_training_completed.wait)
        """
