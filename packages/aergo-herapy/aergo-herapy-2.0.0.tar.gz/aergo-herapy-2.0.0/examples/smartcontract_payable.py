...
def run():
    ...
    try:
        ...
        sender_private_key = "47DTHPaRpbJ67KZvBaciz68EJ5k6E2FNBUuknKR6NA4t8oyA3uyvjS2QKxJ7JsgHMunPUitoT"
        sender_account = aergo.import_account(exported_data=sender_private_key, password="1234")
        ...
        print("------ Deploy SC -----------")
        tx, result = aergo.deploy_sc(amount=10, payload=payload, args=1234,
                                     gas_limit=2)
        ...
        print("------ Fail SC -----------")
        tx, result = aergo.call_sc(sc_address, "set_none", gas_limit=2)
        time.sleep(3)
        result = aergo.get_tx_result(tx.tx_hash)
