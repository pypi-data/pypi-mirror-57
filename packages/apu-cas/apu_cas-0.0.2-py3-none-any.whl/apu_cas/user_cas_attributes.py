...
def save_user_cas_attributes(user_cas_attributes_payload):
    """
    Saves CAS user attributes into namespace variable, retrieve it through get_user_cas_attributes()
    """
    globals.cas_user_attributes = UserCasAttributes(user_cas_attributes_payload)


def get_user_cas_attributes() -> UserCasAttributes:
    """
    :return: CAS user attributes from namespace variable
    """
    return globals.cas_user_attributes
