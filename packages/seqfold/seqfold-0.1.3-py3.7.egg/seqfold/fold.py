...
def calc_dg(seq: str, temp: float, verbose: bool = False) -> float:
    ...
    Optional Args:
        verbose: Whether to log the structure as well
...
def run():
    ...
    dg = calc_dg(parsed_args.seq, temp=parsed_args.temp, verbose=parsed_args.verbose)
    print(dg)
