...
static PyModuleDef openal_module = {
	PyModuleDef_HEAD_INIT,
	"igeOpenAL.sound",							// Module name to use with Python import statements
	"OpenAL Sound Module.",						// Module description
	0,
	sound_methods								// Structure that defines the methods of the module
};

PyMODINIT_FUNC PyInit_igeOpenAL() {
	PyObject* module = PyModule_Create(&openal_module);
