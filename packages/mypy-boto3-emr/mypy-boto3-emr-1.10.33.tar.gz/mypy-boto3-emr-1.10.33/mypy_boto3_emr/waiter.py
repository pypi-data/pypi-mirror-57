...
class ClusterRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [cluster_running.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/emr.html#EMR.Waiter.cluster_running.wait)
        """
...
class ClusterTerminatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [cluster_terminated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/emr.html#EMR.Waiter.cluster_terminated.wait)
        """
...
class StepCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [step_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/emr.html#EMR.Waiter.step_complete.wait)
        """
