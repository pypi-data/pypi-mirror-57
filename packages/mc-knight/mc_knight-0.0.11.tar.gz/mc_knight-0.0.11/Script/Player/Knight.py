...
class Knight:
    ...
    def CheckCollision(self):
        ...
        return True
    def CheckMill(self):
        if self.direction==0 and self.collider[self.posY,self.posX] == 7:
            print('触发碰撞，类型7')
            return True
        elif self.direction==1 and self.collider[self.posY,self.posX]==7:
            print('触发碰撞，类型7')
            return True
        elif self.direction==2 and self.collider[self.posY,self.posX]==7:
            print('触发碰撞，类型7')
            return True
        elif self.direction==3 and self.collider[self.posY,self.posX]==7:
            print('触发碰撞，类型7')
            return True
        return False
