...
def LoadLevel07():
    return Level07(MCGame.GetInstance().screen,6,7)
def LoadLevel08():
    return Level08(MCGame.GetInstance().screen,6,8)
def LoadLevel09():
    return Level09(MCGame.GetInstance().screen,6,8)
def LoadLevel10():
    return Level10(MCGame.GetInstance().screen,6,9)