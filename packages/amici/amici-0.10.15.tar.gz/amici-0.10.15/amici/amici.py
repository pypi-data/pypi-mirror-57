...
class SolverPtr(object):
    ...
    def setup(self, t0, model, x0, dx0, sx0, sdx0):
        ...
        :type sx0: AmiVectorArray
        :param sx0: initial state sensitivities
        :type sdx0: AmiVectorArray
    ...
    def setupB(self, which, tf, model, xB0, dxB0, xQB0):
        r"""
        Initialises the AMI memory object for the backwards problem
        :type which: int
    ...
    def setPreequilibration(self, require_preequilibration):
        r"""
    ...
    def getNewtonDampingFactorMode(self):
        r"""
    ...
    def setNewtonDampingFactorMode(self, dampingFactorMode):
        r"""
    ...
    def getNewtonDampingFactorLowerBound(self):
        r"""
    ...
    def setNewtonDampingFactorLowerBound(self, dampingFactorLowerBound):
        r"""
    ...
    def reInit(self, t0, yy0, yp0):
        r"""
        Reinitializes the states in the solver after an event occurence
    ...
    def sensReInit(self, yyS0, ypS0):
        r"""
        Reinitializes the state sensitivites in the solver after an
        event occurence

        :type yyS0: AmiVectorArray
        :param yyS0: new state sensitivity
        :type ypS0: AmiVectorArray
    ...
    def reInitB(self, which, tB0, yyB0, ypB0):
        r"""
        Reinitializes the adjoint states after an event occurence
    ...
    def quadReInitB(self, which, yQB0):
        r"""
        Reinitialize the adjoint states after an event occurence
...
class ReturnDataPtr(object):
    ...
    def initializeObjectiveFunction(self):
        r"""initializeObjectiveFunction"""
        return _amici.ReturnDataPtr_initializeObjectiveFunction(self)

    def invalidate(self, t):
        r"""
        Set likelihood, state variables, outputs and respective
    ...
    def invalidateLLH(self):
        r"""
        Set likelihood and chi2 to NaN
    ...
    def invalidateSLLH(self):
        r"""
        Set likelihood sensitivities to NaN
        (typically after integration failure)
        """
    ...
    def applyChainRuleFactorToSimulationResults(self, model):
        r"""
        applies the chain rule to account for parameter transformation
    ...
    sx = property(_amici.ReturnDataPtr_sx_get, _amici.ReturnDataPtr_sx_set, doc=r"""
    ...
    sres = property(_amici.ReturnDataPtr_sres_get, _amici.ReturnDataPtr_sres_set, doc=r"""
     parameter derivative of residual (dimension: nt*ny x nplist,
    row-major)
    """)
    FIM = property(_amici.ReturnDataPtr_FIM_get, _amici.ReturnDataPtr_FIM_set, doc=r"""
    ...
    newton_status = property(_amici.ReturnDataPtr_newton_status_get, _amici.ReturnDataPtr_newton_status_set, doc=r""" flag indicating success of Newton solver""")
    newton_cpu_time = property(_amici.ReturnDataPtr_newton_cpu_time_get, _amici.ReturnDataPtr_newton_cpu_time_set, doc=r""" computation time of the Newton solver [ms]""")
    newton_numsteps = property(_amici.ReturnDataPtr_newton_numsteps_get, _amici.ReturnDataPtr_newton_numsteps_set, doc=r"""
    number of Newton steps for steady state problem
        [newton, simulation, newton] (length = 3)
    """)
    newton_numlinsteps = property(_amici.ReturnDataPtr_newton_numlinsteps_get, _amici.ReturnDataPtr_newton_numlinsteps_set, doc=r"""
    ...
    """)
    t_steadystate = property(_amici.ReturnDataPtr_t_steadystate_get, _amici.ReturnDataPtr_t_steadystate_set, doc=r""" time at which steadystate was reached in the simulation based approach""")
    wrms_steadystate = property(_amici.ReturnDataPtr_wrms_steadystate_get, _amici.ReturnDataPtr_wrms_steadystate_set, doc=r"""
    weighted root-mean-square of the rhs when steadystate
        was reached
    """)
    wrms_sensi_steadystate = property(_amici.ReturnDataPtr_wrms_sensi_steadystate_get, _amici.ReturnDataPtr_wrms_sensi_steadystate_set, doc=r"""
    weighted root-mean-square of the rhs when steadystate
        was reached
    """)
    ...
    sx_ss = property(_amici.ReturnDataPtr_sx_ss_get, _amici.ReturnDataPtr_sx_ss_set, doc=r""" preequilibration sensitivities found by Newton solver (dimension: nplist x nx, row-major)""")
...
class ModelPtr(object):
    ...
    def setParameterList(self, plist):
        r"""
        Set the list of parameters for which sensitivities are
    ...
    def hasCustomInitialStates(self):
        r"""
    ...
    def hasCustomInitialStateSensitivities(self):
        r"""
    ...
    def requireSensitivitiesForAllParameters(self):
        r"""
        Require computation of sensitivities for all parameters p
    ...
    def getObservable(self, y, t, x):
        ...
        :type y: gsl::span< amici::realtype >
    ...
    def getObservableSensitivity(self, sy, t, x, sx):
        r"""
        Sensitivity of time-resolved observables,
        total derivative sy = dydx * sx + dydp (only for forward sensitivities)
        :type sy: gsl::span< amici::realtype >
    ...
    def addObservableObjective(self, Jy, it, x, edata):
        r"""
        Time-resolved measurement negative log-likelihood Jy
        :type Jy: float
    ...
    def addObservableObjectiveSensitivity(self, sllh, s2llh, it, x, sx, edata):
        r"""
        Sensitivity of time-resolved measurement negative log-likelihood
        Jy, total derivative (to be used with forward senstivities)
        :type sllh: std::vector< amici::realtype,std::allocator< amici::realtype > >
        :param sllh: first order buffer (dimension: nplist)
        :type s2llh: std::vector< amici::realtype,std::allocator< amici::realtype > >
    ...
    def getAdjointStateObservableUpdate(self, dJydx, it, x, edata):
        r"""
        State sensitivity of the negative loglikelihood Jy,
        partial derivative (to be used with adjoint senstivities)
        :type dJydx: gsl::span< amici::realtype >
    ...
    def getEvent(self, z, ie, t, x):
        r"""
        Event-resolved observables
        :type z: gsl::span< amici::realtype >
    ...
    def getEventSensitivity(self, sz, ie, t, x, sx):
        r"""
        Sensitivities of event-resolved observables, total derivative,
    ...
    def getEventRegularization(self, rz, ie, t, x):
        r"""
        Regularization for event-resolved observables
        :type rz: gsl::span< amici::realtype >
    ...
    def getEventRegularizationSensitivity(self, srz, ie, t, x, sx):
        r"""
        Sensitivities of regularization for event-resolved observables,
        total derivative (only forward sensitivities)
        :type srz: gsl::span< amici::realtype >
    ...
    def addEventObjective(self, Jz, ie, nroots, t, x, edata):
        r"""
        Event-resolved observable negative log-likelihood,
        :type Jz: float
    ...
    def getAdjointStateEventUpdate(self, dJzdx, ie, nroots, t, x, edata):
        ...
        partial derivative (to be used with adjoint senstivities)
        :type dJzdx: gsl::span< amici::realtype >
    ...
    def getEventTimeSensitivity(self, stau, t, ie, x, sx):
        r"""
        Sensitivity of event timepoint, total derivative (only forward
        sensi)
        :type stau: std::vector< amici::realtype,std::allocator< amici::realtype > >
    ...
    def setAlwaysCheckFinite(self, alwaysCheck):
        r"""
        Set if the result of every call to Model::f* should be checked
        for finiteness
    ...
    def wasPythonGenerated(self):
        r"""
        check whether the model was generated from python
        :rtype: boolean
        :return: that
        """
    ...
    dxdotdp = property(_amici.ModelPtr_dxdotdp_get, _amici.ModelPtr_dxdotdp_set, doc=r"""
    ...
    def froot(self, t, x, dx, root):
        ...
        :type root: gsl::span< amici::realtype >
...
class ExpData(object):
    ...
    def __init__(self, *args):
        ...
        *Overload 8:*
        ...
        constructor that initializes with returnData, adds noise
...
class ConditionContext(object):
    ...
    def __init__(self, model, edata=None):
        ...
        :param edata:
        """
        _amici.ConditionContext_swiginit(self, _amici.new_ConditionContext(model, edata))
...
class ReturnData(object):
    ...
    sx = property(_amici.ReturnData_sx_get, _amici.ReturnData_sx_set, doc=r"""
     parameter derivative of state (dimension: nt x nplist x nx,
    row-major)
    """)
    ...
    sres = property(_amici.ReturnData_sres_get, _amici.ReturnData_sres_set, doc=r"""
     parameter derivative of residual (dimension: nt*ny x nplist,
    row-major)
    """)
    FIM = property(_amici.ReturnData_FIM_get, _amici.ReturnData_FIM_set, doc=r"""
     fisher information matrix (dimension: nplist x nplist,
    row-major)
    """)
    ...
    newton_status = property(_amici.ReturnData_newton_status_get, _amici.ReturnData_newton_status_set, doc=r""" flag indicating success of Newton solver""")
    newton_cpu_time = property(_amici.ReturnData_newton_cpu_time_get, _amici.ReturnData_newton_cpu_time_set, doc=r""" computation time of the Newton solver [ms]""")
    newton_numsteps = property(_amici.ReturnData_newton_numsteps_get, _amici.ReturnData_newton_numsteps_set, doc=r"""
    number of Newton steps for steady state problem
        [newton, simulation, newton] (length = 3)
    """)
    newton_numlinsteps = property(_amici.ReturnData_newton_numlinsteps_get, _amici.ReturnData_newton_numlinsteps_set, doc=r"""
    number of linear steps by Newton step for steady state problem. this
        will only be filled for iterative solvers (length = newton_maxsteps * 2)
    """)
    t_steadystate = property(_amici.ReturnData_t_steadystate_get, _amici.ReturnData_t_steadystate_set, doc=r""" time at which steadystate was reached in the simulation based approach""")
    wrms_steadystate = property(_amici.ReturnData_wrms_steadystate_get, _amici.ReturnData_wrms_steadystate_set, doc=r"""
    weighted root-mean-square of the rhs when steadystate
        was reached
    """)
    wrms_sensi_steadystate = property(_amici.ReturnData_wrms_sensi_steadystate_get, _amici.ReturnData_wrms_sensi_steadystate_set, doc=r"""
    weighted root-mean-square of the rhs when steadystate
        was reached
    """)
    ...
    sx_ss = property(_amici.ReturnData_sx_ss_get, _amici.ReturnData_sx_ss_set, doc=r""" preequilibration sensitivities found by Newton solver (dimension: nplist x nx, row-major)""")
...
class Model(AbstractModel):
    ...
    dxdotdp = property(_amici.Model_dxdotdp_get, _amici.Model_dxdotdp_set, doc=r"""
     temporary storage of dxdotdp data across functions (dimension: nplist x
    nx_solver, row-major)
    """)
...
class Model_ODE(Model):
    ...
    def froot(self, *args):
        r"""
        implementation of froot at the N_Vector level
...
def readSimulationExpData(hdf5Filename, hdf5Root, model):
    r"""
    readSimulationExpData reads AMICI experimental data from
...
def writeSimulationExpData(edata, file, hdf5Location):
    r"""
    writeSimulationExpData writes AMICI experimental data to
    attributes in HDF5 file.
    :type edata: :py:class:`ExpData`
...
def printErrMsgIdAndTxt(id, message):
    r"""
...
def printWarnMsgIdAndTxt(id, message):
    r"""
...
class AmiciApplication(object):
    ...
    def runAmiciSimulation(self, solver, edata, model, rethrow=False):
        r"""
    ...
    def runAmiciSimulations(self, solver, edatas, model, failfast, num_threads):
        r"""
