...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-wafv2", "1.19.0", __name__, "aws-wafv2@1.19.0.jsii.tgz")
...
class CfnIPSet(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-wafv2.CfnIPSet"):
    ...
    """
    def __init__(self, scope_: aws_cdk.core.Construct, id: str, *, name: str, scope: str, addresses: typing.Optional[typing.Union[typing.Optional["IPAddressesProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, description: typing.Optional[str]=None, ip_address_version: typing.Optional[str]=None, tags: typing.Optional["TagListProperty"]=None) -> None:
        ...
        """
        props = CfnIPSetProps(name=name, scope=scope, addresses=addresses, description=description, ip_address_version=ip_address_version, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-wafv2.CfnIPSetProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'scope': 'scope', 'addresses': 'addresses', 'description': 'description', 'ip_address_version': 'ipAddressVersion', 'tags': 'tags'})
class CfnIPSetProps():
    def __init__(self, *, name: str, scope: str, addresses: typing.Optional[typing.Union[typing.Optional["CfnIPSet.IPAddressesProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, description: typing.Optional[str]=None, ip_address_version: typing.Optional[str]=None, tags: typing.Optional["CfnIPSet.TagListProperty"]=None):
...
class CfnRegexPatternSet(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-wafv2.CfnRegexPatternSet"):
    ...
    """
    def __init__(self, scope_: aws_cdk.core.Construct, id: str, *, name: str, scope: str, description: typing.Optional[str]=None, regular_expression_list: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["RegularExpressionListProperty"]]]=None, tags: typing.Optional["TagListProperty"]=None) -> None:
        ...
        """
        props = CfnRegexPatternSetProps(name=name, scope=scope, description=description, regular_expression_list=regular_expression_list, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-wafv2.CfnRegexPatternSetProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'scope': 'scope', 'description': 'description', 'regular_expression_list': 'regularExpressionList', 'tags': 'tags'})
class CfnRegexPatternSetProps():
    def __init__(self, *, name: str, scope: str, description: typing.Optional[str]=None, regular_expression_list: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnRegexPatternSet.RegularExpressionListProperty"]]]=None, tags: typing.Optional["CfnRegexPatternSet.TagListProperty"]=None):
...
class CfnRuleGroup(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-wafv2.CfnRuleGroup"):
    ...
    def __init__(self, scope_: aws_cdk.core.Construct, id: str, *, name: str, scope: str, capacity: typing.Optional[jsii.Number]=None, description: typing.Optional[str]=None, rules: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["RulesProperty"]]]=None, tags: typing.Optional["TagListProperty"]=None, visibility_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["VisibilityConfigProperty"]]]=None) -> None:
        ...
        """
        props = CfnRuleGroupProps(name=name, scope=scope, capacity=capacity, description=description, rules=rules, tags=tags, visibility_config=visibility_config)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-wafv2.CfnRuleGroupProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'scope': 'scope', 'capacity': 'capacity', 'description': 'description', 'rules': 'rules', 'tags': 'tags', 'visibility_config': 'visibilityConfig'})
class CfnRuleGroupProps():
    def __init__(self, *, name: str, scope: str, capacity: typing.Optional[jsii.Number]=None, description: typing.Optional[str]=None, rules: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnRuleGroup.RulesProperty"]]]=None, tags: typing.Optional["CfnRuleGroup.TagListProperty"]=None, visibility_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnRuleGroup.VisibilityConfigProperty"]]]=None):
...
class CfnWebACL(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-wafv2.CfnWebACL"):
    ...
    """
    def __init__(self, scope_: aws_cdk.core.Construct, id: str, *, name: str, scope: str, default_action: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["DefaultActionProperty"]]]=None, description: typing.Optional[str]=None, rules: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["RulesProperty"]]]=None, tags: typing.Optional["TagListProperty"]=None, visibility_config: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["VisibilityConfigProperty"]]]=None) -> None:
        ...
        """
        props = CfnWebACLProps(name=name, scope=scope, default_action=default_action, description=description, rules=rules, tags=tags, visibility_config=visibility_config)
