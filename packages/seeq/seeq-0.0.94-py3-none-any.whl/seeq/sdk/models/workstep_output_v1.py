...
class WorkstepOutputV1(object):
    ...
    def __init__(self, created_at=None, data=None, description=None, href=None, id=None, is_archived=False, last=None, name=None, next=None, previous=None, status_message=None, type=None):
        """
