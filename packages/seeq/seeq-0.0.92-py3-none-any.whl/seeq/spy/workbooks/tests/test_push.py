...
def _find_item(original_id):
    return spy.workbooks.Workbook.find_item(original_id, _login.user.username)
...
def test_worksheet_order():
    ...
    worksheet_1 = _find_item('686B7041-D922-4256-979A-3B9BB8915E88')
    worksheet_2 = _find_item('31AF5986-00F9-4B77-B02B-BFC3603DA26B')
    worksheet_3 = _find_item('2BEC414E-2F58-45A0-83A6-AAB098812D38')
...
def test_archived_worksheets():
    ...
    archived_worksheet = _find_item('C28D3F17-C7BB-43B7-B670-41550D623CDF')
...
def test_images():
    ...
    image_worksheet = _find_item('787EA985-A7FB-4ACE-910A-91BC712A38A1')
...
def test_copied_workbook_with_journal():
    ...
    copied_worksheet = _find_item('46F3F25C-3229-470E-96A9-4D838D0F53CE')
...
def test_topic_links():
    ...
    document_worksheet = _find_item('4D0F99FD-8778-470B-9295-1776D587047E')
