...
class ItemOutputV1(object):
    ...
    def __init__(self, ancillaries=None, cached=False, description=None, href=None, id=None, is_archived=False, name=None, properties=None, scoped_to=None, status_message=None, type=None):
        """
