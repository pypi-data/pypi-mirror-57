...
class ItemSearchPreviewV1(object):
    ...
    def __init__(self, ancestors=None, datasource=None, description=None, href=None, id=None, is_archived=False, name=None, source_value_unit_of_measure=None, type=None, value_unit_of_measure=None):
        """
