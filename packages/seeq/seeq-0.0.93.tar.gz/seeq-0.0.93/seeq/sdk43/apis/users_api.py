...
class UsersApi(object):
    ...
    def autocomplete_users_and_groups(self, **kwargs):
        ...
        :param bool include_datasource_name: Whether to include the datasource name in the results
    ...
    def autocomplete_users_and_groups_with_http_info(self, **kwargs):
        ...
        all_params = ['query', 'include_datasource_name']
        ...
        query_params = []
        if 'include_datasource_name' in params:
            query_params.append(('includeDatasourceName', params['include_datasource_name']))
    ...
    def update_user(self, **kwargs):
        ...
        :param UserUpdateV1 body: User Update information (required)
        :return: UserOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        """
