...
class TreeItemOutputV1(object):
    ...
    def __init__(self, description=None, has_children=False, href=None, id=None, is_archived=False, name=None, status_message=None, type=None, value_unit_of_measure=None):
        """
