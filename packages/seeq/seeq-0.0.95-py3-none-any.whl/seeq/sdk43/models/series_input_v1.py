...
class SeriesInputV1(object):
    ...
    def __init__(self, data_id=None, data_version_check=None, datasource_class=None, datasource_id=None, description=None, formula=None, host_id=None, interpolation_method=None, key_unit_of_measure=None, maximum_interpolation=None, name=None, parameters=None, properties=None, scoped_to=None, sync_token=None, value_unit_of_measure=None):
        """
    ...
    def datasource_class(self):
        ...
        The datasource class, which is the type of system holding the series, such as OSIsoft PI
    ...
    def datasource_id(self):
        ...
        The datasource ID, which is how the datasource identifies itself
    ...
    def properties(self):
        ...
        Properties to set on this series. A property consists of a name, a value, and a unit of measure.
