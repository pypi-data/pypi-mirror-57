...
class AssetOutputV1(object):
    ...
    def __init__(self, data_id=None, datasource_class=None, datasource_id=None, description=None, href=None, id=None, is_archived=False, name=None, scoped_to=None, status_message=None, type=None):
        """
