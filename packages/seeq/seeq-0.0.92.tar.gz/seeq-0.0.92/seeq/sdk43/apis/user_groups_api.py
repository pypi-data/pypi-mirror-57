...
class UserGroupsApi(object):
    ...
    def add_identity_to_user_group(self, **kwargs):
        ...
        :param str identity_id: ID of the user or user group to add. For convenience, it can also be a username. (required)
    ...
    def remove_identity_from_user_group(self, **kwargs):
        ...
        :param str identity_id: ID of the user or user group to remove. For convenience, it can also be a username. (required)
        :return: UserGroupOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        """
