...
class AnnotationOutputV1(object):
    ...
    def __init__(self, access_level=None, backups=None, created_at=None, created_by=None, description=None, discoverable=False, document=None, href=None, id=None, interests=None, is_archived=False, name=None, published_at=None, replies=None, replies_to=None, status_message=None, type=None, updated_at=None):
        """
    ...
    def access_level(self):
        """
        Gets the access_level of this AnnotationOutputV1.
        The access level the current user has to the item.

        :return: The access_level of this AnnotationOutputV1.
        :rtype: str
        """
    ...
    def access_level(self, access_level):
        """
        Sets the access_level of this AnnotationOutputV1.
        The access level the current user has to the item.

        :param access_level: The access_level of this AnnotationOutputV1.
        :type: str
        """
