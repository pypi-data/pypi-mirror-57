...
class ScalarInputV1(object):
    ...
    def __init__(self, data_id=None, description=None, formula=None, name=None, number_format=None, parameters=None, properties=None, scoped_to=None, sync_token=None, unit_of_measure=None):
        """
