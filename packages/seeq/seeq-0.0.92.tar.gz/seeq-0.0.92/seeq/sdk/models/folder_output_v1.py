...
class FolderOutputV1(object):
    ...
    def __init__(self, access_level=None, ancestors=None, created_at=None, description=None, href=None, id=None, is_archived=False, marked_as_favorite=False, name=None, owner=None, parent_folder_id=None, status_message=None, type=None, updated_at=None):
        """
    ...
    def access_level(self):
        """
        Gets the access_level of this FolderOutputV1.
        The access level the current user has to the item.

        :return: The access_level of this FolderOutputV1.
        :rtype: str
        """
    ...
    def access_level(self, access_level):
        """
        Sets the access_level of this FolderOutputV1.
        The access level the current user has to the item.

        :param access_level: The access_level of this FolderOutputV1.
        :type: str
        """
    ...
    def marked_as_favorite(self):
        ...
        Flag indicating whether this folder has been marked as a favorite by the current user
    ...
    def parent_folder_id(self):
        ...
        The ID of the parent folder which this folder is a subfolder of
