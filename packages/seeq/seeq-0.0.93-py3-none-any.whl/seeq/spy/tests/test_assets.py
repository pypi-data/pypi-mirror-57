...
def test_components():
    ...
    metadata_df['Build Path'] = 'Components Test'
    ...
    metadata_df.at[metadata_df['Name'] == 'Area E_Temperature', 'Build Asset'] = 'Refrigerator 3'

    build_df = spy.assets.build(Refrigerator, metadata_df)
    ...
    assert_instantiations(search_results_df, [
        ('Components Test', 'Refrigerator 1', 'Temperature', 'CalculatedSignal'),
        ('Components Test >> Refrigerator 1', 'Compressor 1', 'Power', 'CalculatedSignal'),
        ('Components Test >> Refrigerator 1', 'Compressor 2', 'Power', 'CalculatedSignal'),
        ('Components Test', 'Refrigerator 2', 'Temperature', 'CalculatedSignal'),
        ('Components Test >> Refrigerator 2', 'Compressor 3', 'Power', 'CalculatedSignal'),
        ('Components Test >> Refrigerator 2', 'Compressor 4', 'Power', 'CalculatedSignal'),
        ('Components Test', 'Refrigerator 3', 'Temperature', 'CalculatedSignal')
    ])
