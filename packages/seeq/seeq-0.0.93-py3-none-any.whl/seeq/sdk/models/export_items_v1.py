...
class ExportItemsV1(object):
    ...
    def __init__(self, autoupdate_time_range=False, capsule_time=False, export_capsules=False, export_name=None, format=None, grid_enabled=True, grid_size=None, items=None, original_timestamps_enabled=False, statistics_enabled=True, swap_in=None, swap_out=None):
        """
    ...
    def autoupdate_time_range(self):
        ...
        Boolean indicating if the time range for export should be updated to 'now' when export is started.
    ...
    def grid_enabled(self):
        ...
        Boolean indicating if the data grid should be included.
    ...
    def original_timestamps_enabled(self):
        ...
        If the original sample period should be used this value will be true. A manual or automatic grid size may be used when false.
    ...
    def statistics_enabled(self):
        ...
        Boolean indicating if the summary statistics should be included. This flag only applies to Excel exports.
