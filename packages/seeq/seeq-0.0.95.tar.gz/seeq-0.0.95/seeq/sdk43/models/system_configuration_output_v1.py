...
class SystemConfigurationOutputV1(object):
    ...
    def __init__(self, default_auth_auto_login=False, default_auth_provider_id=None, default_max_capsule_duration=None, default_max_interpolation=None, maximum_threads=None, parallelization_threshold=None, priorities=None, registration_enabled=False, restrict_logs=False, status_message=None):
        """
