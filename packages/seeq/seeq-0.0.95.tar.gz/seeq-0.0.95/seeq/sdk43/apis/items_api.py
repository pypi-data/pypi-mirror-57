...
class ItemsApi(object):
    ...
    def change_owner(self, **kwargs):
        """
        Change the owner of the specified item to the specified user. You need full control of the item to be able to change the owner.
    ...
    def remove_access_control_entry_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/items/{id}/acl/{aceId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def search_items_with_http_info(self, **kwargs):
        ...
        all_params = ['filters', 'scope', 'asset', 'types', 'offset', 'limit']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
