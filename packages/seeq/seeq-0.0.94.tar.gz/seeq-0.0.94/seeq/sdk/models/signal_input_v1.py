...
class SignalInputV1(object):
    ...
    def __init__(self, additional_properties=None, data_version_check=None, description=None, formula=None, formula_parameters=None, interpolation_method=None, key_unit_of_measure=None, maximum_interpolation=None, name=None, number_format=None, scoped_to=None, sync_token=None, value_unit_of_measure=None):
        """
    ...
    def additional_properties(self):
        ...
        Additional properties to set on the signal
