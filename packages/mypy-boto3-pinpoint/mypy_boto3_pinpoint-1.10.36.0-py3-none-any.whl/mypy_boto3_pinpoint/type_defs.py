"Main interface for pinpoint service type defs"
...
_RequiredCampaignEmailMessageTypeDef = TypedDict(
    "_RequiredCampaignEmailMessageTypeDef", {"Title": str}
)
_OptionalCampaignEmailMessageTypeDef = TypedDict(
    "_OptionalCampaignEmailMessageTypeDef",
    {"Body": str, "FromAddress": str, "HtmlBody": str},
    total=False,
)


class CampaignEmailMessageTypeDef(
    _RequiredCampaignEmailMessageTypeDef, _OptionalCampaignEmailMessageTypeDef
):
    pass
...
TemplateTypeDef = TypedDict("TemplateTypeDef", {"Name": str}, total=False)
...
EmailMessageActivityTypeDef = TypedDict(
    ...
    {"MessageConfig": JourneyEmailMessageTypeDef, "NextActivity": str, "TemplateName": str},
    total=False,
)
...
_OptionalTemplateResponseTypeDef = TypedDict(
    ...
    {"Arn": str, "DefaultSubstitutions": str, "tags": Dict[str, str], "TemplateDescription": str},
    total=False,
)
