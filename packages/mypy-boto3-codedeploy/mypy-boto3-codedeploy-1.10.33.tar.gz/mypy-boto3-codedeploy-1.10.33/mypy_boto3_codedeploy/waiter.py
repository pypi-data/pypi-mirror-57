...
class DeploymentSuccessfulWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [deployment_successful.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/codedeploy.html#CodeDeploy.Waiter.deployment_successful.wait)
        """
