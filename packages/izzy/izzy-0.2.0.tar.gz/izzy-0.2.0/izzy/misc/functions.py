...
class ArrayLike:
    ...
    Note: this class is not implemented. Don't use it, because it doesn't do anything.
    """

    # Types covered by ArrayLike
    types = (list, tuple, set, np.ndarray, pd.Series, pd.DataFrame)
