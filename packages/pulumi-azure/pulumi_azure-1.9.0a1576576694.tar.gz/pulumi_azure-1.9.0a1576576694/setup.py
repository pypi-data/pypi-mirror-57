...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.9.0-alpha.1576576694+gf33a8dc9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.9.0-alpha.1576576694+gf33a8dc9`
                """)
            else:
                raise
