...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.8.0-alpha.1576145007+g8e24bea9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.8.0-alpha.1576145007+g8e24bea9`
                """)
            else:
                raise
