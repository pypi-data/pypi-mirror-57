...
def boto3_client(
    ...
    if session is not None:
        return session.client("autoscaling-plans", **kwargs)
    return boto3.client("autoscaling-plans", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_scaling_plan_resources_paginator(
    client: Client,
) -> DescribeScalingPlanResourcesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_scaling_plans_paginator(client: Client) -> DescribeScalingPlansPaginator:
    """
