...
diff = (Tester(NAME)
        ...
        .add("Eternity", data="Eternity_07x05.json")  # ok, instantiation more compact
        .add("Eternity", data="Eternity_example.txt", prs_py="Eternity_Parser", prs_jv="Eternity_Parser")  # ok, instantiation more compact
