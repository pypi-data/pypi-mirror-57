...
Mypy-friendly auto-generated type annotations for `boto3 securityhub 1.10.33` service.
...
client: securityhub.Client = boto3.client("securityhub")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: securityhub.Client = session.client("securityhub")
