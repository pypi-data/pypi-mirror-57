...
def get_get_enabled_standards_paginator(client: Client) -> GetEnabledStandardsPaginator:
    ...
    """
    return client.get_paginator("get_enabled_standards")
...
def get_get_insights_paginator(client: Client) -> GetInsightsPaginator:
    ...
    """
    return client.get_paginator("get_insights")
...
def get_list_enabled_products_for_import_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_enabled_products_for_import')`, returns a correct
    type.
    """
    return client.get_paginator("list_enabled_products_for_import")
