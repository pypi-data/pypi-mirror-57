...
Mypy-friendly auto-generated type annotations for `boto3 redshift 1.10.33` service.
...
client: redshift.Client = boto3.client("redshift")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: redshift.Client = session.client("redshift")
