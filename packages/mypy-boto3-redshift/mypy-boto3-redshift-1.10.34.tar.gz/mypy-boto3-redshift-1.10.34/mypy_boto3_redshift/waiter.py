...
class ClusterAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [cluster_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/redshift.html#Redshift.Waiter.cluster_available.wait)
        """
...
class ClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [cluster_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/redshift.html#Redshift.Waiter.cluster_deleted.wait)
        """
...
class ClusterRestoredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [cluster_restored.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/redshift.html#Redshift.Waiter.cluster_restored.wait)
        """
...
class SnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [snapshot_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/redshift.html#Redshift.Waiter.snapshot_available.wait)
        """
