...
class AnyInstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [any_instance_in_service.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elb.html#ElasticLoadBalancing.Waiter.any_instance_in_service.wait)
        """
...
class InstanceDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_deregistered.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elb.html#ElasticLoadBalancing.Waiter.instance_deregistered.wait)
        """
...
class InstanceInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_in_service.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elb.html#ElasticLoadBalancing.Waiter.instance_in_service.wait)
        """
