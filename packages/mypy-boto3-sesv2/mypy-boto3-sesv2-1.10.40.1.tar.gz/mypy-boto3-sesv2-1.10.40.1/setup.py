...
setup(
    ...
    description="Type annotations for boto3.SESV2 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 sesv2 type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
