...
from dli.logging import AnalyticsHandler
from dli.siren import siren_to_entity, PatchedSirenBuilder
...
class DliClient(Accounts, AutoRegMetadata,
    ...
    def _setup_logging(self):
        ...
        analytics_handler = AnalyticsHandler(client=self, capacity=1)
        ...
        if self.debug:
            ...
            analytics_handler.setFormatter(json_format)
