...
class TestLoggingExt:
    ...
    def test_debug_logging_is_logged_correctly(self, client, monkeypatch):
        client.log_debug()
    ...
    def test_info_logging_is_logged_correctly(self, client, monkeypatch):
        client.log_info()
    ...
    def test_warning_logging_is_logged_correctly(self, client, monkeypatch):
        client.log_warning()
    ...
    def test_error_logging_is_logged_correctly(self, client, monkeypatch):
        client.log_error()
    ...
    def test_exception_logging_is_logged_correctly(self, client, monkeypatch):
