...
class Package(SirenComponent):
    ...
    def get_package_datasets(self, package_id, count=100):
        ...
        return self.session.get(
            package_urls.package_datasets.format(id=package_id),
    ...
    def register_package(
        ...
        :param bool is_internal_within_organisation: Optional. Default True. Can the package be viewed by other organisations
    ...
    def edit_package(
        ...
        **kwargs
        ...
        :keyword str intended_purpose: Optional. Provides details about intended usage of the data contained
                                     in the package, e.g. permanent storage, temporary storage, POC.
        :keyword bool is_internal_within_organisation: Optional. Can the package be viewed by other organisations
    ...
    def _get_package(self, **kwargs):
        response = self.session.get(
            package_urls.package_index, params=kwargs
        )
