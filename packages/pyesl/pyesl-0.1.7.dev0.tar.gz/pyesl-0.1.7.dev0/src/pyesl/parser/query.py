...
class QueryParser(object):
        ...
        **生成单个metric的N个field之间聚合运算语句块**
        ...
        - Example::
            ...
            aggs = QueryParser.single_aggs(
                fields={
                    'name1': 'ms_gb_distinct.count', 'name2': 'ms_gb_distinct.distinctcount', 'param1': 2}, func='sum',
        ...
        _qc = QueryCalculation(fields=_fields, expr=expr, func=func, terms=_filters, expr_params=_params)
        return _qc
    ...
    def aggs_cal(
        ...
        **聚合运算结果之间的四则运算**
        ...
        :param calculations: 聚合运算语句块或聚合运算参数
