...
VSRE = r"^__version__ = ['\"]([^'\"]*)['\"]"
VERSIONFILE = "h5traj/_version.py"
...
if (3, 0) <= sys.version_info[0:2] < (3, 4):
    exit_with_error("You need Python 3.4+ to install H5Traj!")
...
setup_args = {
    'name':             "h5traj",
    'version':          verstr,
    'description':      "HDF5-backed MDTraj",
    'long_description': "An HDF5-backed variant of MDTraj, designed to minimize memory usage",
