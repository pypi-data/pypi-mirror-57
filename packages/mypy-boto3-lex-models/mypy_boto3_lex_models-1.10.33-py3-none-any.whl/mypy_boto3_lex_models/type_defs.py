...
GetBotAliasesPaginatePaginationConfigTypeDef = TypedDict(
    "GetBotAliasesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetBotAliasesPaginateResponseBotAliasesTypeDef = TypedDict(
...
GetBotAliasesPaginateResponseTypeDef = TypedDict(
    "GetBotAliasesPaginateResponseTypeDef",
    {"BotAliases": List[GetBotAliasesPaginateResponseBotAliasesTypeDef], "NextToken": str},
    total=False,
)

GetBotChannelAssociationsPaginatePaginationConfigTypeDef = TypedDict(
    "GetBotChannelAssociationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetBotChannelAssociationsPaginateResponsebotChannelAssociationsTypeDef = TypedDict(
...
GetBotChannelAssociationsPaginateResponseTypeDef = TypedDict(
...
GetBotVersionsPaginatePaginationConfigTypeDef = TypedDict(
    "GetBotVersionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetBotVersionsPaginateResponsebotsTypeDef = TypedDict(
...
GetIntentVersionsPaginatePaginationConfigTypeDef = TypedDict(
    "GetIntentVersionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetIntentVersionsPaginateResponseintentsTypeDef = TypedDict(
...
GetIntentsPaginateResponseTypeDef = TypedDict(
    "GetIntentsPaginateResponseTypeDef",
    {"intents": List[GetIntentsPaginateResponseintentsTypeDef], "NextToken": str},
    total=False,
)

GetSlotTypeVersionsPaginatePaginationConfigTypeDef = TypedDict(
    "GetSlotTypeVersionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetSlotTypeVersionsPaginateResponseslotTypesTypeDef = TypedDict(
...
GetSlotTypeVersionsPaginateResponseTypeDef = TypedDict(
...
GetSlotTypesPaginatePaginationConfigTypeDef = TypedDict(
    "GetSlotTypesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetSlotTypesPaginateResponseslotTypesTypeDef = TypedDict(
...
GetSlotTypesPaginateResponseTypeDef = TypedDict(
