...
if __name__=="__main__":
    mycal = iCalendar()
    mycal.debug(False,"../rsc/utest_logs/log.txt",-2)
    ics_fp = "D:\\Git\\pyICSParser\\rsc\\utest\\test_vect\\by_ferie.ics"
    mycal.local_load(ics_fp)
#            mycal.parse_loaded()
    print("RRULE Compute","*"*50,ics_fp)
    #### COPY THIS CODE IN __MAIN__ of pyiCalendar for debug
    start, end = '20110101', '20121231'
    dates = mycal.get_event_instances(start,end)


elif __name__=="__main__2":
