...
This code was originally published under the Apache Licence v2, which is
included here. Only one line has been changed and marked.
...
### Changed by Jan Maximilian Michal on 30 Dec 2016
# was 'from .._compat import fields'
