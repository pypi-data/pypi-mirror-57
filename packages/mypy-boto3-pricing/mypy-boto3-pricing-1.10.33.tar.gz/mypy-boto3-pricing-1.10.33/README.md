...
Mypy-friendly auto-generated type annotations for `boto3 pricing 1.10.33` service.
...
client: pricing.Client = boto3.client("pricing")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: pricing.Client = session.client("pricing")
