    ...
    def create_state_machine(
        ...
        **Request Syntax**
        ...
        :param type:
          ...
          Determines whether a Standard or Express state machine is created. If not set, Standard is
          created.
        ...
        :param loggingConfiguration:
          ...
          - **includeExecutionData** *(boolean) --*
            ...
            Determines whether execution history data is included in your log. When set to ``FALSE``
            , data is excluded.

          - **destinations** *(list) --*

            An object that describes where your execution history events will be logged. Limited to
            ...
            - *(dict) --*
              ...
              - **cloudWatchLogsLogGroup** *(dict) --*
                ...
                `AWS\\:\\:Logs\\:\\:LogGroup
                <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-loggroup.html>`__
          ...
          - *(dict) --*
            ...
            - **loggingConfiguration** *(dict) --*
              ...
              - **includeExecutionData** *(boolean) --*
                ...
                Determines whether execution history data is included in your log. When set to
                ``FALSE`` , data is excluded.

              - **destinations** *(list) --*

                An object that describes where your execution history events will be logged. Limited
                to size 1. Required, if your log level is not set to ``OFF`` .
