...
GENSETTINGS = GenSettings(songfinder.__settingsPath__, songfinder.__dataPath__, songfinder.__portable__)
PRESSETTINGS = PresSettings(songfinder.__settingsPath__, songfinder.__dataPath__, songfinder.__portable__)
LATEXSETTINGS = LatexSettings(songfinder.__settingsPath__, songfinder.__dataPath__, songfinder.__portable__)
GENSETTINGS.create()
GENSETTINGS.read()
PRESSETTINGS.create()
PRESSETTINGS.read()
