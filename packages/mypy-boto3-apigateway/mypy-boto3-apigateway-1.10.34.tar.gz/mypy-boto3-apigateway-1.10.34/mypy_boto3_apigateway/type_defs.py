...
GetApiKeysPaginatePaginationConfigTypeDef = TypedDict(
    "GetApiKeysPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetApiKeysPaginateResponseitemsTypeDef = TypedDict(
...
GetApiKeysPaginateResponseTypeDef = TypedDict(
...
GetBasePathMappingsPaginatePaginationConfigTypeDef = TypedDict(
    "GetBasePathMappingsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetBasePathMappingsPaginateResponseitemsTypeDef = TypedDict(
    "GetBasePathMappingsPaginateResponseitemsTypeDef",
    {"basePath": str, "restApiId": str, "stage": str},
    total=False,
)

GetBasePathMappingsPaginateResponseTypeDef = TypedDict(
    "GetBasePathMappingsPaginateResponseTypeDef",
    {"items": List[GetBasePathMappingsPaginateResponseitemsTypeDef], "NextToken": str},
    total=False,
)

GetClientCertificatesPaginatePaginationConfigTypeDef = TypedDict(
    "GetClientCertificatesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetClientCertificatesPaginateResponseitemsTypeDef = TypedDict(
...
GetClientCertificatesPaginateResponseTypeDef = TypedDict(
...
GetDeploymentsPaginateResponseitemsapiSummaryTypeDef = TypedDict(
...
GetDocumentationPartsPaginatePaginationConfigTypeDef = TypedDict(
    "GetDocumentationPartsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetDocumentationPartsPaginateResponseitemslocationTypeDef = TypedDict(
...
GetDocumentationPartsPaginateResponseitemsTypeDef = TypedDict(
...
GetDocumentationPartsPaginateResponseTypeDef = TypedDict(
    "GetDocumentationPartsPaginateResponseTypeDef",
    {"items": List[GetDocumentationPartsPaginateResponseitemsTypeDef], "NextToken": str},
    total=False,
)

GetDocumentationVersionsPaginatePaginationConfigTypeDef = TypedDict(
    "GetDocumentationVersionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetDocumentationVersionsPaginateResponseitemsTypeDef = TypedDict(
    "GetDocumentationVersionsPaginateResponseitemsTypeDef",
    {"version": str, "createdDate": datetime, "description": str},
    total=False,
)

GetDocumentationVersionsPaginateResponseTypeDef = TypedDict(
...
GetDomainNamesPaginateResponseitemsendpointConfigurationTypeDef = TypedDict(
...
GetGatewayResponsesPaginatePaginationConfigTypeDef = TypedDict(
    "GetGatewayResponsesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetGatewayResponsesPaginateResponseitemsTypeDef = TypedDict(
...
GetGatewayResponsesPaginateResponseTypeDef = TypedDict(
...
GetRequestValidatorsPaginatePaginationConfigTypeDef = TypedDict(
    "GetRequestValidatorsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetRequestValidatorsPaginateResponseitemsTypeDef = TypedDict(
    "GetRequestValidatorsPaginateResponseitemsTypeDef",
    {"id": str, "name": str, "validateRequestBody": bool, "validateRequestParameters": bool},
    total=False,
)

GetRequestValidatorsPaginateResponseTypeDef = TypedDict(
...
GetResourcesPaginateResponseitemsresourceMethodsmethodIntegrationintegrationResponsesTypeDef = TypedDict(
...
GetResourcesPaginateResponseitemsresourceMethodsmethodIntegrationTypeDef = TypedDict(
...
GetResourcesPaginateResponseitemsresourceMethodsmethodResponsesTypeDef = TypedDict(
    "GetResourcesPaginateResponseitemsresourceMethodsmethodResponsesTypeDef",
    {"statusCode": str, "responseParameters": Dict[str, bool], "responseModels": Dict[str, str]},
    total=False,
)

GetResourcesPaginateResponseitemsresourceMethodsTypeDef = TypedDict(
...
GetResourcesPaginateResponseitemsTypeDef = TypedDict(
...
GetRestApisPaginatePaginationConfigTypeDef = TypedDict(
    "GetRestApisPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetRestApisPaginateResponseitemsendpointConfigurationTypeDef = TypedDict(
    "GetRestApisPaginateResponseitemsendpointConfigurationTypeDef",
    {"types": List[Literal["REGIONAL", "EDGE", "PRIVATE"]], "vpcEndpointIds": List[str]},
    total=False,
)

GetRestApisPaginateResponseitemsTypeDef = TypedDict(
...
GetRestApisPaginateResponseTypeDef = TypedDict(
    "GetRestApisPaginateResponseTypeDef",
    {"items": List[GetRestApisPaginateResponseitemsTypeDef], "NextToken": str},
    total=False,
)

GetSdkTypesPaginatePaginationConfigTypeDef = TypedDict(
    "GetSdkTypesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetSdkTypesPaginateResponseitemsconfigurationPropertiesTypeDef = TypedDict(
    "GetSdkTypesPaginateResponseitemsconfigurationPropertiesTypeDef",
    {"name": str, "friendlyName": str, "description": str, "required": bool, "defaultValue": str},
    total=False,
)

GetSdkTypesPaginateResponseitemsTypeDef = TypedDict(
...
GetUsagePlanKeysPaginatePaginationConfigTypeDef = TypedDict(
    "GetUsagePlanKeysPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetUsagePlanKeysPaginateResponseitemsTypeDef = TypedDict(
    "GetUsagePlanKeysPaginateResponseitemsTypeDef",
    {"id": str, "type": str, "value": str, "name": str},
    total=False,
)

GetUsagePlanKeysPaginateResponseTypeDef = TypedDict(
    "GetUsagePlanKeysPaginateResponseTypeDef",
    {"items": List[GetUsagePlanKeysPaginateResponseitemsTypeDef], "NextToken": str},
    total=False,
)

GetUsagePlansPaginatePaginationConfigTypeDef = TypedDict(
    "GetUsagePlansPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetUsagePlansPaginateResponseitemsapiStagesthrottleTypeDef = TypedDict(
    "GetUsagePlansPaginateResponseitemsapiStagesthrottleTypeDef",
    {"burstLimit": int, "rateLimit": float},
    total=False,
)

GetUsagePlansPaginateResponseitemsapiStagesTypeDef = TypedDict(
...
GetUsagePlansPaginateResponseitemsquotaTypeDef = TypedDict(
    "GetUsagePlansPaginateResponseitemsquotaTypeDef",
    {"limit": int, "offset": int, "period": Literal["DAY", "WEEK", "MONTH"]},
    total=False,
)

GetUsagePlansPaginateResponseitemsthrottleTypeDef = TypedDict(
    "GetUsagePlansPaginateResponseitemsthrottleTypeDef",
    {"burstLimit": int, "rateLimit": float},
    total=False,
)

GetUsagePlansPaginateResponseitemsTypeDef = TypedDict(
...
GetUsagePlansPaginateResponseTypeDef = TypedDict(
    "GetUsagePlansPaginateResponseTypeDef",
    {"items": List[GetUsagePlansPaginateResponseitemsTypeDef], "NextToken": str},
    total=False,
)

GetVpcLinksPaginatePaginationConfigTypeDef = TypedDict(
    "GetVpcLinksPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

GetVpcLinksPaginateResponseitemsTypeDef = TypedDict(
...
GetVpcLinksPaginateResponseTypeDef = TypedDict(
