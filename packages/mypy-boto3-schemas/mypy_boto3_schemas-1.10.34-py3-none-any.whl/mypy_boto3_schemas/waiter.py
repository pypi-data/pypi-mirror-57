...
class CodeBindingExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [code_binding_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/schemas.html#Schemas.Waiter.code_binding_exists.wait)
        """
