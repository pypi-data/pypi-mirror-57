...
Mypy-friendly auto-generated type annotations for `boto3 schemas 1.10.33` service.
...
```bash
pip install boto3-stubs[mypy-boto3-schemas]
```
...
client: schemas.Client = boto3.client("schemas")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: schemas.Client = session.client("schemas")
