...
ListChannelsPaginateResponsechannelSummarieschannelStoragecustomerManagedS3TypeDef = TypedDict(
    "ListChannelsPaginateResponsechannelSummarieschannelStoragecustomerManagedS3TypeDef",
    {"bucket": str, "keyPrefix": str, "roleArn": str},
    total=False,
)

ListChannelsPaginateResponsechannelSummarieschannelStorageTypeDef = TypedDict(
...
ListChannelsPaginateResponsechannelSummariesTypeDef = TypedDict(
...
ListDatasetContentsPaginatePaginationConfigTypeDef = TypedDict(
    "ListDatasetContentsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListDatasetContentsPaginateResponsedatasetContentSummariesstatusTypeDef = TypedDict(
    "ListDatasetContentsPaginateResponsedatasetContentSummariesstatusTypeDef",
    {"state": Literal["CREATING", "SUCCEEDED", "FAILED"], "reason": str},
    total=False,
)

ListDatasetContentsPaginateResponsedatasetContentSummariesTypeDef = TypedDict(
...
ListDatasetContentsPaginateResponseTypeDef = TypedDict(
...
ListDatasetsPaginateResponsedatasetSummariesactionsTypeDef = TypedDict(
    "ListDatasetsPaginateResponsedatasetSummariesactionsTypeDef",
    {"actionName": str, "actionType": Literal["QUERY", "CONTAINER"]},
    total=False,
)

ListDatasetsPaginateResponsedatasetSummariestriggersdatasetTypeDef = TypedDict(
    "ListDatasetsPaginateResponsedatasetSummariestriggersdatasetTypeDef", {"name": str}, total=False
)

ListDatasetsPaginateResponsedatasetSummariestriggersscheduleTypeDef = TypedDict(
    "ListDatasetsPaginateResponsedatasetSummariestriggersscheduleTypeDef",
    {"expression": str},
    total=False,
)

ListDatasetsPaginateResponsedatasetSummariestriggersTypeDef = TypedDict(
...
ListDatasetsPaginateResponsedatasetSummariesTypeDef = TypedDict(
...
ListDatastoresPaginatePaginationConfigTypeDef = TypedDict(
    "ListDatastoresPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListDatastoresPaginateResponsedatastoreSummariesdatastoreStoragecustomerManagedS3TypeDef = TypedDict(
    "ListDatastoresPaginateResponsedatastoreSummariesdatastoreStoragecustomerManagedS3TypeDef",
    {"bucket": str, "keyPrefix": str, "roleArn": str},
    total=False,
)

ListDatastoresPaginateResponsedatastoreSummariesdatastoreStorageTypeDef = TypedDict(
...
ListDatastoresPaginateResponsedatastoreSummariesTypeDef = TypedDict(
...
ListDatastoresPaginateResponseTypeDef = TypedDict(
...
ListPipelinesPaginateResponsepipelineSummariesreprocessingSummariesTypeDef = TypedDict(
...
ListPipelinesPaginateResponsepipelineSummariesTypeDef = TypedDict(
