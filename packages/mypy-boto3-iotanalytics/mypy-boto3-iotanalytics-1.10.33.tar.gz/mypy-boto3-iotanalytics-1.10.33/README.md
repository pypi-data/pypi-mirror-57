...
Mypy-friendly auto-generated type annotations for `boto3 iotanalytics 1.10.33` service.
...
client: iotanalytics.Client = boto3.client("iotanalytics")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: iotanalytics.Client = session.client("iotanalytics")
