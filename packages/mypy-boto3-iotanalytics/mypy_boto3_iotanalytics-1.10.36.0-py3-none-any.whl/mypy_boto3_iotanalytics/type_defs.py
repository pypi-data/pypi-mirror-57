...
_RequiredContainerDatasetActionTypeDef = TypedDict(
    ...
    {"image": str, "executionRoleArn": str, "resourceConfiguration": ResourceConfigurationTypeDef},
)
...
MessageTypeDef = TypedDict("MessageTypeDef", {"messageId": str, "payload": Union[bytes, IO]})
...
RunPipelineActivityResponseTypeDef = TypedDict(
    ...
    {"payloads": List[Union[bytes, IO]], "logResult": str},
    total=False,
)

SampleChannelDataResponseTypeDef = TypedDict(
    "SampleChannelDataResponseTypeDef", {"payloads": List[Union[bytes, IO]]}, total=False
)
