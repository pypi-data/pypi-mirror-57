...
class DescribeBudgetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeBudgets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/budgets.html#Budgets.Paginator.DescribeBudgets.paginate)
        """
...
class DescribeNotificationsForBudgetPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeNotificationsForBudget.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/budgets.html#Budgets.Paginator.DescribeNotificationsForBudget.paginate)
        """
...
class DescribeSubscribersForNotificationPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeSubscribersForNotification.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/budgets.html#Budgets.Paginator.DescribeSubscribersForNotification.paginate)
        """
