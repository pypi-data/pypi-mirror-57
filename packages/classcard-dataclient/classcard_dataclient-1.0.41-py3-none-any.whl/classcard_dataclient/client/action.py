    ...
    def create_teacher(teachers):
        ...
        if teachers:
            ...
            if is_multi:
                ...
                teacher_list = backbone.get_teacher_list(number=teachers[0].number)
                teacher_map = {tl['number']: tl['uid'] for tl in teacher_list}
    ...
    def create_student(students):
        ...
        if students:
            ...
            if is_multi:
                ...
                student_list = backbone.get_student_list(number=students[0].number)
                student_map = {sl['number']: sl['uid'] for sl in student_list}
