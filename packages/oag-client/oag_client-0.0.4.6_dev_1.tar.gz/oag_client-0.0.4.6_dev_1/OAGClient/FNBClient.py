    ...
    def parse_update(self, update_dict):
        flight = {
            ...
            'Flight': {
                ...
                'origin_scheduled_dep': update_dict['FlightData']['SchedDepartureLocal'],
                'dest_scheduled_arrival': update_dict['FlightData']['SchedArrivalLocal'],
                'origin_scheduled_dep_utc': update_dict['FlightData']['SchedDepartureUtc'],
                'dest_scheduled_arrival_utc': update_dict['FlightData']['SchedArrivalUtc'],
                'estimated_departure_accuracy': update_dict['FlightData']['LatestDeparture']['Accuracy'],
                'estimated_departure_utc': update_dict['FlightData']['LatestDeparture']['DateTimeUtc'],
                'estimated_departure': update_dict['FlightData']['LatestDeparture']['DateTimeLocal'],
                'estimated_arrival_accuracy': update_dict['FlightData']['LatestArrival']['Accuracy'],
                'estimated_arrival_utc': update_dict['FlightData']['LatestArrival']['DateTimeUtc'],
                'estimated_arrival': update_dict['FlightData']['LatestArrival']['DateTimeLocal'],
