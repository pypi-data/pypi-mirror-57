import requests
import json
from .flight_view_helper import convert_oag_status_to_normal_form, parse_local_date_time, parse_UTC_date_time
    ...
    def parse_update(self, update_dict):
        flight = {
            'FlightIdentifier': {
                ...
                'SchedDepartureLocal': parse_local_date_time(update_dict['FlightIdentifier']['SchedDepartureLocal']),
            },
            'Alert': update_dict['Alert'],
            'Flight': {
                'FvFlightId': update_dict['FlightData']['FvFlightId'],
                ...
                'origin_scheduled_dep': parse_local_date_time(update_dict['FlightData']['SchedDepartureLocal']),
                'dest_scheduled_arrival': parse_local_date_time(update_dict['FlightData']['SchedArrivalLocal']),
                'origin_scheduled_dep_utc': parse_UTC_date_time(update_dict['FlightData']['SchedDepartureUtc']),
                'dest_scheduled_arrival_utc': parse_UTC_date_time(update_dict['FlightData']['SchedArrivalUtc']),
                'estimated_departure_accuracy': update_dict['FlightData']['LatestDeparture']['Accuracy'],
                'estimated_departure_utc': parse_UTC_date_time(update_dict['FlightData']['LatestDeparture']['DateTimeUtc']),
                'estimated_departure': parse_local_date_time(update_dict['FlightData']['LatestDeparture']['DateTimeLocal']),
                'estimated_arrival_accuracy': update_dict['FlightData']['LatestArrival']['Accuracy'],
                'estimated_arrival_utc': parse_UTC_date_time(update_dict['FlightData']['LatestArrival']['DateTimeUtc']),
                'estimated_arrival': parse_local_date_time(update_dict['FlightData']['LatestArrival']['DateTimeLocal']),
