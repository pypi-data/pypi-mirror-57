...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_destinations_paginator(client: Client) -> DescribeDestinationsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_metric_filters_paginator(client: Client) -> DescribeMetricFiltersPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_resource_policies_paginator(client: Client) -> DescribeResourcePoliciesPaginator:
    """
