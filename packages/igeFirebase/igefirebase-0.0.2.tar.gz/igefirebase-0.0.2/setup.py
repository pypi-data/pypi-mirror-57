...
sfc_module = Extension('igefirebase',
                    sources=[
                        ...
                        'win32/win32_admob.cpp',
                    ],
                    include_dirs=['bin/include', './'],
                    library_dirs=[bindir],
			        libraries=['firebase_analytics', 'firebase_admob', 'firebase_auth', 'firebase_app', 'firebase_messaging', 'advapi32', 'ws2_32', 'crypt32'])

setup(name='igefirebase', version='0.0.2',
