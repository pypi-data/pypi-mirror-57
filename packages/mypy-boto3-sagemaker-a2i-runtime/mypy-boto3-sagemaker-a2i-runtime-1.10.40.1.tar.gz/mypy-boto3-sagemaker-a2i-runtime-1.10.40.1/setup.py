...
setup(
    ...
    description="Type annotations for boto3.AugmentedAIRuntime 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 sagemaker-a2i-runtime type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
