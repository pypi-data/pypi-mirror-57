...
class CharPreprocessing:
    ...
    def remove_mesoclise_enclise(self, sentence):
        ...
        sentence = re.sub(r'(\w+)-(lhes|lhe|nas|nos|vos|as|me|no|na|os|se|te|a|o)(-(\w+)|\b)', r'\1\4', sentence)

        # TODO For future version
        # re.sub(r'(\w+)-(lhes|lhe|nas|nos|vos|as|me|no|na|os|se|te|a|o)(-(\w+)|\b)', r'\1\4 \2', sentence)
    ...
    def remove_useless_chars(self, sentence, glosa=False):
        ...
        wout_dup_hyphen = re.sub(r'(\w+)-{2,}(\w+)', r'\1-\2', wout_symbol)
    ...
    def keep_only_latin_1_chars(self, sentence):
