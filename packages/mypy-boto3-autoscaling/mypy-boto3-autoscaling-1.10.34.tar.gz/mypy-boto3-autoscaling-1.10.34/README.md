...
Mypy-friendly auto-generated type annotations for `boto3 autoscaling 1.10.34` service.
...
client: autoscaling.Client = boto3.client("autoscaling")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: autoscaling.Client = session.client("autoscaling")
