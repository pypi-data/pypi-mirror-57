...
def type_check(type_self: type, k: str, T_expected: type, value_found: object):
    try:
        ...
        do_it = (not definitely_exclude) and (ZuperTypingGlobals.enable_type_checking_difficult or simple)
        if do_it:
            ...
            if not ok:  # pragma: no cover
                ...
                raise ZValueError(msg, type_self=type_self, field=k, expected_type=T_expected,
                                  found_type=T_found,
