...
from .annotations_tricks import (get_Callable_info, get_ClassVar_arg, get_FixedTupleLike_args, get_ForwardRef_arg,
                                 get_Iterator_arg, get_List_arg, get_Optional_arg, get_Sequence_arg, get_Type_arg,
                                 get_TypeVar_name, get_Union_args, get_VarTuple_arg, is_Any, is_Callable, is_ClassVar,
                                 is_FixedTupleLike, is_FixedTupleLike_canonical, is_ForwardRef, is_Iterator, is_List,
                                 is_List_canonical, is_NewType, is_Optional, is_Sequence, is_Type, is_TypeVar, is_Union,
                                 is_VarTuple, is_VarTuple_canonical, make_Tuple, make_Union, make_VarTuple)
from .my_dict import (
    CustomList,
    get_CustomList_arg,
    get_DictLike_args,
