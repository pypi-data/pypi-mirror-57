...
class IntrusionSettingsController(BaseController):
    ...
    def update_network_security_intrusion_settings(self,
                                                   network_id,
                                                   update_network_security_intrusion_settings=None):
        ...
        Args:
            ...
            update_network_security_intrusion_settings
                (UpdateNetworkSecurityIntrusionSettings, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_security_intrusion_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_organization_security_intrusion_settings(self,
        ...
        Args:
            organization_id (string): TODO: type description here. Example: 
            update_organization_security_intrusion_settings
                (UpdateOrganizationSecurityIntrusionSettings): TODO: type
                description here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_organization_security_intrusion_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
