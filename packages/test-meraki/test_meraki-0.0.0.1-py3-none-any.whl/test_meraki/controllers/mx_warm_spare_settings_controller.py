...
class MXWarmSpareSettingsController(BaseController):
    ...
    def create_swap_network_warmspare(self,
                                      network_id):
        """Does a POST request to /networks/{networkId}/swapWarmSpare.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/swapWarmSpare'
    ...
    def get_network_warm_spare_settings(self,
                                        network_id):
        """Does a GET request to /networks/{networkId}/warmSpareSettings.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/warmSpareSettings'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': network_id
        })
        _query_builder = Configuration.base_uri
    ...
    def update_network_warm_spare_settings(self,
        ...
        """Does a PUT request to /networks/{networkId}/warmSpareSettings.
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_warm_spare_settings
                (UpdateNetworkWarmSpareSettings): TODO: type description here.
                Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_warm_spare_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
