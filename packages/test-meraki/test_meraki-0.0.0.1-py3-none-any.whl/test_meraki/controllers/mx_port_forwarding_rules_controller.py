...
class MXPortForwardingRulesController(BaseController):
    ...
    def update_network_port_forwarding_rules(self,
                                             network_id,
                                             update_network_port_forwarding_rules=None):
        ...
        Args:
            ...
            update_network_port_forwarding_rules
                (UpdateNetworkPortForwardingRules, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_port_forwarding_rules))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
