...
import test_meraki.models.bandwidth_limits_1

class PerClientBandwidthLimits(object):
    ...
    Attributes:
        ...
        bandwidth_limits (BandwidthLimits1): The bandwidth limits object,
    ...
    def __init__(self,
        ...
        """Constructor for the PerClientBandwidthLimits class"""
    ...
    def from_dictionary(cls,
        ...
        bandwidth_limits = test_meraki.models.bandwidth_limits_1.BandwidthLimits1.from_dictionary(dictionary.get('bandwidthLimits')) if dictionary.get('bandwidthLimits') else None
