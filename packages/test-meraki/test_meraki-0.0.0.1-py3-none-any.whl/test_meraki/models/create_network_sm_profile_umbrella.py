...
import test_meraki.models.provider_configuration

class CreateNetworkSmProfileUmbrella(object):
    ...
    Attributes:
        ...
        provider_configuration (list of ProviderConfiguration): The specific
            ProviderConfiguration to be passed to the filtering framework, in
            the form of an array of objects (as JSON).
    ...
    def __init__(self,
                 ...
                 uses_cert=None):
        """Constructor for the CreateNetworkSmProfileUmbrella class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('ProviderConfiguration') != None:
            ...
            for structure in dictionary.get('ProviderConfiguration'):
                provider_configuration.append(test_meraki.models.provider_configuration.ProviderConfiguration.from_dictionary(structure))
