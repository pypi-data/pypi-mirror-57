...
import test_meraki.models.license

class ClaimOrganization(object):
    ...
    Attributes:
        ...
        serials (list of string): The serials of the devices that should be
            claimed
        licenses (list of License): The licenses that should be claimed
    ...
    def __init__(self,
                 ...
                 serials=None,
                 licenses=None):
        """Constructor for the ClaimOrganization class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('licenses') != None:
            ...
            for structure in dictionary.get('licenses'):
                licenses.append(test_meraki.models.license.License.from_dictionary(structure))
