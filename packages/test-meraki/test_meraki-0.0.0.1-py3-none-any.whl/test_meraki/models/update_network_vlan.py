...
import test_meraki.models.reserved_ip_range
import test_meraki.models.dhcp_option

class UpdateNetworkVlan(object):
    ...
    Attributes:
        ...
        reserved_ip_ranges (list of ReservedIpRange): The DHCP reserved IP
            ranges on the VLAN
        ...
        dhcp_options (list of DhcpOption): The list of DHCP options that will
            be included in DHCP responses. Each object in the list should have
            "code", "type", and "value" properties.
    ...
    def __init__(self,
                 ...
                 dhcp_options=None):
        """Constructor for the UpdateNetworkVlan class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('reservedIpRanges') != None:
            ...
            for structure in dictionary.get('reservedIpRanges'):
                reserved_ip_ranges.append(test_meraki.models.reserved_ip_range.ReservedIpRange.from_dictionary(structure))
        ...
        if dictionary.get('dhcpOptions') != None:
            ...
            for structure in dictionary.get('dhcpOptions'):
                dhcp_options.append(test_meraki.models.dhcp_option.DhcpOption.from_dictionary(structure))
