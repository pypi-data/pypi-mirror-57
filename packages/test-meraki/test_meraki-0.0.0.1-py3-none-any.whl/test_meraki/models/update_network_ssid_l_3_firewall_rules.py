...
import test_meraki.models.rule_8

class UpdateNetworkSsidL3FirewallRules(object):
    ...
    Attributes:
        rules (list of Rule8): An ordered array of the firewall rules for this
            SSID (not including the local LAN access rule or the default
            rule)
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkSsidL3FirewallRules class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(test_meraki.models.rule_8.Rule8.from_dictionary(structure))
