...
import test_meraki.models.tag
import test_meraki.models.network

class CreateOrganizationAdmin(object):
    ...
    Attributes:
        ...
        tags (list of Tag): The list of tags that the dashboard administrator
            has privileges on
        networks (list of Network): The list of networks that the dashboard
    ...
    def __init__(self,
                 ...
                 tags=None,
                 networks=None):
        """Constructor for the CreateOrganizationAdmin class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('tags') != None:
            ...
            for structure in dictionary.get('tags'):
                tags.append(test_meraki.models.tag.Tag.from_dictionary(structure))
        networks = None
        if dictionary.get('networks') != None:
            networks = list()
            for structure in dictionary.get('networks'):
                networks.append(test_meraki.models.network.Network.from_dictionary(structure))
