...
class SwitchPortSchedulesController(BaseController):
    ...
    def get_network_switch_port_schedules(self,
                                          network_id):
        """Does a GET request to /networks/{networkId}/switch/portSchedules.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/switch/portSchedules'
    ...
    def create_network_switch_port_schedule(self,
        ...
        """Does a POST request to /networks/{networkId}/switch/portSchedules.
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            create_network_switch_port_schedule
                (CreateNetworkSwitchPortSchedule): TODO: type description
                here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(create_network_switch_port_schedule))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def delete_network_switch_port_schedule(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            port_schedule_id (string): TODO: type description here. Example: 
    ...
    def update_network_switch_port_schedule(self,
                                            network_id,
                                            port_schedule_id,
                                            update_network_switch_port_schedule=None):
        """Does a PUT request to /networks/{networkId}/switch/portSchedules/{portScheduleId}.
        ...
        Args:
            ...
            update_network_switch_port_schedule
                (UpdateNetworkSwitchPortSchedule, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_switch_port_schedule))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
