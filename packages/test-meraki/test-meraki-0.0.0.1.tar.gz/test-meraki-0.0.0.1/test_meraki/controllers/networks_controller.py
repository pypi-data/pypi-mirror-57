...
class NetworksController(BaseController):
    ...
    def update_network(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network (UpdateNetwork, optional): TODO: type description
                here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def create_bind_network(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            bind_network (BindNetwork): TODO: type description here. Example:
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(bind_network))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_network_bluetooth_settings(self,
                                          network_id,
                                          update_network_bluetooth_settings=None):
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_bluetooth_settings (UpdateNetworkBluetoothSettings,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_bluetooth_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_network_site_to_site_vpn(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_site_to_site_vpn (UpdateNetworkSiteToSiteVpn):
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_site_to_site_vpn))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def get_network_traffic(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            t_0 (string, optional): The beginning of the timespan for the
                data. The maximum lookback period is 30 days from today.
            timespan (float, optional): The timespan for which the information
                will be fetched. If specifying timespan, do not specify
                parameter t0. The value must be in seconds and be less than or
                equal to 30 days.
            device_type (string, optional): Filter the data by device type:
                combined (default), wireless, switch, appliance.     When
                using combined, for each rule the data will come from the
    ...
    def create_unbind_network(self,
                              network_id):
    ...
    def get_organization_networks(self,
        ...
        Args:
            ...
            config_template_id (string, optional): An optional parameter that
                is the ID of a config template. Will return all networks bound
                to that template.
    ...
    def create_organization_network(self,
        ...
        Args:
            organization_id (string): TODO: type description here. Example: 
            create_organization_network (CreateOrganizationNetwork): TODO:
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(create_organization_network))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def create_combine_organization_networks(self,
                                             organization_id,
        ...
        Args:
            organization_id (string): TODO: type description here. Example: 
            combine_organization_networks (CombineOrganizationNetworks): TODO:
                type description here. Example: 
        ...
        # Prepare and execute request
        _request = self.http_client.post(_query_url, headers=_headers, parameters=APIHelper.json_serialize(combine_organization_networks))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
