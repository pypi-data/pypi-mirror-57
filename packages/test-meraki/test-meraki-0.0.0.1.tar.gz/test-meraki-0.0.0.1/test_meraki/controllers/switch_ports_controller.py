...
class SwitchPortsController(BaseController):
    ...
    def update_device_switch_port(self,
                                  serial,
                                  number,
                                  update_device_switch_port=None):
        ...
        Args:
            serial (string): TODO: type description here. Example: 
            number (string): TODO: type description here. Example: 
            update_device_switch_port (UpdateDeviceSwitchPort, optional):
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_device_switch_port))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
