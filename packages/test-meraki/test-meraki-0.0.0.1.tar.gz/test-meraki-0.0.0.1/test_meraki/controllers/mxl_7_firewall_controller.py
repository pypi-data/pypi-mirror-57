...
class MXL7FirewallController(BaseController):
    ...
    def update_network_l_7_firewall_rules(self,
                                          network_id,
                                          update_network_l_7_firewall_rules=None):
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_l_7_firewall_rules (UpdateNetworkL7FirewallRules,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_l_7_firewall_rules))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
