...
class ContentFilteringRulesController(BaseController):
    ...
    def update_network_content_filtering(self,
                                         network_id,
                                         update_network_content_filtering=None):
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_content_filtering (UpdateNetworkContentFiltering,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_content_filtering))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
