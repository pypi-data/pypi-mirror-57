...
import test_meraki.models.stp_bridge_priority

class UpdateNetworkSwitchSettingsStp(object):
    ...
    Attributes:
        ...
        stp_bridge_priority (list of StpBridgePriority): STP bridge priority
            for switches/stacks or switch profiles. An empty array will clear
            the STP bridge priority settings.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkSwitchSettingsStp class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('stpBridgePriority') != None:
            ...
            for structure in dictionary.get('stpBridgePriority'):
                stp_bridge_priority.append(test_meraki.models.stp_bridge_priority.StpBridgePriority.from_dictionary(structure))
