...
class UpdateNetworkSmProfileUmbrella(object):
    ...
    Attributes:
        ...
        provider_bundle_identifier (string): optional: The bundle ID of the
            provider
        provider_configuration (list of ProviderConfiguration): optional: The
    ...
    def __init__(self,
                 ...
                 uses_cert=None):
        """Constructor for the UpdateNetworkSmProfileUmbrella class"""
