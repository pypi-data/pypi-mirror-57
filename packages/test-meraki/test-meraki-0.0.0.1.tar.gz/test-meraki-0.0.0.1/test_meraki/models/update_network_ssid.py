...
import test_meraki.models.radius_server
import test_meraki.models.radius_accounting_server
import test_meraki.models.ap_tags_and_vlan_id

class UpdateNetworkSsid(object):
    ...
    Attributes:
        ...
        radius_servers (list of RadiusServer): The RADIUS 802.1x servers to be
            used for authentication. This param is only valid if the authMode
            is 'open-with-radius' or '8021x-radius'
        ...
        radius_accounting_servers (list of RadiusAccountingServer): The RADIUS
            accounting 802.1x servers to be used for authentication. This
        ...
        ap_tags_and_vlan_ids (list of ApTagsAndVlanId): The list of tags and
            VLAN IDs used for VLAN tagging. This param is only valid when the
            ipAssignmentMode is 'Bridge mode' or 'Layer 3 roaming'
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkSsid class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('radiusServers') != None:
            ...
            for structure in dictionary.get('radiusServers'):
                radius_servers.append(test_meraki.models.radius_server.RadiusServer.from_dictionary(structure))
        ...
        if dictionary.get('radiusAccountingServers') != None:
            ...
            for structure in dictionary.get('radiusAccountingServers'):
                radius_accounting_servers.append(test_meraki.models.radius_accounting_server.RadiusAccountingServer.from_dictionary(structure))
        ...
        if dictionary.get('apTagsAndVlanIds') != None:
            ...
            for structure in dictionary.get('apTagsAndVlanIds'):
                ap_tags_and_vlan_ids.append(test_meraki.models.ap_tags_and_vlan_id.ApTagsAndVlanId.from_dictionary(structure))
