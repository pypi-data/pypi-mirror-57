...
class ApBandSettings1(object):

    """Implementation of the 'ApBandSettings1' model.

    Settings that will be enabled if selectionType is set to 'ap'.

    Attributes:
        band_operation_mode (BandOperationMode1Enum): Choice between 'dual',
            '2.4ghz' or '5ghz'.
    ...
    def __init__(self,
        ...
        """Constructor for the ApBandSettings1 class"""
