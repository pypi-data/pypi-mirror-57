...
class License(object):
    ...
    Attributes:
        ...
        mode (Mode2Enum): Either 'renew' or 'addDevices'. 'addDevices' will
            ...
            of time until expiration. This parameter is legacy and only
            applies to coterm licensing; it should not be specified when
            claiming per-device licenses. Please see <a target='_blank'
