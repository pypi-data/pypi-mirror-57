...
import test_meraki.models.definition
import test_meraki.models.per_client_bandwidth_limits

class TrafficShapingRule(object):
    ...
    Attributes:
        definitions (list of Definition): A list of objects describing the
            definitions of your traffic shaping rule. At least one definition
            is required.
        per_client_bandwidth_limits (PerClientBandwidthLimits): An object
    ...
    def __init__(self,
                 ...
                 pcp_tag_value=None,
                 priority=None):
        """Constructor for the TrafficShapingRule class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('definitions') != None:
            ...
            for structure in dictionary.get('definitions'):
                definitions.append(test_meraki.models.definition.Definition.from_dictionary(structure))
        per_client_bandwidth_limits = test_meraki.models.per_client_bandwidth_limits.PerClientBandwidthLimits.from_dictionary(dictionary.get('perClientBandwidthLimits')) if dictionary.get('perClientBandwidthLimits') else None
