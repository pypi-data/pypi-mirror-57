...
import test_meraki.models.ap_band_settings_1
import test_meraki.models.two_four_ghz_settings_1
import test_meraki.models.five_ghz_settings_1

class UpdateNetworkWirelessRfProfile(object):
    ...
    Attributes:
        ...
        ap_band_settings (ApBandSettings1): Settings that will be enabled if
            selectionType is set to 'ap'.
        two_four_ghz_settings (TwoFourGhzSettings1): Settings related to
            2.4Ghz band
        five_ghz_settings (FiveGhzSettings1): Settings related to 5Ghz band
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkWirelessRfProfile class"""
    ...
    def from_dictionary(cls,
        ...
        ap_band_settings = test_meraki.models.ap_band_settings_1.ApBandSettings1.from_dictionary(dictionary.get('apBandSettings')) if dictionary.get('apBandSettings') else None
        two_four_ghz_settings = test_meraki.models.two_four_ghz_settings_1.TwoFourGhzSettings1.from_dictionary(dictionary.get('twoFourGhzSettings')) if dictionary.get('twoFourGhzSettings') else None
        five_ghz_settings = test_meraki.models.five_ghz_settings_1.FiveGhzSettings1.from_dictionary(dictionary.get('fiveGhzSettings')) if dictionary.get('fiveGhzSettings') else None
