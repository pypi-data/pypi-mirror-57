...
class SNMPSettingsController(BaseController):
    ...
    def update_network_snmp_settings(self,
                                     network_id,
                                     update_network_snmp_settings=None):
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_snmp_settings (UpdateNetworkSnmpSettings,
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_snmp_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
    ...
    def update_organization_snmp(self,
        ...
        Args:
            organization_id (string): TODO: type description here. Example: 
            update_organization_snmp (UpdateOrganizationSnmp, optional): TODO:
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_organization_snmp))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
