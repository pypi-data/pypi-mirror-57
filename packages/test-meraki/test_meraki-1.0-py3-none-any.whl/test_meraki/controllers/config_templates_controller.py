...
class ConfigTemplatesController(BaseController):
    ...
    def delete_organization_config_template(self,
                                            organization_id,
                                            config_template_id):
        """Does a DELETE request to /organizations/{organizationId}/configTemplates/{configTemplateId}.
        ...
        # Prepare query URL
        _url_path = '/organizations/{organizationId}/configTemplates/{configTemplateId}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'organizationId': organization_id,
