...
class MerakiAuthUsersController(BaseController):
    ...
    def get_network_meraki_auth_user(self,
                                     network_id,
                                     meraki_auth_user_id):
        """Does a GET request to /networks/{networkId}/merakiAuthUsers/{merakiAuthUserId}.

        Return the Meraki Auth splash or RADIUS user

        Args:
            network_id (string): TODO: type description here. Example: 
            meraki_auth_user_id (string): TODO: type description here.
                Example: 
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/merakiAuthUsers/{merakiAuthUserId}'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'networkId': network_id,
            'merakiAuthUserId': meraki_auth_user_id
        })
        _query_builder = Configuration.base_uri
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
