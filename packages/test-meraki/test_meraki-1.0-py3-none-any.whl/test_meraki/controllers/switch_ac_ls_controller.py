...
class SwitchACLsController(BaseController):
    ...
    def get_network_switch_access_control_lists(self,
                                                network_id):
        """Does a GET request to /networks/{networkId}/switch/accessControlLists.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/switch/accessControlLists'
    ...
    def update_network_switch_access_control_lists(self,
        ...
        """Does a PUT request to /networks/{networkId}/switch/accessControlLists.
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            update_network_switch_access_control_lists
                (UpdateNetworkSwitchAccessControlLists): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_switch_access_control_lists))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
