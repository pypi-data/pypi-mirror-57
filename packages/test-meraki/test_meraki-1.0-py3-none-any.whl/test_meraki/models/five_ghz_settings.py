...
class FiveGhzSettings(object):

    """Implementation of the 'FiveGhzSettings' model.

    Settings related to 5Ghz band

    Attributes:
        max_power (int): Sets max power (dBm) of 5Ghz band. Can be integer
            between 8 and 30. Defaults to 30.
        min_power (int): Sets min power (dBm) of 5Ghz band. Can be integer
            between 8 and 30. Defaults to 8.
        min_bitrate (int): Sets min bitrate (Mbps) of 5Ghz band. Can be one of
            '6', '9', '12', '18', '24', '36', '48' or '54'. Defaults to 12.
        valid_auto_channels (list of int): Sets valid auto channels for 5Ghz
            ...
            '132', '136', '140', '144', '149', '153', '157', '161' or
            '165'.Defaults to [36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108,
            112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161,
            165].
        channel_width (string): Sets channel width (MHz) for 5Ghz band. Can be
            one of 'auto', '20', '40' or '80'. Defaults to auto.
    ...
    def __init__(self,
                 ...
                 channel_width=None,
                 rxsop=None):
        """Constructor for the FiveGhzSettings class"""
