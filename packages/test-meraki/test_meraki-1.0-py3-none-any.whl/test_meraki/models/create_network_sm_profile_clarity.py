...
import test_meraki.models.vendor_config

class CreateNetworkSmProfileClarity(object):
    ...
    Attributes:
        ...
        filter_sockets (bool): Whether or not to enable socket traffic
            filtering (one of true, false). Default true.
        vendor_config (list of VendorConfig): The specific VendorConfig to be
            passed to the filtering framework, in the form of an array of
            objects (as JSON).
    ...
    def __init__(self,
                 ...
                 filter_sockets=None):
        """Constructor for the CreateNetworkSmProfileClarity class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('VendorConfig') != None:
            ...
            for structure in dictionary.get('VendorConfig'):
                vendor_config.append(test_meraki.models.vendor_config.VendorConfig.from_dictionary(structure))
