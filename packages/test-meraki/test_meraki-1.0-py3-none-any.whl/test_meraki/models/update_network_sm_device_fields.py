...
import test_meraki.models.device_fields

class UpdateNetworkSmDeviceFields(object):
    ...
    Attributes:
        ...
        device_fields (DeviceFields): The new fields of the device. Each field
            of this object is optional.
    ...
    def __init__(self,
                 ...
                 id=None,
                 serial=None):
        """Constructor for the UpdateNetworkSmDeviceFields class"""
    ...
    def from_dictionary(cls,
        ...
        device_fields = test_meraki.models.device_fields.DeviceFields.from_dictionary(dictionary.get('deviceFields')) if dictionary.get('deviceFields') else None
