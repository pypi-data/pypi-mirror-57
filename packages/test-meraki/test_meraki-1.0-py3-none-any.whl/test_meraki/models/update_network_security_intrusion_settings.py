...
import test_meraki.models.protected_networks

class UpdateNetworkSecurityIntrusionSettings(object):
    ...
    Attributes:
        ...
        protected_networks (ProtectedNetworks): Set the included/excluded
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateNetworkSecurityIntrusionSettings class"""
    ...
    def from_dictionary(cls,
        ...
        protected_networks = test_meraki.models.protected_networks.ProtectedNetworks.from_dictionary(dictionary.get('protectedNetworks')) if dictionary.get('protectedNetworks') else None
