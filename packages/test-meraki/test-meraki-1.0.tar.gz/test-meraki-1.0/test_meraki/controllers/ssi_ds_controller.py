...
class SSIDsController(BaseController):
    ...
    def get_network_device_wireless_status(self,
                                           network_id,
                                           serial):
        """Does a GET request to /networks/{networkId}/devices/{serial}/wireless/status.
    ...
    def update_network_ssid(self,
        ...
        Args:
            network_id (string): TODO: type description here. Example: 
            number (string): TODO: type description here. Example: 
            update_network_ssid (UpdateNetworkSsid, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_ssid))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
