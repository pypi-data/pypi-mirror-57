    ...
    def get_device_camera_analytics_overview(self,
        ...
        Args:
            ...
            timespan (float, optional): The timespan for which the information
                ...
                than or equal to 7 days. The default is 1 hour.
            object_type (ObjectTypeEnum, optional): [optional] The object type
                for which analytics will be retrieved. The default object type
    ...
    def get_device_camera_analytics_zone_history(self,
        ...
        Args:
            ...
            timespan (float, optional): The timespan for which the information
                will be fetched. If specifying timespan, do not specify
                parameters t0 and t1. The value must be in seconds and be less
                than or equal to 14 hours. The default is 1 hour.
            resolution (int, optional): The time resolution in seconds for
                returned data. The valid resolutions are: 60. The default is
                60.
            object_type (ObjectTypeEnum, optional): [optional] The object type
                for which analytics will be retrieved. The default object type
                is person. The available types are [person, vehicle].
