...
class MXVPNFirewallController(BaseController):
    ...
    def update_organization_vpn_firewall_rules(self,
                                               organization_id,
                                               update_organization_vpn_firewall_rules=None):
        ...
        Args:
            ...
            update_organization_vpn_firewall_rules
                (UpdateOrganizationVpnFirewallRules, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_organization_vpn_firewall_rules))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
