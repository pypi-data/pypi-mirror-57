...
class MX1ManyNATRulesController(BaseController):
    ...
    def update_network_one_to_many_nat_rules(self,
                                             network_id,
                                             update_network_one_to_many_nat_rules=None):
        ...
        Args:
            ...
            update_network_one_to_many_nat_rules
                (UpdateNetworkOneToManyNatRules, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_one_to_many_nat_rules))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
