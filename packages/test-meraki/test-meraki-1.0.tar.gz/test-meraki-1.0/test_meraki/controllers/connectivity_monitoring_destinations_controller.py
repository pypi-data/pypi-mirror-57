...
class ConnectivityMonitoringDestinationsController(BaseController):
    ...
    def update_network_connectivity_monitoring_destinations(self,
                                                            network_id,
                                                            update_network_connectivity_monitoring_destinations=None):
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_connectivity_monitoring_destinations))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
