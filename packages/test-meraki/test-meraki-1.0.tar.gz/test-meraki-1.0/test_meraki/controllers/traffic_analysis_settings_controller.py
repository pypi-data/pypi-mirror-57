...
class TrafficAnalysisSettingsController(BaseController):
    ...
    def get_network_traffic_analysis_settings(self,
                                              network_id):
        """Does a GET request to /networks/{networkId}/trafficAnalysisSettings.
        ...
        # Prepare query URL
        _url_path = '/networks/{networkId}/trafficAnalysisSettings'
    ...
    def update_network_traffic_analysis_settings(self,
                                                 network_id,
                                                 update_network_traffic_analysis_settings=None):
        """Does a PUT request to /networks/{networkId}/trafficAnalysisSettings.
        ...
        Args:
            ...
            update_network_traffic_analysis_settings
                (UpdateNetworkTrafficAnalysisSettings, optional): TODO: type
        ...
        # Prepare and execute request
        _request = self.http_client.put(_query_url, headers=_headers, parameters=APIHelper.json_serialize(update_network_traffic_analysis_settings))
        CustomHeaderAuth.apply(_request)
        _context = self.execute_request(_request)
        self.validate_response(_context)
