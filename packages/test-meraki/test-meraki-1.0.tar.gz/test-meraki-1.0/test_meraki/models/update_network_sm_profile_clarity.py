...
class UpdateNetworkSmProfileClarity(object):
    ...
    Attributes:
        ...
        filter_sockets (bool): optional: Whether or not to enable socket
            traffic filtering (one of true, false).
        vendor_config (list of VendorConfig): optional: The specific
    ...
    def __init__(self,
                 ...
                 filter_sockets=None,
                 vendor_config=None):
        """Constructor for the UpdateNetworkSmProfileClarity class"""
