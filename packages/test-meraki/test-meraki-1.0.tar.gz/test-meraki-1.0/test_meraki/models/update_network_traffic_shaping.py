...
import test_meraki.models.rule_11

class UpdateNetworkTrafficShaping(object):
    ...
    Attributes:
        default_rules_enabled (bool): Whether default traffic shaping rules
            ...
            8.
        rules (list of Rule11): An array of traffic shaping rules. Rules are
    ...
    def __init__(self,
                 ...
                 rules=None):
        """Constructor for the UpdateNetworkTrafficShaping class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('rules') != None:
            ...
            for structure in dictionary.get('rules'):
                rules.append(test_meraki.models.rule_11.Rule11.from_dictionary(structure))
