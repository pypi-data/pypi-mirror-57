...
import test_meraki.models.action

class CreateOrganizationActionBatch(object):
    ...
    Attributes:
        ...
        synchronous (bool): Set to true to force the batch to run synchronous.
            ...
            false.
        actions (list of Action): A set of changes to make as part of this
            action (<a
    ...
    def __init__(self,
                 ...
                 confirmed=None,
                 synchronous=None):
        """Constructor for the CreateOrganizationActionBatch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('actions') != None:
            ...
            for structure in dictionary.get('actions'):
                actions.append(test_meraki.models.action.Action.from_dictionary(structure))
