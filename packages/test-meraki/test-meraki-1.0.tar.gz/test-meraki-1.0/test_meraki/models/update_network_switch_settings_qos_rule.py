...
class UpdateNetworkSwitchSettingsQosRule(object):

    """Implementation of the 'updateNetworkSwitchSettingsQosRule' model.
    ...
    Attributes:
        vlan (int): The VLAN of the incoming packet. A null value will match
            any VLAN.
        protocol (Protocol5Enum): The protocol of the incoming packet. Can be
        ...
        dst_port_range (string): The destination port range of the incoming
            ...
            70-80
        dscp (int): DSCP tag that should be assigned to incoming packet. Set
    ...
    def __init__(self,
                 ...
                 dst_port_range=None,
                 dscp=None):
        """Constructor for the UpdateNetworkSwitchSettingsQosRule class"""
