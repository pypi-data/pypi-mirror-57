...
import test_meraki.models.ipsec_policies
...
class Peer(object):
    ...
    Attributes:
        ...
        private_subnets (list of string): The list of the private subnets of
            the VPN peer
        ipsec_policies (IpsecPolicies): Custom IPSec policies for the VPN
    ...
    def from_dictionary(cls,
        ...
        ipsec_policies = test_meraki.models.ipsec_policies.IpsecPolicies.from_dictionary(dictionary.get('ipsecPolicies')) if dictionary.get('ipsecPolicies') else None
