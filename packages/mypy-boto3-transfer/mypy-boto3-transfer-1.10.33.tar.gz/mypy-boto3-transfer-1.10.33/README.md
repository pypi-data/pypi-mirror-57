...
Mypy-friendly auto-generated type annotations for `boto3 transfer 1.10.33` service.
...
client: transfer.Client = boto3.client("transfer")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: transfer.Client = session.client("transfer")
