...
class PlanSettings(object):
    ...
    def __init__(self, configuration='optimize_money', planning_time=20, result_ttl=20, result_timezone=0, predict_slots=0, flight_distance=False, traffic_jams=True, routing=None, transport_factor=None):  # noqa: E501
    ...
    def routing(self):
        ...
        Список матриц времен и расстояний для каждого типа транспорта  # noqa: E501
