...
class Cargo(object):
    ...
    def __init__(self, key=None, mass=1, volume=1, capacity_x=0, capacity_y=0, capacity_z=0, width=0, height=0, length=0, max_storage_time=None, restrictions=None):  # noqa: E501
