...
"""
    ...
    OpenAPI spec version: 1.6.152797
...
class TripStatistics(object):
    ...
    def total_load(self, total_load):
        ...
        if total_load is None:
            raise ValueError("Invalid value for `total_load`, must not be `None`")  # noqa: E501
    ...
    def weight_utilization(self, weight_utilization):
        ...
        :type: float
        """
        if weight_utilization is None:
            raise ValueError("Invalid value for `weight_utilization`, must not be `None`")  # noqa: E501
    ...
    def volume_utilization(self, volume_utilization):
        ...
        if volume_utilization is None:
            raise ValueError("Invalid value for `volume_utilization`, must not be `None`")  # noqa: E501
