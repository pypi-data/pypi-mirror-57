...
class PlanTask(object):
    ...
    """
    swagger_types = {
        'locations': 'list[LastmileLocation]',
        'orders': 'list[Order]',
    ...
    def __init__(self, locations=None, orders=None, performers=None, transports=None, shifts=None, hardlinks=None, settings=None):  # noqa: E501
