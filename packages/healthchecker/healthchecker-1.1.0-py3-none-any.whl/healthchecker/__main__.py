...
def _to_github(repo_name: str, github_api_token: str, filename: str,
               statuses: ServiceStatusList, branch: str = settings.GITHUB_BRANCH,
               author_email: str = settings.GITHUB_COMMITTER_EMAIL) -> bool:
...
def _notify(url: str, statuses: ServiceStatusList, payload: typing.Optional[str] = None,
...
async def main() -> int:
    ...
    validations = [
        validation
        for validation in args.validation or settings.URLS_VALIDATION
        if validation.strip()
    ]
    repo_name: typing.Optional[str] = args.gh_repo
    filename: typing.Optional[str] = args.gh_filename
    branch: str = args.gh_branch
    author_email: str = args.gh_email
    github_api_token: typing.Optional[str] = args.gh_token
    notify_url: typing.Optional[str] = (parse_url(args.notify_url)
                                        if args.notify_url else None)
