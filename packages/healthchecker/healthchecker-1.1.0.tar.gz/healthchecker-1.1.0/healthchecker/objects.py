...
class ServiceStatus(object):
    ...
    def uid(self) -> str:
        ...
        return md5(self.url.encode('utf-8')).hexdigest()[:8]  # noqa: S303 # nosec: B303
...
class ServiceStatusList(object):
    """typing.List of ServiceStatus objects. It is used just like any other Python list.
    ...
    def __init__(self, *args: ServiceStatus):
        """typing.List of ServiceStatus objects."""
    ...
    def extend(self, lst: typing.Iterable) -> None:
