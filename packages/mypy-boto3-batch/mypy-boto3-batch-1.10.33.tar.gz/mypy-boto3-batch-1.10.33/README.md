...
Mypy-friendly auto-generated type annotations for `boto3 batch 1.10.33` service.
...
client: batch.Client = boto3.client("batch")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: batch.Client = session.client("batch")
