...
class Client(BaseClient):
    ...
    def cancel_job(self, jobId: str, reason: str) -> Dict[str, Any]:
        """
        Cancels a job in an AWS Batch job queue. Jobs that are in the ``SUBMITTED`` , ``PENDING`` ,
        or ``RUNNABLE`` state are cancelled. Jobs that have progressed to ``STARTING`` or
        ``RUNNING`` are not cancelled (but the API operation still succeeds, even if no job is
        cancelled); these jobs must be terminated with the  TerminateJob operation.
        ...
        **Request Syntax**
        ...
        :param reason: **[REQUIRED]**
          ...
          returned by future  DescribeJobs operations on the job. This message is also recorded in
          the AWS Batch activity logs.
    ...
    def create_compute_environment(
        ...
        specification that you define or the `launch template
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html>`__ that you
        specify when you create the compute environment. You can choose to use Amazon EC2 On-Demand
        Instances or Spot Instances in your managed compute environment. You can optionally set a
        maximum price so that Spot Instances only launch when the Spot Instance price is below a
        ...
        provides more compute resource configuration options, such as using a custom AMI, but you
        must ensure that your AMI meets the Amazon ECS container instance AMI specification. For
        more information, see `Container Instance AMIs
        <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/container_instance_AMIs.html>`__
        ...
        find the Amazon ECS cluster that is associated with it. Then, manually launch your container
        instances into that Amazon ECS cluster. For more information, see `Launching an Amazon ECS
        Container Instance
        <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_container_instance.html>`__
        ...
        .. note::
          ...
          the compute resources. To use a new AMI for your AWS Batch jobs:
        ...
        **Request Syntax**
        ...
        :param type: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html>`__ in the
        ...
        :param computeResources:
          ...
          Details of the compute resources managed by the compute environment. This parameter is
        ...
        :param serviceRole: **[REQUIRED]**
          ...
          .. note::
            ...
            Batch assumes that your ARN does not use the ``service-role`` path prefix. Because of
    ...
    def create_job_queue(
        ...
        You also set a priority to the job queue that determines the order in which the AWS Batch
        ...
        **Request Syntax**
        ...
        :param priority: **[REQUIRED]**
          ...
          value for the ``priority`` parameter) are evaluated first when associated with the same
          compute environment. Priority is determined in descending order, for example, a job queue
          with a priority value of ``10`` is given scheduling preference over a job queue with a
          priority value of ``1`` .
        ...
        :param computeEnvironmentOrder: **[REQUIRED]**
          ...
          other. The job scheduler uses this parameter to determine which compute environment should
          execute a given job. Compute environments must be in the ``VALID`` state before you can
          associate them with a job queue. You can associate up to three compute environments with a
          job queue.
    ...
    def describe_compute_environments(
        ...
        ``DescribeComputeEnvironment`` operation to determine the ``ecsClusterArn`` that you should
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          ``DescribeComputeEnvironments`` request with the returned ``nextToken`` value. This value
            ...
            - **computeEnvironments** *(list) --*
              ...
              - *(dict) --*
                ...
                - **state** *(string) --*
                  ...
                  place jobs within the environment. Jobs in a ``STARTING`` or ``RUNNING`` state
                  continue to progress normally. Managed compute environments in the ``DISABLED``
                  state do not scale out. However, they scale in to ``minvCpus`` value after
                ...
                - **computeResources** *(dict) --*
                  ...
                  - **allocationStrategy** *(string) --*
                    ...
                    . If this is not specified, the default is ``BEST_FIT`` , which will use only
                    the best fitting instance type, waiting for additional capacity if it's not
                    available. This allocation strategy keeps costs lower but can limit scaling.
                    ``BEST_FIT_PROGRESSIVE`` will select an additional instance type that is large
                    enough to meet the requirements of the jobs in the queue, with a preference for
                    an instance type with a lower cost. ``SPOT_CAPACITY_OPTIMIZED`` is only
                    available for Spot Instance compute resources and will select an additional
                    instance type that is large enough to meet the requirements of the jobs in the
                    queue, with a preference for an instance type that is less likely to be
                    interrupted.
                  ...
                  - **instanceTypes** *(list) --*
                    ...
                    launch any instance type within those families (for example, ``c5`` or ``p3`` ),
                    or you can specify specific sizes within a family (such as ``c5.8xlarge`` ). You
                    can also choose ``optimal`` to pick instance types (from the C, M, and R
                  ...
                  - **subnets** *(list) --*
                    ...
                    <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html>`__ in the
                  ...
                  - **securityGroupIds** *(list) --*
                    ...
                    The Amazon EC2 security groups associated with instances launched in the compute
                    environment. One or more security groups must be specified, either in
                    ``securityGroupIds`` or using a launch template referenced in ``launchTemplate``
                  ...
                  - **instanceRole** *(string) --*
                    ...
                    more information, see `Amazon ECS Instance Role
                    <https://docs.aws.amazon.com/batch/latest/userguide/instance_IAM_role.html>`__
                  ...
                  - **placementGroup** *(string) --*
                    ...
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html>`__
                  ...
                  - **spotIamFleetRole** *(string) --*
                    ...
                    a ``SPOT`` compute environment. For more information, see `Amazon EC2 Spot Fleet
                    Role
                    <https://docs.aws.amazon.com/batch/latest/userguide/spot_fleet_IAM_role.html>`__
                    in the *AWS Batch User Guide* .
                  ...
                  - **launchTemplate** *(dict) --*
                    ...
                    <https://docs.aws.amazon.com/batch/latest/userguide/launch-templates.html>`__ in
    ...
    def describe_job_definitions(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          this parameter is not used, then ``DescribeJobDefinitions`` returns up to 100 results and
            ...
            - **jobDefinitions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **parameters** *(dict) --*
                  ...
                  Parameters
                  <https://docs.aws.amazon.com/batch/latest/userguide/job_definition_parameters.html>`__
                  in the *AWS Batch User Guide* .
                ...
                - **containerProperties** *(dict) --*
                  ...
                  - **mountPoints** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **readOnly** *(boolean) --*
                        ...
                        volume; otherwise, the container can write to the volume. The default value
                        is ``false`` .
                  ...
                  - **readonlyRootFilesystem** *(boolean) --*
                    ...
                    container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__
                    section of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__
                  ...
                  - **nodeRangeProperties** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **targetNodes** *(string) --*
                        ...
                        used to end the range. Your accumulative node ranges must account for all
                        nodes (0:n). You may nest node ranges, for example 0:10 and 4:5, in which
                      ...
                      - **container** *(dict) --*
                        ...
                        - **image** *(string) --*
                          ...
                          <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section
                          of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__
                        ...
                        - **vcpus** *(integer) --*
                          ...
                          <https://docs.docker.com/engine/reference/run/>`__ . Each vCPU is
                        ...
                        - **memory** *(integer) --*
                          ...
                          <https://docs.docker.com/engine/reference/run/>`__ . You must specify at
                        ...
                        - **command** *(list) --*
                          ...
                          ``Cmd`` in the `Create a container
                          <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section
                          of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__
                          and the ``COMMAND`` parameter to `docker run
                          <https://docs.docker.com/engine/reference/run/>`__ . For more information,
                        ...
                        - **mountPoints** *(list) --*
                          ...
                          to ``Volumes`` in the `Create a container
                          <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section
                          of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__
                        ...
                        - **privileged** *(boolean) --*
                          ...
                          maps to ``Privileged`` in the `Create a container
                          <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section
                          of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__
                        ...
                        - **linuxParameters** *(dict) --*
                          ...
                          - **devices** *(list) --*
                            ...
                            Any host devices to expose to the container. This parameter maps to
                            ``Devices`` in the `Create a container
                            <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__
                            section of the `Docker Remote API
                            <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--device``
                            ...
                            - *(dict) --*
                              ...
                              - **permissions** *(list) --*
                                ...
                                By default, the container has permissions for ``read`` , ``write`` ,
    ...
    def describe_job_queues(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          this parameter is used, ``DescribeJobQueues`` only returns ``maxResults`` results in a
          ...
          not used, then ``DescribeJobQueues`` returns up to 100 results and a ``nextToken`` value
          if applicable.
              ...
              - *(dict) --*
                ...
                - **container** *(dict) --*
                  ...
                  - **logStreamName** *(string) --*
                    ...
                    log group for AWS Batch jobs is ``/aws/batch/job`` . Each container attempt
    ...
    def list_jobs(
        ...
        * an array job ID to return a list of that job's children
        ...
        You can filter the results by job status with the ``jobStatus`` parameter. If you do not
        ...
        **Request Syntax**
        ...
        :param jobStatus:
          ...
          The job status with which to filter jobs in the specified queue. If you do not specify a
          status, only ``RUNNING`` jobs are returned.

        :type maxResults: integer
        :param maxResults:

          The maximum number of results returned by ``ListJobs`` in paginated output. When this
          parameter is used, ``ListJobs`` only returns ``maxResults`` results in a single page along
          with a ``nextToken`` response element. The remaining results of the initial request can be
          seen by sending another ``ListJobs`` request with the returned ``nextToken`` value. This
          value can be between 1 and 100. If this parameter is not used, then ``ListJobs`` returns
    ...
    def register_job_definition(
        ...
        **Request Syntax**
        ...
        :param nodeProperties:
          ...
          node properties for a job, it becomes a multi-node parallel job. For more information, see
          `Multi-node Parallel Jobs
          <https://docs.aws.amazon.com/batch/latest/userguide/multi-node-parallel-jobs.html>`__ in
          the *AWS Batch User Guide* . If the job definition's ``type`` parameter is ``container`` ,
        ...
        :param retryStrategy:
          ...
          retry strategy that is specified during a  SubmitJob operation overrides the retry
          strategy defined here. If a job is terminated due to a timeout, it is not retried.
        ...
        :param timeout:
          ...
          which AWS Batch terminates your jobs if they have not finished. If a job is terminated due
          to a timeout, it is not retried. The minimum value for the timeout is 60 seconds. Any
          timeout configuration that is specified during a  SubmitJob operation overrides the
          timeout configuration defined here. For more information, see `Job Timeouts
    ...
    def submit_job(
        ...
        **Request Syntax**
        ...
        :param jobQueue: **[REQUIRED]**
          ...
          The job queue into which the job is submitted. You can specify either the name or the
        ...
        :param arrayProperties:
          ...
          array job. For more information, see `Array Jobs
          <https://docs.aws.amazon.com/batch/latest/userguide/array_jobs.html>`__ in the *AWS Batch
          User Guide* .
        ...
        :param dependsOn:
          ...
          specify a ``SEQUENTIAL`` type dependency without specifying a job ID for array jobs so
          that each child array job completes sequentially, starting at index 0. You can also
          specify an ``N_TO_N`` type dependency with a job ID for array jobs. In that case, each
          index child of this job must wait for the corresponding index child of each dependency to
        ...
        :param jobDefinition: **[REQUIRED]**
          ...
          The job definition used by this job. This value can be either a ``name:revision`` or the
        ...
        :param parameters:
          ...
          mapping. Parameters in a ``SubmitJob`` request override any corresponding parameter
        ...
        :param containerOverrides:
          ...
          command for a container (that is specified in the job definition or the Docker image) with
          a ``command`` override. You can also override existing environment variables (that are
          specified in the job definition or Docker image) on a container or add new environment
        ...
        :param nodeOverrides:
          ...
          - **numNodes** *(integer) --*
            ...
            * The main node index specified in the job definition must be fewer than the number of
          ...
          - **nodePropertyOverrides** *(list) --*
            ...
            - *(dict) --*
              ...
              - **targetNodes** *(string) --* **[REQUIRED]**
                ...
                ``0:3`` indicates nodes with index values of ``0`` through ``3`` . If the starting
        ...
        :param timeout:
          ...
          duration after which AWS Batch terminates your jobs if they have not finished. If a job is
          terminated due to a timeout, it is not retried. The minimum value for the timeout is 60
          ...
          job. For more information, see `Job Timeouts
          <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/job_timeouts.html>`__ in the
          *Amazon Elastic Container Service Developer Guide* .
    ...
    def terminate_job(self, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        terminated, which causes them to transition to ``FAILED`` . Jobs that have not progressed to
    ...
    def update_job_queue(
        ...
        **Request Syntax**
        ...
        :param computeEnvironmentOrder:
          ...
          each other. This is one of the parameters used by the job scheduler to determine which
