...
def boto3_client(
    ...
    if session is not None:
        return session.client("batch", **kwargs)
    return boto3.client("batch", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_compute_environments_paginator(
    client: Client,
) -> DescribeComputeEnvironmentsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_job_definitions_paginator(client: Client) -> DescribeJobDefinitionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_job_queues_paginator(client: Client) -> DescribeJobQueuesPaginator:
    """
