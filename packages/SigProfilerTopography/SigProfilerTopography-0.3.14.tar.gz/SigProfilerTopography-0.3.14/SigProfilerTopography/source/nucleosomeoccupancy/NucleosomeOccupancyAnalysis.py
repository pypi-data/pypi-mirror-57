...
def combined_prepare_chrbased_data_fill_signal_count_arrays(occupancy_type,
    ...
    if verbose: print('\tWorker pid %s memory_usage in %.2f MB START TEST chrLong:%s simNum:%d' %(str(os.getpid()), memory_usage(), chrLong, simNum))
    ...
    if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check1 TEST Read Signal Array and Dataframes chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
    ...
    if ((chrBasedSignalArray is not None) or
        ...
        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check2_1 TEST Dinucs Start chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
        # Fill for dinucs
        ...
        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check2_2 TEST Dinucs End chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))

        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check3_1 TEST Indels Start chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
        # Fill for indels
        ...
        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check3_2 TEST Indels End chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))

        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check4_1 TEST Subs Start chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
        ...
        if verbose: print('\tWorker pid %s memory_usage in %.2f MB Check4_2 TEST Subs End chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
        ###############################################################################
    ...
    if verbose: print('\tWorker pid %s memory_usage in %.2f MB END TEST  chrLong:%s simNum:%d' % (str(os.getpid()), memory_usage(), chrLong, simNum))
