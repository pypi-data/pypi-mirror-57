...
def readChrBasedMutationsMergeWithProbabilitiesAndWrite(inputList):
    ...
    if ((chr_based_mutation_df is not None) and (mutations_probabilities_df is not None)):
        ...
        ############################################################################
        # #TODO To be set after Phobe run
        # print('DEBUG starts Dec 4, 2019')
        # print('BEFORE')
        # print('chr_based_mutation_df.dtypes')
        # print(chr_based_mutation_df.dtypes)
        # print('mutations_probabilities_df')
        # print(mutations_probabilities_df.dtypes)
        #
        # mutations_probabilities_df[MUTATION]=mutations_probabilities_df[MUTATION].astype(str)
        # mutations_probabilities_df[SAMPLE]=mutations_probabilities_df[SAMPLE].astype(str)
        #
        # print('AFTER')
        # print('chr_based_mutation_df.dtypes')
        # print(chr_based_mutation_df.dtypes)
