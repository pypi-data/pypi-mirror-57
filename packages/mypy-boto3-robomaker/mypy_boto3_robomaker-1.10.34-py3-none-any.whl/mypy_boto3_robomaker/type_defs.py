...
ListDeploymentJobsPaginateFiltersTypeDef = TypedDict(
    "ListDeploymentJobsPaginateFiltersTypeDef", {"name": str, "values": List[str]}, total=False
)

ListDeploymentJobsPaginatePaginationConfigTypeDef = TypedDict(
    "ListDeploymentJobsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListDeploymentJobsPaginateResponsedeploymentJobsdeploymentApplicationConfigslaunchConfigTypeDef = TypedDict(
...
ListDeploymentJobsPaginateResponsedeploymentJobsdeploymentApplicationConfigsTypeDef = TypedDict(
...
ListDeploymentJobsPaginateResponsedeploymentJobsdeploymentConfigdownloadConditionFileTypeDef = TypedDict(
    "ListDeploymentJobsPaginateResponsedeploymentJobsdeploymentConfigdownloadConditionFileTypeDef",
    {"bucket": str, "key": str, "etag": str},
    total=False,
)

ListDeploymentJobsPaginateResponsedeploymentJobsdeploymentConfigTypeDef = TypedDict(
...
ListDeploymentJobsPaginateResponsedeploymentJobsTypeDef = TypedDict(
...
ListDeploymentJobsPaginateResponseTypeDef = TypedDict(
...
ListFleetsPaginateFiltersTypeDef = TypedDict(
    "ListFleetsPaginateFiltersTypeDef", {"name": str, "values": List[str]}, total=False
)
...
ListFleetsPaginateResponsefleetDetailsTypeDef = TypedDict(
...
ListRobotApplicationsPaginateFiltersTypeDef = TypedDict(
    "ListRobotApplicationsPaginateFiltersTypeDef", {"name": str, "values": List[str]}, total=False
)

ListRobotApplicationsPaginatePaginationConfigTypeDef = TypedDict(
    "ListRobotApplicationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRobotApplicationsPaginateResponserobotApplicationSummariesrobotSoftwareSuiteTypeDef = TypedDict(
    "ListRobotApplicationsPaginateResponserobotApplicationSummariesrobotSoftwareSuiteTypeDef",
    {"name": Literal["ROS", "ROS2"], "version": Literal["Kinetic", "Melodic", "Dashing"]},
    total=False,
)

ListRobotApplicationsPaginateResponserobotApplicationSummariesTypeDef = TypedDict(
...
ListRobotApplicationsPaginateResponseTypeDef = TypedDict(
...
ListRobotsPaginateFiltersTypeDef = TypedDict(
    "ListRobotsPaginateFiltersTypeDef", {"name": str, "values": List[str]}, total=False
)

ListRobotsPaginatePaginationConfigTypeDef = TypedDict(
    "ListRobotsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRobotsPaginateResponserobotsTypeDef = TypedDict(
...
ListRobotsPaginateResponseTypeDef = TypedDict(
    "ListRobotsPaginateResponseTypeDef",
    {"robots": List[ListRobotsPaginateResponserobotsTypeDef], "NextToken": str},
    total=False,
)

ListSimulationApplicationsPaginateFiltersTypeDef = TypedDict(
    "ListSimulationApplicationsPaginateFiltersTypeDef",
    {"name": str, "values": List[str]},
    total=False,
)

ListSimulationApplicationsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSimulationApplicationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSimulationApplicationsPaginateResponsesimulationApplicationSummariesrobotSoftwareSuiteTypeDef = TypedDict(
    "ListSimulationApplicationsPaginateResponsesimulationApplicationSummariesrobotSoftwareSuiteTypeDef",
    {"name": Literal["ROS", "ROS2"], "version": Literal["Kinetic", "Melodic", "Dashing"]},
    total=False,
)

ListSimulationApplicationsPaginateResponsesimulationApplicationSummariessimulationSoftwareSuiteTypeDef = TypedDict(
    "ListSimulationApplicationsPaginateResponsesimulationApplicationSummariessimulationSoftwareSuiteTypeDef",
    {"name": Literal["Gazebo", "RosbagPlay"], "version": str},
    total=False,
)

ListSimulationApplicationsPaginateResponsesimulationApplicationSummariesTypeDef = TypedDict(
...
ListSimulationApplicationsPaginateResponseTypeDef = TypedDict(
...
ListSimulationJobsPaginateFiltersTypeDef = TypedDict(
    "ListSimulationJobsPaginateFiltersTypeDef", {"name": str, "values": List[str]}, total=False
)

ListSimulationJobsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSimulationJobsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSimulationJobsPaginateResponsesimulationJobSummariesTypeDef = TypedDict(
...
ListSimulationJobsPaginateResponseTypeDef = TypedDict(
