...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipCtxGetApiVersion = 8,
  HIP_API_ID_hipSetupArgument = 9,
  HIP_API_ID_hipMemcpyFromSymbolAsync = 10,
  HIP_API_ID_hipExtGetLinkTypeAndHopCount = 11,
  HIP_API_ID_hipMemcpyDtoD = 12,
  HIP_API_ID_hipHostFree = 13,
  HIP_API_ID_hipMemcpy2DToArray = 14,
  HIP_API_ID_hipCtxGetCacheConfig = 15,
  HIP_API_ID_hipStreamWaitEvent = 16,
  HIP_API_ID_hipDeviceGetStreamPriorityRange = 17,
  HIP_API_ID_hipModuleLoad = 18,
  HIP_API_ID_hipDevicePrimaryCtxSetFlags = 19,
  HIP_API_ID_hipLaunchCooperativeKernel = 20,
  HIP_API_ID_hipLaunchCooperativeKernelMultiDevice = 21,
  HIP_API_ID_hipMemcpyAsync = 22,
  HIP_API_ID_hipMalloc3DArray = 23,
  HIP_API_ID_hipStreamCreate = 24,
  HIP_API_ID_hipCtxGetCurrent = 25,
  HIP_API_ID_hipDevicePrimaryCtxGetState = 26,
  HIP_API_ID_hipEventQuery = 27,
  HIP_API_ID_hipEventCreate = 28,
  HIP_API_ID_hipMemGetAddressRange = 29,
  HIP_API_ID_hipMemcpyFromSymbol = 30,
  HIP_API_ID_hipArrayCreate = 31,
  HIP_API_ID_hipStreamGetFlags = 32,
  HIP_API_ID_hipMallocArray = 33,
  HIP_API_ID_hipCtxGetSharedMemConfig = 34,
  HIP_API_ID_hipMemPtrGetInfo = 35,
  HIP_API_ID_hipFuncGetAttribute = 36,
  HIP_API_ID_hipCtxGetFlags = 37,
  HIP_API_ID_hipStreamDestroy = 38,
  HIP_API_ID___hipPushCallConfiguration = 39,
  HIP_API_ID_hipMemset3DAsync = 40,
  HIP_API_ID_hipMemcpy3D = 41,
  HIP_API_ID_hipInit = 42,
  HIP_API_ID_hipMemcpyAtoH = 43,
  HIP_API_ID_hipStreamGetPriority = 44,
  HIP_API_ID_hipMemset2D = 45,
  HIP_API_ID_hipMemset2DAsync = 46,
  HIP_API_ID_hipDeviceCanAccessPeer = 47,
  HIP_API_ID_hipDeviceEnablePeerAccess = 48,
  HIP_API_ID_hipLaunchKernel = 49,
  HIP_API_ID_hipModuleUnload = 50,
  HIP_API_ID_hipHostUnregister = 51,
  HIP_API_ID_hipProfilerStop = 52,
  HIP_API_ID_hipLaunchByPtr = 53,
  HIP_API_ID_hipStreamSynchronize = 54,
  HIP_API_ID_hipDeviceSetCacheConfig = 55,
  HIP_API_ID_hipGetErrorName = 56,
  HIP_API_ID_hipMemcpyHtoD = 57,
  HIP_API_ID_hipModuleGetGlobal = 58,
  HIP_API_ID_hipMemcpyHtoA = 59,
  HIP_API_ID_hipCtxCreate = 60,
  HIP_API_ID_hipMemcpy2D = 61,
  HIP_API_ID_hipIpcCloseMemHandle = 62,
  HIP_API_ID_hipChooseDevice = 63,
  HIP_API_ID_hipDeviceSetSharedMemConfig = 64,
  HIP_API_ID_hipDeviceComputeCapability = 65,
  HIP_API_ID_hipDeviceGet = 66,
  HIP_API_ID_hipProfilerStart = 67,
  HIP_API_ID_hipCtxSetCacheConfig = 68,
  HIP_API_ID_hipFuncSetCacheConfig = 69,
  HIP_API_ID_hipMemcpyPeerAsync = 70,
  HIP_API_ID_hipEventElapsedTime = 71,
  HIP_API_ID_hipDevicePrimaryCtxReset = 72,
  HIP_API_ID_hipMemcpy3DAsync = 73,
  HIP_API_ID_hipEventDestroy = 74,
  HIP_API_ID_hipCtxPopCurrent = 75,
  HIP_API_ID_hipGetSymbolAddress = 76,
  HIP_API_ID_hipHostGetFlags = 77,
  HIP_API_ID_hipHostMalloc = 78,
  HIP_API_ID_hipDriverGetVersion = 79,
  HIP_API_ID_hipMemGetInfo = 80,
  HIP_API_ID_hipDeviceReset = 81,
  HIP_API_ID_hipMemset = 82,
  HIP_API_ID_hipMemsetD8 = 83,
  HIP_API_ID_hipMemcpyParam2DAsync = 84,
  HIP_API_ID_hipHostRegister = 85,
  HIP_API_ID_hipCtxSetSharedMemConfig = 86,
  HIP_API_ID_hipArray3DCreate = 87,
  HIP_API_ID_hipIpcOpenMemHandle = 88,
  HIP_API_ID_hipGetLastError = 89,
  HIP_API_ID_hipCtxDestroy = 90,
  HIP_API_ID_hipDeviceGetSharedMemConfig = 91,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 92,
  HIP_API_ID_hipSetDeviceFlags = 93,
  HIP_API_ID_hipHccModuleLaunchKernel = 94,
  HIP_API_ID_hipFree = 95,
  HIP_API_ID_hipOccupancyMaxPotentialBlockSize = 96,
  HIP_API_ID_hipDeviceGetAttribute = 97,
  HIP_API_ID_hipMemcpyDtoH = 98,
  HIP_API_ID_hipCtxDisablePeerAccess = 99,
  HIP_API_ID_hipMallocManaged = 100,
  HIP_API_ID_hipDeviceGetByPCIBusId = 101,
  HIP_API_ID_hipIpcGetMemHandle = 102,
  HIP_API_ID_hipMemcpyHtoDAsync = 103,
  HIP_API_ID_hipCtxGetDevice = 104,
  HIP_API_ID_hipMemset3D = 105,
  HIP_API_ID_hipModuleLoadData = 106,
  HIP_API_ID_hipDeviceTotalMem = 107,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor = 108,
  HIP_API_ID_hipCtxSetCurrent = 109,
  HIP_API_ID_hipGetErrorString = 110,
  HIP_API_ID_hipDevicePrimaryCtxRetain = 111,
  HIP_API_ID_hipDeviceDisablePeerAccess = 112,
  HIP_API_ID_hipStreamCreateWithFlags = 113,
  HIP_API_ID_hipMemcpyFromArray = 114,
  HIP_API_ID_hipMemcpy2DAsync = 115,
  HIP_API_ID_hipFuncGetAttributes = 116,
  HIP_API_ID_hipGetSymbolSize = 117,
  HIP_API_ID_hipEventCreateWithFlags = 118,
  HIP_API_ID_hipStreamQuery = 119,
  HIP_API_ID_hipDeviceGetPCIBusId = 120,
  HIP_API_ID_hipMemcpy = 121,
  HIP_API_ID_hipPeekAtLastError = 122,
  HIP_API_ID_hipExtLaunchMultiKernelMultiDevice = 123,
  HIP_API_ID_hipStreamAddCallback = 124,
  HIP_API_ID_hipMemcpyToArray = 125,
  HIP_API_ID_hipMemsetD32 = 126,
  HIP_API_ID_hipDeviceSynchronize = 127,
  HIP_API_ID_hipDeviceGetCacheConfig = 128,
  HIP_API_ID_hipMalloc3D = 129,
  HIP_API_ID_hipPointerGetAttributes = 130,
  HIP_API_ID_hipMemsetAsync = 131,
  HIP_API_ID_hipMemcpyToSymbol = 132,
  HIP_API_ID_hipCtxPushCurrent = 133,
  HIP_API_ID_hipMemcpyPeer = 134,
  HIP_API_ID_hipEventSynchronize = 135,
  HIP_API_ID_hipMemcpyDtoDAsync = 136,
  HIP_API_ID_hipExtMallocWithFlags = 137,
  HIP_API_ID_hipCtxEnablePeerAccess = 138,
  HIP_API_ID_hipMemcpyDtoHAsync = 139,
  HIP_API_ID_hipModuleLaunchKernel = 140,
  HIP_API_ID_hipModuleGetTexRef = 141,
  HIP_API_ID_hipDeviceGetLimit = 142,
  HIP_API_ID_hipModuleLoadDataEx = 143,
  HIP_API_ID_hipRuntimeGetVersion = 144,
  HIP_API_ID___hipPopCallConfiguration = 145,
  HIP_API_ID_hipGetDeviceProperties = 146,
  HIP_API_ID_hipFreeArray = 147,
  HIP_API_ID_hipDevicePrimaryCtxRelease = 148,
  HIP_API_ID_hipHostGetDevicePointer = 149,
  HIP_API_ID_hipMemcpyParam2D = 150,
  HIP_API_ID_hipModuleGetFunction = 151,
  HIP_API_ID_hipMemsetD32Async = 152,
  HIP_API_ID_hipGetDevice = 153,
  HIP_API_ID_hipGetDeviceCount = 154,
  HIP_API_ID_NUMBER = 155,
  HIP_API_ID_ANY = 156,
...
#define INIT_hipLaunchCooperativeKernel_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipLaunchCooperativeKernel.f = f; \
  cb_data.args.hipLaunchCooperativeKernel.gridDim = gridDim; \
  cb_data.args.hipLaunchCooperativeKernel.blockDimX = blockDimX; \
  cb_data.args.hipLaunchCooperativeKernel.kernelParams = kernelParams; \
  cb_data.args.hipLaunchCooperativeKernel.sharedMemBytes = sharedMemBytes; \
  cb_data.args.hipLaunchCooperativeKernel.stream = stream; \
};
...
#define INIT_hipLaunchCooperativeKernelMultiDevice_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipLaunchCooperativeKernelMultiDevice.launchParamsList = launchParamsList; \
  cb_data.args.hipLaunchCooperativeKernelMultiDevice.numDevices = numDevices; \
  cb_data.args.hipLaunchCooperativeKernelMultiDevice.flags = flags; \
};
...
#define INIT_hipExtLaunchMultiKernelMultiDevice_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipExtLaunchMultiKernelMultiDevice.launchParamsList = launchParamsList; \
  cb_data.args.hipExtLaunchMultiKernelMultiDevice.numDevices = numDevices; \
  cb_data.args.hipExtLaunchMultiKernelMultiDevice.flags = flags; \
};
