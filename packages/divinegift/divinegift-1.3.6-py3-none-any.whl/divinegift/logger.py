...
def log_debug(*args, separator=' '):
    ...
    """
    if logger:
        logger.debug(separator.join(args))
    else:
        logging.debug(separator.join(args))
    #print(msg)
...
def log_info(*args, separator=' '):
    ...
    """
    if logger:
        logger.info(separator.join(args))
    else:
        logging.info(separator.join(args))
    #print(msg)
...
def log_warning(*args, separator=' '):
    ...
    """
    if logger:
        logger.warning(separator.join(args))
    else:
        logging.warning(separator.join(args))
    #print(msg)
...
def log_err(*args, separator=' ', src: str = None, mode: list = [], channel: dict = {}):
    ...
    """
    if logger:
        logger.exception(separator.join(args))
    else:
        logging.exception(separator.join(args))
    #print(msg)
    error_txt = f'An error has occurred in {src}\nError text: {separator.join(args)}\n{traceback.format_exc()}'
...
def log_crit(*args, separator=' '):
    logging.critical(separator.join(args))
    #print(msg)
