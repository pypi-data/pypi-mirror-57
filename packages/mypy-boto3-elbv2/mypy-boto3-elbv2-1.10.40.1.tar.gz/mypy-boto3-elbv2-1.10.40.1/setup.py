...
setup(
    ...
    description="Type annotations for boto3.ElasticLoadBalancingv2 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 elbv2 type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
