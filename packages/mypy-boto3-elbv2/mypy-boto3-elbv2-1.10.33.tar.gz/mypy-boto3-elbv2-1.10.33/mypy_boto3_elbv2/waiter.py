...
class LoadBalancerAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [load_balancer_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.load_balancer_available.wait)
        """
...
class LoadBalancerExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [load_balancer_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.load_balancer_exists.wait)
        """
...
class LoadBalancersDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [load_balancers_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.load_balancers_deleted.wait)
        """
...
class TargetDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [target_deregistered.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.target_deregistered.wait)
        """
...
class TargetInServiceWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [target_in_service.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/elbv2.html#ElasticLoadBalancingv2.Waiter.target_in_service.wait)
        """
