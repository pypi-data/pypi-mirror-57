...
reader = [] # select reader (if reader = None -> request card from all readers)
...
class PCSCCardRequest(AbstractCardRequest):
    def __init__(self, newcardonly=False, readers=None,
        ...
        self.pollinginterval = 0.01 if self.msr_active else 0.5 # normal 0.1
