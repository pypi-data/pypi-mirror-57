...
- enable_namespace (ACTION REQUIRED, lower version incompatible):
  If you didn't use this option with `True` under
  version 0.7 you MUST set `False` in version 0.7

  Also DO NOT use this option from version 0.7 without particular reason.

- auto_mount: If you call app.mount () or pref.mount (), this option will
  be disabled automatically. Otherwise Atila try to mount
...
- 0.7 (Dec, 2019)
  ...
  - deprecated app options: enable_namespace and auto_mount
