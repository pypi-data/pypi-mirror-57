...
Mypy-friendly auto-generated type annotations for `boto3 servicediscovery 1.10.33` service.
...
client: servicediscovery.Client = boto3.client("servicediscovery")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: servicediscovery.Client = session.client("servicediscovery")
