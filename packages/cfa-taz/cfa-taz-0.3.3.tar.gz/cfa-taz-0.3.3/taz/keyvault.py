...
class KeyVault:
    ...
    attributes:
        ...
        AZURE_TENANT_ID, AZURE_CLIENT_ID, AZURE_CLIENT_SECRET and AZURE_CLI_USER
            - service principal authentication if AZURE_CLIENT_SECRET is set
            - user MSI authentication if AZURE_CLIENT_ID is set
            - CLI based authentication if AZURE_CLI_USER var is set
            - system MSI authentication: default configuration
    """
