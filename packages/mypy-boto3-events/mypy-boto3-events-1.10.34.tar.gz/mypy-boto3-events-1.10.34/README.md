...
Mypy-friendly auto-generated type annotations for `boto3 events 1.10.34` service.
...
client: events.Client = boto3.client("events")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: events.Client = session.client("events")
