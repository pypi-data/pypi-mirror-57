...
Mypy-friendly auto-generated type annotations for `boto3 iam 1.10.33` service.
...
client: iam.Client = boto3.client("iam")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: iam.Client = session.client("iam")

# Do you prefer resource approach? We've got you covered!
resource: iam.ServiceResource = boto3.resource("iam")
