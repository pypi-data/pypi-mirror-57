...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_get_compliance_summary_paginator(client: Client) -> GetComplianceSummaryPaginator:
    """
    Equivalent of `client.get_paginator('get_compliance_summary')`, returns a correct type.
    """
