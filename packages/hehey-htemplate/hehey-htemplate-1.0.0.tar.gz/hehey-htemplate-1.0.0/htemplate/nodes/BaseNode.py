...
class BaseNode:
    ...
    def find(self):
        ...
        #regex = self.compiler.getAllExpressionPattern()
        regex = self.compiler.getTemplatePattern(True)
        self.posend = 0
        ...
        while True:
            ...
            res = regex.search(self.body, self.findpos)
            if res is None:
