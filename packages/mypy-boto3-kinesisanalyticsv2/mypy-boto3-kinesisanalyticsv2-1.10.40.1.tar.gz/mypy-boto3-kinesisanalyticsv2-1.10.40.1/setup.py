...
setup(
    ...
    description="Type annotations for boto3.KinesisAnalyticsV2 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 kinesisanalyticsv2 type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
