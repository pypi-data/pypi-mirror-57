...
Mypy-friendly auto-generated type annotations for `boto3 ram 1.10.33` service.
...
client: ram.Client = boto3.client("ram")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: ram.Client = session.client("ram")
