...
from mypy_boto3.type_defs import Literal, S3CopySource, overload
...
class Client(BaseClient):
    ...
    def abort_multipart_upload(
        ...
        you should call the  ListParts operation and ensure that the parts list is empty.
        ...
        **Request Syntax**
        ...
        :param Bucket: **[REQUIRED]**
          ...
          hostname. The access point hostname takes the form *AccessPointName* -*AccountId*
          .s3-accesspoint.*Region* .amazonaws.com. When using this operation using an access point
          through the AWS SDKs, you provide the access point ARN in place of the bucket name. For
          more information about access point ARNs, see `Using Access Points
          <https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html>`__ in the
        ...
        :param RequestPayer:
          ...
          Pays Buckets
          <https://docs.aws.amazon.com/http:/docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`__
    ...
    def complete_multipart_upload(
        ...
        each part in the list, you must provide the part number and the ``ETag`` value, returned
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SSEKMSKeyId** *(string) --*
              ...
              If present, specifies the ID of the AWS Key Management Service (AWS KMS) customer
    ...
    def copy_object(
        ...
        in Amazon S3 using the ``StorageClass`` parameter. For more information, see `Storage
        ...
        * To encrypt the target object using server-side encryption with an AWS managed encryption
        ...
        .. note::
          ...
          ``x-amz-server-side- encryption-aws-kms-key-id`` , Amazon S3 uses the AWS managed customer
          master key (CMK) in AWS KMS to protect the data.
        ...
        * Specify a canned ACL (``x-amz-acl`` ) — Amazon S3 supports a set of predefined ACLs, known
        as *canned ACLs* . Each canned ACL has a predefined set of grantees and permissions. For
        ...
        **Request Syntax**
        ...
        :param SSEKMSKeyId:
          ...
          about configuring using any of the officially supported AWS SDKs and AWS CLI, see
          `Specifying the Signature Version in Request Authentication
          <https://docs.aws.amazon.com/http:/docs.aws.amazon.com/AmazonS3/latest/dev/UsingAWSSDK.html#specify-signature-version>`__
          in the *Amazon S3 Developer Guide* .
    ...
    def create_bucket(
        ...
        .. note::
          ...
          goes to the us-east-1 Region. Accordingly, the signature calculations in Signature Version
          4 must use us-east-1 as the Region, even if the location constraint in the request
          specifies another Region where the bucket is to be created. If you create a bucket in a
          Region other than US East (N. Virginia), your application must be able to handle 307
        ...
        * Specify a canned ACL using the ``x-amz-acl`` request header. Amazon S3 supports a set of
        ...
        and permissions. For more information, see `Canned ACL
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#CannedACL>`__ .
    ...
    def create_multipart_upload(
        ...
        * Use encryption keys managed by Amazon S3 or customer master keys (CMKs) stored in AWS Key
        ...
        .. note::
          ...
          If you specify ``x-amz-server-side-encryption:aws:kms`` , but don't provide
          ``x-amz-server-side- encryption-aws-kms-key-id`` , Amazon S3 uses the AWS managed CMK in
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AbortDate** *(datetime) --*
              ...
              The response also includes the ``x-amz-abort-rule-id`` header that provides the ID of
            ...
            - **Bucket** *(string) --*
              ...
              When using this API with an access point, you must direct requests to the access point
              hostname. The access point hostname takes the form *AccessPointName* -*AccountId*
              .s3-accesspoint.*Region* .amazonaws.com. When using this operation using an access
              point through the AWS SDKs, you provide the access point ARN in place of the bucket
              name. For more information about access point ARNs, see `Using Access Points
              <https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html>`__ in the
              *Amazon Simple Storage Service Developer Guide* .
    ...
    def delete_bucket_policy(self, Bucket: str) -> None:
        ...
        permissions on the specified bucket and belong to the bucket owner's account to use this
        operation.
    ...
    def delete_object(
        ...
        If the object you want to delete is in a bucket where the bucket versioning configuration is
    ...
    def delete_objects(
        ...
        provide an invalid token, whether there are versioned keys in the request or not, the entire
        Multi-Object Delete request will fail. For information about MFA Delete, see `MFA Delete
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html#MultiFactorAuthenticationDelete>`__
        .
    ...
    def get_bucket_cors(self, Bucket: str) -> ClientGetBucketCorsResponseTypeDef:
        ...
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html>`__ .
    ...
    def get_bucket_lifecycle(self, Bucket: str) -> ClientGetBucketLifecycleResponseTypeDef:
        ...
        .. warning::
          ...
          configured a bucket lifecycle using the ``filter`` element, you should see the updated
          version of this topic. This topic is provided for backward compatibility.
            ...
            - **Rules** *(list) --*
              ...
              - *(dict) --*
                ...
                - **NoncurrentVersionTransitions** *(list) --*
                  ...
                  versioning-enabled (or versioning is suspended), you can set this action to
                  request that Amazon S3 transition noncurrent object versions to a specific storage
            ...
            - **LoggingEnabled** *(dict) --*
              ...
              *Amazon Simple Storage Service API Reference* .
              ...
              - **TargetBucket** *(string) --*
                ...
                the same target bucket. In this case, you should choose a different ``TargetPrefix``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TopicConfiguration** *(dict) --*
              ...
              This data type is deprecated. A container for specifying the configuration for
    ...
    def get_bucket_replication(self, Bucket: str) -> ClientGetBucketReplicationResponseTypeDef:
        ...
        For information about replication configuration, see `Replication
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/replication.html>`__ in the *Amazon Simple
                ...
                - *(dict) --*
                  ...
                  - **Destination** *(dict) --*
                    ...
                    - **Metrics** *(dict) --*
                      ...
                      specified together with a ``ReplicationTime`` block.
                  ...
                  - **DeleteMarkerReplication** *(dict) --*
                    ...
                    .. note::
                      ...
                      Amazon S3 handled replication of delete markers differently. For more
    ...
    def get_bucket_versioning(self, Bucket: str) -> ClientGetBucketVersioningResponseTypeDef:
        ...
        Delete status is ``enabled`` , the bucket owner must use an authentication device to change
              ...
              - *(dict) --*
                ...
                - **Condition** *(dict) --*
                  ...
                  - **KeyPrefixEquals** *(string) --*
                    ...
                    specified and sibling ``HttpErrorCodeReturnedEquals`` is not specified. If both
    ...
    def get_object(
        ...
        object ``photos/2006/February/sample.jpg`` in the bucket named ``examplebucket`` , specify
        the resource as ``/examplebucket/photos/2006/February/sample.jpg`` . For more information
    ...
    def get_public_access_block(self, Bucket: str) -> ClientGetPublicAccessBlockResponseTypeDef:
        ...
        operation, you must have the ``s3:GetBucketPublicAccessBlock`` permission. For more
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ReplicationStatus** *(string) --*
              ...
              (``GetObject`` ) or object metadata (``HeadObject`` ) from these buckets, Amazon S3
              will return the ``x-amz-replication-status`` header in the response as follows:

              * If requesting an object from the source bucket — Amazon S3 will return the
              ``x-amz-replication-status`` header if the object in your request is eligible for
              replication. For example, suppose that in your replication configuration, you specify
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IsTruncated** *(boolean) --*
              ...
              request using the NextKeyMarker and NextVersionIdMarker response parameters as a
            ...
            - **NextVersionIdMarker** *(string) --*
              ...
              ``NextVersionIdMarker`` specifies the first object version not returned that satisfies
              the search criteria. Use this value for the version-id-marker request parameter in a
              subsequent request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Delimiter** *(string) --*
              ...
              of the delimiter to be rolled up into a single result element in the
              ``CommonPrefixes`` collection. These rolled-up keys are not returned elsewhere in the
              response. Each rolled-up result counts as only one return against the ``MaxKeys``
              value.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextContinuationToken** *(string) --*
               ...
               more keys in the bucket that can be listed. The next list requests to Amazon S3 can
               be continued with this ``NextContinuationToken`` . ``NextContinuationToken`` is
    ...
    def put_bucket_acl(
        ...
        * Specify access permissions explicitly with the ``x-amz-grant-read`` ,
        ...
        headers, you cannot use the ``x-amz-acl`` header to set a canned ACL. These parameters map
    ...
    def put_bucket_analytics_configuration(
        ...
        comma-separated values (CSV) flat file. See the ``DataExport`` request element. Reports are
        updated daily and are based on the object filters that you configure. When selecting data
        export, you specify a destination bucket and an optional destination prefix where the file
        is written. You can export the data to a destination bucket in a different account. However,
        the destination bucket must be in the same Region as the bucket that you are making the PUT
        analytics configuration to. For more information, see `Amazon S3 Analytics – Storage Class
        Analysis <https://docs.aws.amazon.com/AmazonS3/latest/dev/analytics-storage-class.html>`__ .
              ...
              - **Encryption** *(dict) --*
                ...
                - **SSEKMS** *(dict) --*
                  ...
                  - **KeyId** *(string) --* **[REQUIRED]**
                    ...
                    Specifies the ID of the AWS Key Management Service (AWS KMS) customer master key
          ...
          - **Rules** *(list) --* **[REQUIRED]**
            ...
            - *(dict) --*
              ...
              - **NoncurrentVersionTransitions** *(list) --*
                ...
                transition noncurrent object versions to a specific storage class at a set period in
                the object's lifetime.
          ...
          - **LoggingEnabled** *(dict) --*
            ...
            *Amazon Simple Storage Service API Reference* .
            ...
            - **TargetBucket** *(string) --* **[REQUIRED]**
              ...
              same target bucket. In this case, you should choose a different ``TargetPrefix`` for
            ...
            - *(dict) --*
              ...
              - **Destination** *(dict) --* **[REQUIRED]**
                ...
                - **ReplicationTime** *(dict) --*
                  ...
                  RTC is enabled and the time when all objects and operations on objects must be
              ...
              - **DeleteMarkerReplication** *(dict) --*
                ...
                .. note::
                  ...
                  If you don't specify the ``Filter`` element, Amazon S3 assumes that the
                  replication configuration is the earlier version, V1. In the earlier version,
                  Amazon S3 handled replication of delete markers differently. For more information,
    ...
    def put_object(
        ...
        * Use encryption keys managed by Amazon S3 or customer master keys (CMKs) stored in AWS Key
        ...
        .. note::
          ...
          If you specify ``x-amz-server-side-encryption:aws:kms`` , but don't provide
          ``x-amz-server-side- encryption-aws-kms-key-id`` , Amazon S3 uses the default AWS KMS CMK
          to protect the data.
        ...
        **Request Syntax**
        ...
        :param WebsiteRedirectLocation:
          ...
          If the bucket is configured as a website, redirects requests for this object to another
          object in the same bucket or to an external URL. Amazon S3 stores the value of this header
          in the object metadata. For information about object metadata, see `Object Key and
          Metadata <https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html>`__ .
        ...
        :param SSEKMSKeyId:
          ...
          header specifies the ID of the AWS Key Management Service (AWS KMS) customer master key
          ...
          provide``x-amz-server-side-encryption-aws-kms-key-id`` , Amazon S3 uses the AWS managed
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SSEKMSKeyId** *(string) --*
              ...
              If ``x-amz-server-side-encryption`` is present and has the value of ``aws:kms`` , this
              header specifies the ID of the AWS Key Management Service (AWS KMS) customer master
    ...
    def put_object_acl(
        ...
        """
        Uses the ``acl`` subresource to set the access control list (ACL) permissions for an object
        that already exists in a bucket. You must have ``WRITE_ACP`` permission to set the ACL of an
        object.

        Depending on your application needs, you can choose to set the ACL on an object using either
        the request body or the headers. For example, if you have an existing application that
        updates a bucket ACL using the request body, you can continue to use that approach.
        ...
        * Specify a canned ACL with the ``x-amz-acl`` request header. Amazon S3 supports a set of
        ...
        permissions. Specify the canned ACL name as the value of ``x-amz-ac`` l. If you use this
        header, you cannot use other access control-specific headers in your request. For more
        information, see `Canned ACL
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#CannedACL>`__ .
        ...
        * Specify access permissions explicitly with the ``x-amz-grant-read`` ,
        ...
        headers. When using these headers, you specify explicit access permissions and grantees (AWS
        accounts or Amazon S3 groups) who will receive the permission. If you use these ACL-specific
        headers, you cannot use ``x-amz-acl`` header to set a canned ACL. These parameters map to
        the set of permissions that Amazon S3 supports in an ACL. For more information, see `Access
    ...
    def put_public_access_block(
        ...
        .. warning::
          ...
          object, it checks the ``PublicAccessBlock`` configuration for both the bucket (or the
          bucket that contains the object) and the bucket owner's account. If the
          ``PublicAccessBlock`` configurations are different between the bucket and the account,
            ...
            - **S3** *(dict) --*
              ...
              - **Encryption** *(dict) --*
                ...
                - **KMSKeyId** *(string) --*
                  ...
                  If the encryption type is ``aws:kms`` , this optional value specifies the AWS KMS
                  key ID to use for encryption of job results.
    ...
    def upload_part_copy(
        ...
        * For information about copying objects using a single atomic operation vs. the multipart
        upload, see `Operations on Objects
        ...
        * **Consideration 2** - If both of the ``x-amz-copy-source-if-none-match`` and
        ...
        ``x-amz-copy-source-if-modified-since`` condition evaluates to ``true`` ; Amazon S3 returns
