...
class BucketExistsWaiter(Boto3Waiter):
    ...
    def wait(self, Bucket: str, WaiterConfig: BucketExistsWaitWaiterConfigTypeDef = None) -> None:
        """
        [bucket_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/s3.html#S3.Waiter.bucket_exists.wait)
        """
...
class BucketNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [bucket_not_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/s3.html#S3.Waiter.bucket_not_exists.wait)
        """
...
class ObjectExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [object_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/s3.html#S3.Waiter.object_exists.wait)
        """
...
class ObjectNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [object_not_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/s3.html#S3.Waiter.object_not_exists.wait)
        """
