...
setup(
    ...
    description="Type annotations for boto3.S3 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 s3 type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
