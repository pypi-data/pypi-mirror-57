...
Mypy-friendly auto-generated type annotations for `boto3 dataexchange 1.10.33` service.
...
```bash
pip install boto3-stubs[mypy-boto3-dataexchange]
```
...
client: dataexchange.Client = boto3.client("dataexchange")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: dataexchange.Client = session.client("dataexchange")
