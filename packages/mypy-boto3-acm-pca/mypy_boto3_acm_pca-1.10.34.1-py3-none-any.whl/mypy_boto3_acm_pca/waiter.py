...
class AuditReportCreatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [AuditReportCreated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.AuditReportCreated.wait)
        """
...
class CertificateAuthorityCSRCreatedWaiter(Boto3Waiter):
    ...
    def wait(self, CertificateAuthorityArn: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [CertificateAuthorityCSRCreated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateAuthorityCSRCreated.wait)
        """
...
class CertificateIssuedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [CertificateIssued.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.CertificateIssued.wait)
        """
