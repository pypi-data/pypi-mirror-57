...
class AuditReportCreatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [audit_report_created.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.audit_report_created.wait)
        """
...
class CertificateAuthorityCSRCreatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [certificate_authority_csr_created.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.certificate_authority_csr_created.wait)
        """
...
class CertificateIssuedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [certificate_issued.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/acm-pca.html#ACMPCA.Waiter.certificate_issued.wait)
        """
