...
setup(
    ...
    description="Type annotations for boto3.Cloud9 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 cloud9 type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
