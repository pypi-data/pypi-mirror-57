...
Mypy-friendly auto-generated type annotations for `boto3 cloud9 1.10.34` service.
...
client: cloud9.Client = boto3.client("cloud9")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: cloud9.Client = session.client("cloud9")
