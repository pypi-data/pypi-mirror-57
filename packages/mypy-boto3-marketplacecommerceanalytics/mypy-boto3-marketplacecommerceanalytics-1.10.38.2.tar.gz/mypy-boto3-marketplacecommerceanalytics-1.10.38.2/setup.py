...
setup(
    ...
    description="Mypy-friendly boto3 1.10.38 type annotations for marketplacecommerceanalytics service.",
    classifiers=[
    ...
    install_requires=["typing_extensions; python_version < '3.8'", "mypy-boto3==1.10.38.2",],
    zip_safe=False,
