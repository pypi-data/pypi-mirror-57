...
class Parameters(object):
    ...
    def get_node_info(self, node_name: str = None):
        ...
        try:
            ...
            return self.API.get("/v1/parameters/get-node-info/{}".format(node_name))
    ...
    def get_beam_info(self, beam_number: int = None):
        ...
        try:
            ...
            return self.API.get("/v1/parameters/get-beam-info/{}".format(beam_number))
        except AssertionError as e:
    ...
    def get_datapaths(self, event_number: int = None) -> list:
        ...
        """
        if event_number:
            return self.API.get(url="/v1/events/datapaths/{}".format(event_number))
        else:
