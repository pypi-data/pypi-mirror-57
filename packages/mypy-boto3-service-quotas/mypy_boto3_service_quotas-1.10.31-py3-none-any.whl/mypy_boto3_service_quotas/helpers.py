...
def get_list_requested_service_quota_change_history_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_requested_service_quota_change_history')`, returns a
    correct type.
    """
...
def get_list_requested_service_quota_change_history_by_quota_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_requested_service_quota_change_history_by_quota')`,
...
def get_list_service_quota_increase_requests_in_template_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_service_quota_increase_requests_in_template')`,
    returns a correct type.
    """
