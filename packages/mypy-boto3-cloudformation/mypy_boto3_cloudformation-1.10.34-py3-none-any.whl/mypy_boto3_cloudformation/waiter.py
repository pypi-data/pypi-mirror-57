...
class ChangeSetCreateCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [change_set_create_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.change_set_create_complete.wait)
        """
...
class StackCreateCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stack_create_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.stack_create_complete.wait)
        """
...
class StackDeleteCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stack_delete_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.stack_delete_complete.wait)
        """
...
class StackExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stack_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.stack_exists.wait)
        """
...
class StackImportCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stack_import_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.stack_import_complete.wait)
        """
...
class StackUpdateCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [stack_update_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.stack_update_complete.wait)
        """
...
class TypeRegistrationCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [type_registration_complete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/cloudformation.html#CloudFormation.Waiter.type_registration_complete.wait)
        """
