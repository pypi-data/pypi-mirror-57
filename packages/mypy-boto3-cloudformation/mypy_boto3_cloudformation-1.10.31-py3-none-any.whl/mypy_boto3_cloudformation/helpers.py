...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_account_limits_paginator(client: Client) -> DescribeAccountLimitsPaginator:
    """
...
def get_list_stack_set_operation_results_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_stack_set_operation_results')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_stack_set_operations_paginator(client: Client) -> ListStackSetOperationsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_change_set_create_complete_waiter(client: Client) -> ChangeSetCreateCompleteWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_type_registration_complete_waiter(client: Client) -> TypeRegistrationCompleteWaiter:
    """
