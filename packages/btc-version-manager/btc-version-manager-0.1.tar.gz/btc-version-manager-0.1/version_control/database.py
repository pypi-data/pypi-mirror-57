...
def format_message(log_message: str, log_message_args: Collection, log_message_args_dict: dict) -> str:
    """
    Method for formatting a message line: adding arguments
    :param log_message: original log message
    :param log_message_args: collection of arguments
    :param log_message_args_dict: argument values for formatting
    :return: str
    """
...
def get_exception_info(exc_type: Any, exc_val: str, exc_tb: traceback) -> dict:
    """
    Method for getting exception information
    :param exc_type: Any, type of exception
...
class TransactionManagerError(Exception):
    """
    Custom transaction manager exception class
    """
...
class TransactionManager:
    """
    Context manager for exception handling and transaction commit / rollback
    """
