...
class VersionControlJSONEncoder(DjangoJSONEncoder):
    """
    Encoder format 'json' for serializer 'VersionControlBaseSerializer'
    """
...
class VersionControlBaseSerializer(base.Serializer):
    """
    Base serializer of version control objects.
    Designed to create a recoverable representation of a modified object, as well as forwarding additional
    ...
    [
        {
            ...
            fields_extra_data: {
                'name_1': {
                    ...
                    'display_value': 'display_value_of_name_1'  Если поле имеет атрибут 'choices'
                },
                'name_2': {
                    'verbose_name': 'verbose_name_of_name_2'
                    'internal_type': 'ForeignKey',
                    'representation': 'repr_of_name_2_fk'  Стрковое представление объекта связи
                }
            },
            obj_extra_data: {
                'verbose_name': 'verbose_name_of_model_object',
                'representation': 'repr_of_model_object'  Строковое представление
            }
        },
        {
            ...
    ...
    def provide_obj_extra_data(self, data, obj):
        """
        Method for filling fixture with additional data
        """
    ...
    def provide_extra_data(self, obj, field):
        """
        Method for filling fixture with additional field data
        """
    ...
    def get_choice_field_display_value(self, obj: Type[Model],  field: Field) -> str:
        """
        Method for retrieving translated display of field value 'display_value'
        """
    ...
    def get_representation(self, obj: Type[Model],  field: Field):
        """
        Method for extracting descriptive names for field objects 'ForeignKey', 'ManyToManyField'
        """
        ...
        try:
            ...
            logger.error(e)
            representation = getattr(field, 'verbose_name', field.name)
