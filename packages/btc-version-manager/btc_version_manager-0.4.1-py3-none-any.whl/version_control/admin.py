...
from version_control.models import ModelObjectVersion, ModelObjectVersionGroup, TemplateProcessor
...
class ModelObjectVersionAdmin(admin.ModelAdmin):
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        template_processor = TemplateProcessor([previous_version, version])
