...
class EstimatorManager(object):
    ...
    def build_estimator(self):
        ...
        if self.args['ps'] > 0 and self.args['tw'] > 0:
            if distribution_strategy == 'ParameterServerStrategy':
                ...
                self.run_conf.update({'eval_distribute': tf.contrib.distribute.ParameterServerStrategy()})
    ...
    def model_fn(self, features, labels, mode, params):
        ...
        if DEBUG:
            ...
            hook = [tf.estimator.ProfilerHook(save_steps=100000, output_dir=self.train_conf['profile_dir'], show_memory=True)]
