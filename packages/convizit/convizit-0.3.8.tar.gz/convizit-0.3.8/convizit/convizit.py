...
class Convizit:
    ...
    def __execute_request(self, method, url, data=None, params=None, headers=None):
        if headers is None:
            headers = {}
        if params is None:
            params = {}
        ...
        request = requests.request(
            method, request_url, data=data, params=params, headers=headers)
        return request.json()
    ...
    def get_events(self, **kwargs):
        ...
        """
        response = self.__execute_request('POST', '/activity/getevents', params=kwargs)
        return response
    ...
    def get_sessions(self, **kwargs):
        ...
        :return: list of dictionaries
        """
        response = self.__execute_request('POST', '/activity/getsessions', params=kwargs)
        return response
    ...
    def get_visits(self, **kwargs):
        ...
        :return: list of dictionaries
        """
        response = self.__execute_request('POST', '/activity/getpageviews', params=kwargs)
        return response
    ...
    def get_elements(self, **kwargs):
        ...
        :return: list of dictionaries
        """
        response = self.__execute_request('POST', '/activity/getelements', params=kwargs)
        return response
    ...
    def get_pages(self, **kwargs):
        ...
        :return: list of dictionaries
        """
        response = self.__execute_request('POST', '/activity/getpages', params=kwargs)
        return response
