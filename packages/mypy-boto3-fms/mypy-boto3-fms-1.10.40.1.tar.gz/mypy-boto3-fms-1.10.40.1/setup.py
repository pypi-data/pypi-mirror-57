...
setup(
    ...
    description="Type annotations for boto3.FMS 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 fms type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
