...
Mypy-friendly auto-generated type annotations for `boto3 fms 1.10.33` service.
...
client: fms.Client = boto3.client("fms")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: fms.Client = session.client("fms")
