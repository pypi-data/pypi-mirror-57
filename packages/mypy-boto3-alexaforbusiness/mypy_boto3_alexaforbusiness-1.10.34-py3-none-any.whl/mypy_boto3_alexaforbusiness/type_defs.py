...
ListBusinessReportSchedulesPaginatePaginationConfigTypeDef = TypedDict(
    "ListBusinessReportSchedulesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesContentRangeTypeDef = TypedDict(
    "ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesContentRangeTypeDef",
    {"Interval": Literal["ONE_DAY", "ONE_WEEK", "THIRTY_DAYS"]},
    total=False,
)

ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesLastBusinessReportS3LocationTypeDef = TypedDict(
    "ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesLastBusinessReportS3LocationTypeDef",
    {"Path": str, "BucketName": str},
    total=False,
)

ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesLastBusinessReportTypeDef = TypedDict(
...
ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesRecurrenceTypeDef = TypedDict(
    "ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesRecurrenceTypeDef",
    {"StartDate": str},
    total=False,
)

ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesTypeDef = TypedDict(
...
ListBusinessReportSchedulesPaginateResponseTypeDef = TypedDict(
...
ListConferenceProvidersPaginatePaginationConfigTypeDef = TypedDict(
    "ListConferenceProvidersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListConferenceProvidersPaginateResponseConferenceProvidersIPDialInTypeDef = TypedDict(
    "ListConferenceProvidersPaginateResponseConferenceProvidersIPDialInTypeDef",
    {"Endpoint": str, "CommsProtocol": Literal["SIP", "SIPS", "H323"]},
    total=False,
)

ListConferenceProvidersPaginateResponseConferenceProvidersMeetingSettingTypeDef = TypedDict(
    "ListConferenceProvidersPaginateResponseConferenceProvidersMeetingSettingTypeDef",
    {"RequirePin": Literal["YES", "NO", "OPTIONAL"]},
    total=False,
)

ListConferenceProvidersPaginateResponseConferenceProvidersPSTNDialInTypeDef = TypedDict(
    "ListConferenceProvidersPaginateResponseConferenceProvidersPSTNDialInTypeDef",
    {"CountryCode": str, "PhoneNumber": str, "OneClickIdDelay": str, "OneClickPinDelay": str},
    total=False,
)

ListConferenceProvidersPaginateResponseConferenceProvidersTypeDef = TypedDict(
...
ListConferenceProvidersPaginateResponseTypeDef = TypedDict(
...
ListDeviceEventsPaginateResponseDeviceEventsTypeDef = TypedDict(
...
ListSkillsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSkillsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSkillsPaginateResponseSkillSummariesTypeDef = TypedDict(
...
ListSkillsPaginateResponseTypeDef = TypedDict(
    "ListSkillsPaginateResponseTypeDef",
    {"SkillSummaries": List[ListSkillsPaginateResponseSkillSummariesTypeDef]},
    total=False,
)

ListSkillsStoreCategoriesPaginatePaginationConfigTypeDef = TypedDict(
    "ListSkillsStoreCategoriesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSkillsStoreCategoriesPaginateResponseCategoryListTypeDef = TypedDict(
    "ListSkillsStoreCategoriesPaginateResponseCategoryListTypeDef",
    {"CategoryId": int, "CategoryName": str},
    total=False,
)

ListSkillsStoreCategoriesPaginateResponseTypeDef = TypedDict(
...
ListSkillsStoreSkillsByCategoryPaginatePaginationConfigTypeDef = TypedDict(
    "ListSkillsStoreSkillsByCategoryPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetailsDeveloperInfoTypeDef = TypedDict(
    "ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetailsDeveloperInfoTypeDef",
    {"DeveloperName": str, "PrivacyPolicy": str, "Email": str, "Url": str},
    total=False,
)

ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetailsTypeDef = TypedDict(
...
ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsTypeDef = TypedDict(
...
ListSkillsStoreSkillsByCategoryPaginateResponseTypeDef = TypedDict(
...
ListSmartHomeAppliancesPaginatePaginationConfigTypeDef = TypedDict(
    "ListSmartHomeAppliancesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSmartHomeAppliancesPaginateResponseSmartHomeAppliancesTypeDef = TypedDict(
    "ListSmartHomeAppliancesPaginateResponseSmartHomeAppliancesTypeDef",
    {"FriendlyName": str, "Description": str, "ManufacturerName": str},
    total=False,
)

ListSmartHomeAppliancesPaginateResponseTypeDef = TypedDict(
...
SearchDevicesPaginatePaginationConfigTypeDef = TypedDict(
    "SearchDevicesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

SearchDevicesPaginateResponseDevicesDeviceStatusInfoDeviceStatusDetailsTypeDef = TypedDict(
...
SearchDevicesPaginateResponseDevicesDeviceStatusInfoTypeDef = TypedDict(
...
SearchDevicesPaginateResponseDevicesTypeDef = TypedDict(
...
SearchDevicesPaginateResponseTypeDef = TypedDict(
...
SearchProfilesPaginatePaginationConfigTypeDef = TypedDict(
    "SearchProfilesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

SearchProfilesPaginateResponseProfilesTypeDef = TypedDict(
...
SearchProfilesPaginateResponseTypeDef = TypedDict(
...
SearchRoomsPaginatePaginationConfigTypeDef = TypedDict(
    "SearchRoomsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

SearchRoomsPaginateResponseRoomsTypeDef = TypedDict(
...
SearchRoomsPaginateResponseTypeDef = TypedDict(
...
SearchSkillGroupsPaginatePaginationConfigTypeDef = TypedDict(
    "SearchSkillGroupsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

SearchSkillGroupsPaginateResponseSkillGroupsTypeDef = TypedDict(
    "SearchSkillGroupsPaginateResponseSkillGroupsTypeDef",
    {"SkillGroupArn": str, "SkillGroupName": str, "Description": str},
    total=False,
)

SearchSkillGroupsPaginateResponseTypeDef = TypedDict(
...
SearchUsersPaginatePaginationConfigTypeDef = TypedDict(
    "SearchUsersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

SearchUsersPaginateResponseUsersTypeDef = TypedDict(
...
SearchUsersPaginateResponseTypeDef = TypedDict(
