...
setup(
    ...
    description="Type annotations for boto3.AlexaForBusiness 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 alexaforbusiness type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
