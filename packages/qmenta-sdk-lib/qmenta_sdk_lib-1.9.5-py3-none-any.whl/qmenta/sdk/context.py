...
class AnalysisContext:
    ...
    def __init__(self, analysis_id, comm):
        ...
        self.__initial_chunk_retry_wait_time = 0.25  # seconds
        self.__max_chunk_retries = 8  # 0.5, 1 ... 64 seconds
    ...
    def __valid_upload_response(self, response, accumulated_bytes, total_bytes):
    ...
    def upload_file(
        ...
        with open(source_file_path, "rb") as file_object:
            ...
            while (data or chunk_num == 0) and chunk_retry_count <= self.__max_chunk_retries:
                ...
                logger.debug("Chunk size is {}".format(self.__comm.chunk_size))
