...
Mypy-friendly auto-generated type annotations for `boto3 datasync 1.10.33` service.
...
client: datasync.Client = boto3.client("datasync")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: datasync.Client = session.client("datasync")
