...
ListAgentsPaginatePaginationConfigTypeDef = TypedDict(
    "ListAgentsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListAgentsPaginateResponseAgentsTypeDef = TypedDict(
    "ListAgentsPaginateResponseAgentsTypeDef",
    {"AgentArn": str, "Name": str, "Status": Literal["ONLINE", "OFFLINE"]},
    total=False,
)

ListAgentsPaginateResponseTypeDef = TypedDict(
    "ListAgentsPaginateResponseTypeDef",
    {"Agents": List[ListAgentsPaginateResponseAgentsTypeDef]},
    total=False,
)

ListLocationsPaginatePaginationConfigTypeDef = TypedDict(
    "ListLocationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListLocationsPaginateResponseLocationsTypeDef = TypedDict(
    "ListLocationsPaginateResponseLocationsTypeDef",
    {"LocationArn": str, "LocationUri": str},
    total=False,
)

ListLocationsPaginateResponseTypeDef = TypedDict(
...
ListTaskExecutionsPaginatePaginationConfigTypeDef = TypedDict(
    "ListTaskExecutionsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListTaskExecutionsPaginateResponseTaskExecutionsTypeDef = TypedDict(
...
ListTaskExecutionsPaginateResponseTypeDef = TypedDict(
...
ListTasksPaginateResponseTasksTypeDef = TypedDict(
