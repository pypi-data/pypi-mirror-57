...
def get_list_bulk_deployment_detailed_reports_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_bulk_deployment_detailed_reports')`, returns a correct
    type.
    """
...
def get_list_connector_definition_versions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_connector_definition_versions')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_connector_definitions_paginator(client: Client) -> ListConnectorDefinitionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_device_definitions_paginator(client: Client) -> ListDeviceDefinitionsPaginator:
    """
...
def get_list_function_definition_versions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_function_definition_versions')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_function_definitions_paginator(client: Client) -> ListFunctionDefinitionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_logger_definitions_paginator(client: Client) -> ListLoggerDefinitionsPaginator:
    """
...
def get_list_resource_definition_versions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_resource_definition_versions')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_resource_definitions_paginator(client: Client) -> ListResourceDefinitionsPaginator:
    """
...
def get_list_subscription_definition_versions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('list_subscription_definition_versions')`, returns a correct
    type.
    """
