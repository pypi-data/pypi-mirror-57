...
class DBClusterSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_cluster_snapshot_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_cluster_snapshot_available.wait)
        """
...
class DBClusterSnapshotDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_cluster_snapshot_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_cluster_snapshot_deleted.wait)
        """
...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_instance_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_instance_available.wait)
        """
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_instance_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_instance_deleted.wait)
        """
...
class DBSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_snapshot_available.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_snapshot_available.wait)
        """
...
class DBSnapshotCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_snapshot_completed.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_snapshot_completed.wait)
        """
...
class DBSnapshotDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [db_snapshot_deleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/rds.html#RDS.Waiter.db_snapshot_deleted.wait)
        """
