...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_certificates_paginator(client: Client) -> DescribeCertificatesPaginator:
    """
...
def get_describe_custom_availability_zones_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_custom_availability_zones')`, returns a correct
    type.
    """
...
def get_describe_db_cluster_parameter_groups_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_db_cluster_parameter_groups')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_engine_versions_paginator(client: Client) -> DescribeDBEngineVersionsPaginator:
    """
...
def get_describe_db_instance_automated_backups_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_db_instance_automated_backups')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_parameters_paginator(client: Client) -> DescribeDBParametersPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_proxies_paginator(client: Client) -> DescribeDBProxiesPaginator:
    """
    Equivalent of `client.get_paginator('describe_db_proxies')`, returns a correct type.
    """
    return client.get_paginator("describe_db_proxies")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_proxy_target_groups_paginator(
    client: Client,
) -> DescribeDBProxyTargetGroupsPaginator:
    """
    Equivalent of `client.get_paginator('describe_db_proxy_target_groups')`, returns a correct type.
    """
    return client.get_paginator("describe_db_proxy_target_groups")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_proxy_targets_paginator(client: Client) -> DescribeDBProxyTargetsPaginator:
    """
    Equivalent of `client.get_paginator('describe_db_proxy_targets')`, returns a correct type.
    """
    return client.get_paginator("describe_db_proxy_targets")


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_security_groups_paginator(client: Client) -> DescribeDBSecurityGroupsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_db_subnet_groups_paginator(client: Client) -> DescribeDBSubnetGroupsPaginator:
    """
...
def get_describe_engine_default_cluster_parameters_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_engine_default_cluster_parameters')`, returns a
    correct type.
    """
...
def get_describe_engine_default_parameters_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_engine_default_parameters')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_global_clusters_paginator(client: Client) -> DescribeGlobalClustersPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_installation_media_paginator(client: Client) -> DescribeInstallationMediaPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_option_groups_paginator(client: Client) -> DescribeOptionGroupsPaginator:
    """
...
def get_describe_orderable_db_instance_options_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_orderable_db_instance_options')`, returns a
    correct type.
    """
...
def get_describe_pending_maintenance_actions_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_pending_maintenance_actions')`, returns a correct
    type.
    """
...
def get_describe_reserved_db_instances_offerings_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_reserved_db_instances_offerings')`, returns a
    correct type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_source_regions_paginator(client: Client) -> DescribeSourceRegionsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_download_db_log_file_portion_paginator(client: Client) -> DownloadDBLogFilePortionPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_db_cluster_snapshot_available_waiter(client: Client) -> DBClusterSnapshotAvailableWaiter:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_db_cluster_snapshot_deleted_waiter(client: Client) -> DBClusterSnapshotDeletedWaiter:
    """
