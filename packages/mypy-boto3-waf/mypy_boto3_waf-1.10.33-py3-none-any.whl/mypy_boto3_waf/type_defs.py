"Main interface for waf service type defs"
...
GetRateBasedRuleManagedKeysPaginatePaginationConfigTypeDef = TypedDict(
    "GetRateBasedRuleManagedKeysPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "StartingToken": str},
    total=False,
)

GetRateBasedRuleManagedKeysPaginateResponseTypeDef = TypedDict(
    "GetRateBasedRuleManagedKeysPaginateResponseTypeDef",
    {"ManagedKeys": List[str], "NextToken": str},
    total=False,
)

ListActivatedRulesInRuleGroupPaginatePaginationConfigTypeDef = TypedDict(
    "ListActivatedRulesInRuleGroupPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesActionTypeDef = TypedDict(
    "ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesActionTypeDef",
    {"Type": Literal["BLOCK", "ALLOW", "COUNT"]},
    total=False,
)

ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesExcludedRulesTypeDef = TypedDict(
    "ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesExcludedRulesTypeDef",
    {"RuleId": str},
    total=False,
)

ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesOverrideActionTypeDef = TypedDict(
    "ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesOverrideActionTypeDef",
    {"Type": Literal["NONE", "COUNT"]},
    total=False,
)

ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesTypeDef = TypedDict(
...
ListActivatedRulesInRuleGroupPaginateResponseTypeDef = TypedDict(
...
ListByteMatchSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListByteMatchSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListByteMatchSetsPaginateResponseByteMatchSetsTypeDef = TypedDict(
    "ListByteMatchSetsPaginateResponseByteMatchSetsTypeDef",
    {"ByteMatchSetId": str, "Name": str},
    total=False,
)

ListByteMatchSetsPaginateResponseTypeDef = TypedDict(
...
ListGeoMatchSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListGeoMatchSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListGeoMatchSetsPaginateResponseGeoMatchSetsTypeDef = TypedDict(
    "ListGeoMatchSetsPaginateResponseGeoMatchSetsTypeDef",
    {"GeoMatchSetId": str, "Name": str},
    total=False,
)

ListGeoMatchSetsPaginateResponseTypeDef = TypedDict(
...
ListIPSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListIPSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListIPSetsPaginateResponseIPSetsTypeDef = TypedDict(
    "ListIPSetsPaginateResponseIPSetsTypeDef", {"IPSetId": str, "Name": str}, total=False
)

ListIPSetsPaginateResponseTypeDef = TypedDict(
    "ListIPSetsPaginateResponseTypeDef",
    {"IPSets": List[ListIPSetsPaginateResponseIPSetsTypeDef], "NextToken": str},
    total=False,
)

ListLoggingConfigurationsPaginatePaginationConfigTypeDef = TypedDict(
    "ListLoggingConfigurationsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListLoggingConfigurationsPaginateResponseLoggingConfigurationsRedactedFieldsTypeDef = TypedDict(
...
ListLoggingConfigurationsPaginateResponseLoggingConfigurationsTypeDef = TypedDict(
...
ListLoggingConfigurationsPaginateResponseTypeDef = TypedDict(
...
ListRateBasedRulesPaginatePaginationConfigTypeDef = TypedDict(
    "ListRateBasedRulesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRateBasedRulesPaginateResponseRulesTypeDef = TypedDict(
    "ListRateBasedRulesPaginateResponseRulesTypeDef", {"RuleId": str, "Name": str}, total=False
)

ListRateBasedRulesPaginateResponseTypeDef = TypedDict(
    "ListRateBasedRulesPaginateResponseTypeDef",
    {"Rules": List[ListRateBasedRulesPaginateResponseRulesTypeDef], "NextToken": str},
    total=False,
)

ListRegexMatchSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListRegexMatchSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRegexMatchSetsPaginateResponseRegexMatchSetsTypeDef = TypedDict(
    "ListRegexMatchSetsPaginateResponseRegexMatchSetsTypeDef",
    {"RegexMatchSetId": str, "Name": str},
    total=False,
)

ListRegexMatchSetsPaginateResponseTypeDef = TypedDict(
...
ListRegexPatternSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListRegexPatternSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRegexPatternSetsPaginateResponseRegexPatternSetsTypeDef = TypedDict(
    "ListRegexPatternSetsPaginateResponseRegexPatternSetsTypeDef",
    {"RegexPatternSetId": str, "Name": str},
    total=False,
)

ListRegexPatternSetsPaginateResponseTypeDef = TypedDict(
...
ListRuleGroupsPaginatePaginationConfigTypeDef = TypedDict(
    "ListRuleGroupsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListRuleGroupsPaginateResponseRuleGroupsTypeDef = TypedDict(
    "ListRuleGroupsPaginateResponseRuleGroupsTypeDef",
    {"RuleGroupId": str, "Name": str},
    total=False,
)

ListRuleGroupsPaginateResponseTypeDef = TypedDict(
...
ListRulesPaginateResponseRulesTypeDef = TypedDict(
    "ListRulesPaginateResponseRulesTypeDef", {"RuleId": str, "Name": str}, total=False
)
...
ListSizeConstraintSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSizeConstraintSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSizeConstraintSetsPaginateResponseSizeConstraintSetsTypeDef = TypedDict(
    "ListSizeConstraintSetsPaginateResponseSizeConstraintSetsTypeDef",
    {"SizeConstraintSetId": str, "Name": str},
    total=False,
)

ListSizeConstraintSetsPaginateResponseTypeDef = TypedDict(
...
ListSqlInjectionMatchSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSqlInjectionMatchSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSqlInjectionMatchSetsPaginateResponseSqlInjectionMatchSetsTypeDef = TypedDict(
    "ListSqlInjectionMatchSetsPaginateResponseSqlInjectionMatchSetsTypeDef",
    {"SqlInjectionMatchSetId": str, "Name": str},
    total=False,
)

ListSqlInjectionMatchSetsPaginateResponseTypeDef = TypedDict(
...
ListSubscribedRuleGroupsPaginatePaginationConfigTypeDef = TypedDict(
    "ListSubscribedRuleGroupsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListSubscribedRuleGroupsPaginateResponseRuleGroupsTypeDef = TypedDict(
    "ListSubscribedRuleGroupsPaginateResponseRuleGroupsTypeDef",
    {"RuleGroupId": str, "Name": str, "MetricName": str},
    total=False,
)

ListSubscribedRuleGroupsPaginateResponseTypeDef = TypedDict(
...
ListWebACLsPaginatePaginationConfigTypeDef = TypedDict(
    "ListWebACLsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListWebACLsPaginateResponseWebACLsTypeDef = TypedDict(
    "ListWebACLsPaginateResponseWebACLsTypeDef", {"WebACLId": str, "Name": str}, total=False
)

ListWebACLsPaginateResponseTypeDef = TypedDict(
    "ListWebACLsPaginateResponseTypeDef",
    {"WebACLs": List[ListWebACLsPaginateResponseWebACLsTypeDef], "NextToken": str},
    total=False,
)

ListXssMatchSetsPaginatePaginationConfigTypeDef = TypedDict(
    "ListXssMatchSetsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListXssMatchSetsPaginateResponseXssMatchSetsTypeDef = TypedDict(
    "ListXssMatchSetsPaginateResponseXssMatchSetsTypeDef",
    {"XssMatchSetId": str, "Name": str},
    total=False,
)

ListXssMatchSetsPaginateResponseTypeDef = TypedDict(
