...
setup(
    ...
    description="Type annotations for boto3.IoTJobsDataPlane 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 iot-jobs-data type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
