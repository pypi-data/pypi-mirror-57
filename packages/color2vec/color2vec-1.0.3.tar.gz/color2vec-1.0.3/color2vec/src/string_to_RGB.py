...
np.random.seed(10)
data_1 = pd.read_csv('data/colors_1.csv')
data_2 = pd.read_csv('data/basic.csv')
del data_2['Hex']
data_3 = pd.read_csv('data/advanced.csv')
del data_3['Hex']
data_4 = pd.read_csv('data/pantone.csv')
del data_4['Hex']
data_5 = pd.read_csv('data/ultra_basic.csv')
del data_5['Hex']
...
model.load_weights("model/string_to_rgb_model.h5")
model.summary()
