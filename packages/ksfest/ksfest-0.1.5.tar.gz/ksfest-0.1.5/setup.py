...
setup(
    ...
    install_requires=['numpy>=1.15','pandas>=0.19','scipy>=0.18','tqdm>=4.38.0', 'matplotlib', 'click>=7.0'],
    license="MIT license",
    ...
    download_url="https://github.com/oristides/ksfest/archive/0.1.5.tar.gz",
    version='0.1.5',
    zip_safe=False,
)
