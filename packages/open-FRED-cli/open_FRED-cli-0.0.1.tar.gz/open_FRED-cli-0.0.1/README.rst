...
.. |commits-since| image:: https://img.shields.io/github/commits-since/open-fred/cli/v0.0.1dev.svg
    :alt: Commits since latest release
    :target: https://github.com/open-fred/cli/compare/v0.0.1dev...master
