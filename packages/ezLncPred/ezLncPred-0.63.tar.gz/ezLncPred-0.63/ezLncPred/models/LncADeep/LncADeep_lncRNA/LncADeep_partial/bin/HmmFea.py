...
def RunHMM(fasta, output, pfam, thread=8):
    ...
    out1 = output + ".out1" 
    out2 = output + ".out2" 
    cmd = "./models/LncADeep/LncADeep_lncRNA/LncADeep_partial/bin/hmmer-3.2.1/src/hmmsearch -o " + out1 + " --domtblout " + out2 + " --noali -E 0.1 --domE 0.1 --cpu " + str(thread) + " " + pfam + " " + fasta
