...
def predict(range_file,model_file):
	os.system('./models/tools/libsvm/svm-scale -r '+ range_file + ' test.f_svm  > test.scaled ')
	os.system('./models/tools/libsvm/svm-predict -b 1 test.scaled ' + model_file +' tmp.txt >  tmp2.txt')
