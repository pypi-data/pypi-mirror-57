...
def main(args):
	...
	options = args
	options.hexamer_dat = 'ezLncPred/models/CPAT/dat/'+options.species+'_Hexamer.tsv' 	
	options.logit_model = 'ezLncPred/models/CPAT/dat/'+options.species+'_logitModel.RData'
	...
	#	
	#	for line in ireader.reader(options.fasta):
	#		count +=1
