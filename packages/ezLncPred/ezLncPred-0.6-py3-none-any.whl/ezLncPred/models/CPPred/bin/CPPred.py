...
def predict(range_file,model_file):
	os.system('ezLncPred/models/tools/libsvm/svm-scale -r '+ range_file + ' test.f_svm  > test.scaled ')
	os.system('ezLncPred/models/tools/libsvm/svm-predict -b 1 test.scaled ' + model_file +' tmp.txt >  tmp2.txt')
...
def main(args):
	...
	args.hexmar = 'ezLncPred/models/CPPred/Hexamer/'+args.species+'_Hexamer.tsv'
	args.range = 'ezLncPred/models/CPPred/'+args.species+'_Model/'+args.species+'.range'
	args.whichmodel = 'ezLncPred/models/CPPred/'+args.species+'_Model/'+args.species+'.model'
