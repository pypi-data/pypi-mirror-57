...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_affected_entities_paginator(client: Client) -> DescribeAffectedEntitiesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_event_aggregates_paginator(client: Client) -> DescribeEventAggregatesPaginator:
    """
