...
Mypy-friendly auto-generated type annotations for `boto3 health 1.10.34` service.
...
client: health.Client = boto3.client("health")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: health.Client = session.client("health")
