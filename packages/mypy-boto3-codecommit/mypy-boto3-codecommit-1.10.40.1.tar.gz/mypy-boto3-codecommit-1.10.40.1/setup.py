...
setup(
    ...
    description="Type annotations for boto3.CodeCommit 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 codecommit type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
