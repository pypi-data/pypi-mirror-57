...
class User(object):
    ...
    def name_first(self, value):
        logger.debug(f"Setting first name for user {self.id} to {value}")
    ...
    def name_last(self, value):
        logger.debug(f"Setting last name for user {self.id} to {value}")
    ...
    def addr1(self, value):
        logger.debug(f"Setting address line 1 for user {self.id} to {value}")
        self._addr1 = value
    ...
    def addr_city(self, value):
        logger.debug(f"Setting city for user {self.id} to {value}")
    ...
    def addr_state(self, value):
        logger.debug(f"Setting state for user {self.id} to {value}")
    ...
    def addr_zip(self, value):
        logger.debug(f"Setting zip code for user {self.id} to {value}")
    ...
    def phone_number(self, value):
        logger.debug(f"Setting phone number for user {self.id} to {value}")
