...
class ContainerImage(Image):
    ...
    * Custom Docker file for specific run commands
    ...
    .. remarks::
        ...
        The following sample shows how to create a :class:`azureml.core.image.container.ContainerImageConfig` object
        and use it with the Image class :meth:`azureml.core.image.Image.create` method.
        ...
        For more information about deploying images, see:

        * `Overview of deploying models with Azure Machine
          Learning <https://aka.ms/azureml-how-deploy>`_

        * `Deploy a model using a custom Docker base
          image <https://docs.microsoft.com/azure/machine-learning/service/how-to-deploy-custom-docker-image>`_
    """
    ...
    def image_configuration(execution_script, runtime, conda_file=None, docker_file=None, schema_file=None,
        ...
        .. remarks::
            ...
            The following sample shows how to create a :class:`azureml.core.image.container.ContainerImageConfig`
            object with this ``image_configuration`` method and use it with the
            Image class :meth:`azureml.core.image.Image.create` method.
