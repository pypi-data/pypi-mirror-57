...
Instances](https://docs.microsoft.com/azure/machine-learning/service/how-to-deploy-azure-container-instance).
"""
...
class AciWebservice(Webservice):
    ...
    .. remarks::
        ...
        A common deployment pattern is to create a configuration object with the ``deploy_configuration`` method
        and then use it with one of the ``deploy*`` methods of the base :class:`azureml.core.webservice.Webservice`
        ...
        https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/deployment/register-model-create-image-deploy-service/register-model-create-image-deploy-service.ipynb
        ...
        The example above deployed the service using an image. However, there are a number of ways to deploy,
        including with the:

        * ``deploy_from_image`` method of :class:`azureml.core.webservice.Webservice` as shown in the sample above.
        ...
        * `Consume an Azure Machine Learning model deployed
          as a web service <https://docs.microsoft.com/azure/machine-learning/service/how-to-consume-web-service>`_

        * `Monitor and collect data from ML web service
          endpoints <https://docs.microsoft.com/azure/machine-learning/service/how-to-enable-app-insights>`_

        * `Troubleshooting
          deployment <https://docs.microsoft.com/azure/machine-learning/service/how-to-troubleshoot-deployment>`_

    :param workspace: The workspace object containing the AciWebservice object to retrieve.
    :type workspace: azureml.core.Workspace
    :param name: The name of the AciWebservice object to retrieve.
    :type name: str
    """
