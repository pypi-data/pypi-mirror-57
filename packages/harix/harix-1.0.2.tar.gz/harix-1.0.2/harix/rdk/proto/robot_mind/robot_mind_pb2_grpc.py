...
from harix.rdk.proto.robot_mind import robot_mind_pb2 as rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2
...
class RobotSkillServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.EnableSkill = channel.unary_unary(
        ...
        request_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.EnableSkillRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.EnableSkillResponse.FromString,
        )
    self.HandleAction = channel.unary_unary(
        '/robotmind.RobotSkillService/HandleAction',
        request_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionResponse.FromString,
        )
...
def add_RobotSkillServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'EnableSkill': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.EnableSkillRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.EnableSkillResponse.SerializeToString,
      ),
      'HandleAction': grpc.unary_unary_rpc_method_handler(
          servicer.HandleAction,
          request_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionResponse.SerializeToString,
      ),
  }
...
class RobotMindServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RegisterSkill = channel.unary_unary(
        ...
        request_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.RegisterSkillRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionResponse.FromString,
        )
...
def add_RobotMindServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RegisterSkill': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.RegisterSkillRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__mind_dot_robot__mind__pb2.ActionResponse.SerializeToString,
      ),
