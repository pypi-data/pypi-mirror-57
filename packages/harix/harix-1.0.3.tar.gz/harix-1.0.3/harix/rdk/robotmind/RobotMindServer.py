...
接受Robot通知服务
"""
from harix.rdk.proto.robot_mind import robot_mind_pb2_grpc
...
class RobotMindServer(object):
    ...
    def StartServer(self):
        ...
        robot_mind_pb2_grpc.add_RobotMindServiceServicer_to_server(RobotMindService(self.callback), server)
