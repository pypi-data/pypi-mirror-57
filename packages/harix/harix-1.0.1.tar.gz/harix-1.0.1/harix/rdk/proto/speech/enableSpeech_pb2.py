...
# source: rdk/proto/speech/enableSpeech.proto
...
EnableRequest = _reflection.GeneratedProtocolMessageType('EnableRequest', (_message.Message,), {
  ...
  '__module__' : 'rdk.proto.speech.enableSpeech_pb2'
