...
from harix.rdk.proto.robot_skill_api import robot_control_api_pb2 as rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2
...
class RobotControlServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.RebootRcu = channel.unary_unary(
        ...
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    ...
    self.DoIntent = channel.unary_unary(
        ...
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.IntentRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    self.DoAction = channel.unary_unary(
        '/robotSkillApi.RobotControlService/DoAction',
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.ActionRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    self.SendData = channel.unary_unary(
        '/robotSkillApi.RobotControlService/SendData',
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.SendDataRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    self.Move = channel.unary_unary(
        '/robotSkillApi.RobotControlService/Move',
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.MoveRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    ...
    self.Rotate = channel.unary_unary(
        ...
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RotateRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    self.SetPosition = channel.unary_unary(
        '/robotSkillApi.RobotControlService/SetPosition',
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.PositionRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
    self.EmergencyStop = channel.unary_unary(
        '/robotSkillApi.RobotControlService/EmergencyStop',
        request_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.EmergencyStopRequest.SerializeToString,
        response_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.FromString,
        )
...
def add_RobotControlServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'RebootRcu': grpc.unary_unary_rpc_method_handler(
          servicer.RebootRcu,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      ...
      'DoIntent': grpc.unary_unary_rpc_method_handler(
          servicer.DoIntent,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.IntentRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      'DoAction': grpc.unary_unary_rpc_method_handler(
          servicer.DoAction,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.ActionRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      'SendData': grpc.unary_unary_rpc_method_handler(
          servicer.SendData,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.SendDataRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      'Move': grpc.unary_unary_rpc_method_handler(
          servicer.Move,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.MoveRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      ...
      'Rotate': grpc.unary_unary_rpc_method_handler(
          servicer.Rotate,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RotateRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      'SetPosition': grpc.unary_unary_rpc_method_handler(
          servicer.SetPosition,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.PositionRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
      'EmergencyStop': grpc.unary_unary_rpc_method_handler(
          servicer.EmergencyStop,
          request_deserializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.EmergencyStopRequest.FromString,
          response_serializer=rdk_dot_proto_dot_robot__skill__api_dot_robot__control__api__pb2.RobotResponse.SerializeToString,
      ),
  }
