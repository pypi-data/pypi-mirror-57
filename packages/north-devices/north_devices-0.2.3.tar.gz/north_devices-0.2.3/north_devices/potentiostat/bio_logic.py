...
"""
NOTE: This driver has been forked from https://github.com/CINF/PyExpLabSys/blob/master/PyExpLabSys/drivers/bio_logic.py,
this file is licensed as GPL3 and a separate license file has been provided in this folder.
