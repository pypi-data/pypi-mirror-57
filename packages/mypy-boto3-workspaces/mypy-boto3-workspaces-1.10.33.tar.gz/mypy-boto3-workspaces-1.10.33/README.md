...
Mypy-friendly auto-generated type annotations for `boto3 workspaces 1.10.33` service.
...
client: workspaces.Client = boto3.client("workspaces")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: workspaces.Client = session.client("workspaces")
