...
def boto3_client(
    ...
    if session is not None:
        return session.client("workspaces", **kwargs)
    return boto3.client("workspaces", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_account_modifications_paginator(
    client: Client,
) -> DescribeAccountModificationsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_ip_groups_paginator(client: Client) -> DescribeIpGroupsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_workspace_bundles_paginator(client: Client) -> DescribeWorkspaceBundlesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_workspace_directories_paginator(
    client: Client,
) -> DescribeWorkspaceDirectoriesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_workspace_images_paginator(client: Client) -> DescribeWorkspaceImagesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_workspaces_paginator(client: Client) -> DescribeWorkspacesPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_workspaces_connection_status_paginator(
    client: Client,
) -> DescribeWorkspacesConnectionStatusPaginator:
    """
    Equivalent of `client.get_paginator('describe_workspaces_connection_status')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_available_management_cidr_ranges_paginator(
    client: Client,
) -> ListAvailableManagementCidrRangesPaginator:
    """
    Equivalent of `client.get_paginator('list_available_management_cidr_ranges')`, returns a correct
    type.
    """
