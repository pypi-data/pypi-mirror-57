...
def search_file(url):
    ...
    with open(path, 'w') as outfile:
        outfile.write(file.read().decode('utf-8', errors="ignore"))
    return outfile.name
...
def read_raitings():
    ...
    [8.7, 'Forrest Gump']...
    """
    if not os.path.isfile('ratings.list'):
        search_file("ftp://ftp.cs.princeton.edu/pub/cs226/moviedb-3.24/lists/ratings.list")
