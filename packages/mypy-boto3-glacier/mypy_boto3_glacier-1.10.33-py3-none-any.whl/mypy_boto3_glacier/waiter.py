...
class VaultExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [vault_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/glacier.html#Glacier.Waiter.vault_exists.wait)
        """
...
class VaultNotExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [vault_not_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.33/reference/services/glacier.html#Glacier.Waiter.vault_not_exists.wait)
        """
