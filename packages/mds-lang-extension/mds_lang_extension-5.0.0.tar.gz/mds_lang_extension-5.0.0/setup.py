""" Tryton module to add many language definitions for Tryton
""" 
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Tryton module to add many language definitions for Tryton',
    ...
    keywords='tryton language country',
    ...
    package_data={
        'trytond.modules.%s' % MODULE: (info.get('xml', [])
            + ['tryton.cfg', 'README.rst','locale/*.po']),
        },
