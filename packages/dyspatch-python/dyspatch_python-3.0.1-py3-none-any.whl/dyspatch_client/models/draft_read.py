...
class DraftRead(object):
    ...
    def __init__(self, id=None, template=None, name=None, url=None, compiled=None, created_at=None, updated_at=None, localizations=None):  # noqa: E501
        """DraftRead - a model defined in Swagger"""  # noqa: E501
