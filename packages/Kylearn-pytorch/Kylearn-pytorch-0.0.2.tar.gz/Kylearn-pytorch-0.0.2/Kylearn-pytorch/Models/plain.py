...
class ShuffleSelfAttentionModel(Model):
    def __init__(
            self, save_path, log_path, d_features, n_depth, d_classifier, d_output, threshold=None,
            stack='ShuffleSelfAttention', expansion_layer='ChannelWiseConvExpansion', mode='1d', optimizer=None,
            **kwargs):
        '''*args: n_layers, n_channels, dropout, use_bottleneck, d_bottleneck'''
        ...
        self.model = stack_dict[stack](expansion_dict[expansion_layer], d_features, dropout=0.1, use_bottleneck=None, d_bottleneck=None, **kwargs)
