...
setup(
    ...
    description="Type annotations for boto3.IoTEventsData 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 iotevents-data type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
