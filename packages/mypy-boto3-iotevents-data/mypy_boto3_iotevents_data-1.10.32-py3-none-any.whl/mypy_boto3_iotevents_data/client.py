...
class Client(BaseClient):
    ...
    def batch_put_message(
        ...
        isn't guaranteed. To guarantee ordering, you must send messages one at a time and wait for a
        successful response.
                ...
                'BatchPutMessageErrorEntries': [
                    {
                        ...
                        |'InternalFailureException'|'ServiceUnavailableException'
                        |'ThrottlingException',
                        'errorMessage': 'string'
                    },
                ]
    ...
    def describe_detector(
        ...
        **Request Syntax**
        ...
        :param keyValue:
          ...
          A filter used to limit results to detectors (instances) created because of the given key
          ID.
