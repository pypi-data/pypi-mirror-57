...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v0.0.1-alpha.1575644278+g3eaccea'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v0.0.1-alpha.1575644278+g3eaccea`
                """)
            else:
                raise
