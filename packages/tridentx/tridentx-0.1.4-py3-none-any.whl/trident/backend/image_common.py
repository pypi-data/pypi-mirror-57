...
__all__ = ['read_image','read_mask','save_image','save_mask','image2array','array2image','mask2array','array2mask','list_pictures','normalize','resize','add_noise','backend_adaptive','random_channel_shift','random_cutout']
...
if _image_backend=='opencv':
    import opencv_backend as image_backend
else:
    import pillow_backend as mage_backend

read_image=image_backend.read_image
read_mask=image_backend.read_mask
save_image=image_backend.save_image
save_mask=image_backend.save_mask
image2array=image_backend.image2array
array2image=image_backend.array2image
mask2array=image_backend.mask2array
array2mask=image_backend.array2mask
