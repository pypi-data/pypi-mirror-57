...
class Ui_MicroPythonPage(object):
    def setupUi(self, MicroPythonPage):
        ...
        MicroPythonPage.setTabOrder(self.replWrapCheckBox, self.mpyCrossPicker)
        ...
        MicroPythonPage.setTabOrder(self.microbitFirmwareUrlLineEdit, self.micropythonDocuUrlLineEdit)
