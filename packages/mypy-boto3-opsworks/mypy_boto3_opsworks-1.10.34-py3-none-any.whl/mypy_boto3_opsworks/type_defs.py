...
AppExistsWaitWaiterConfigTypeDef = TypedDict(
    "AppExistsWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)
...
DescribeEcsClustersPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeEcsClustersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeEcsClustersPaginateResponseEcsClustersTypeDef = TypedDict(
    "DescribeEcsClustersPaginateResponseEcsClustersTypeDef",
    {"EcsClusterArn": str, "EcsClusterName": str, "StackId": str, "RegisteredAt": str},
    total=False,
)

DescribeEcsClustersPaginateResponseTypeDef = TypedDict(
    "DescribeEcsClustersPaginateResponseTypeDef",
    {"EcsClusters": List[DescribeEcsClustersPaginateResponseEcsClustersTypeDef]},
    total=False,
)

InstanceOnlineWaitWaiterConfigTypeDef = TypedDict(
    "InstanceOnlineWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)

InstanceRegisteredWaitWaiterConfigTypeDef = TypedDict(
    "InstanceRegisteredWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)
...
ServiceResourceCreateStackChefConfigurationTypeDef = TypedDict(
    "ServiceResourceCreateStackChefConfigurationTypeDef",
    {"ManageBerkshelf": bool, "BerkshelfVersion": str},
    total=False,
)

ServiceResourceCreateStackConfigurationManagerTypeDef = TypedDict(
    "ServiceResourceCreateStackConfigurationManagerTypeDef",
    {"Name": str, "Version": str},
    total=False,
)

ServiceResourceCreateStackCustomCookbooksSourceTypeDef = TypedDict(
...
StackCreateLayerCloudWatchLogsConfigurationLogStreamsTypeDef = TypedDict(
...
StackCreateLayerCloudWatchLogsConfigurationTypeDef = TypedDict(
...
StackCreateLayerCustomRecipesTypeDef = TypedDict(
...
StackCreateLayerLifecycleEventConfigurationShutdownTypeDef = TypedDict(
    "StackCreateLayerLifecycleEventConfigurationShutdownTypeDef",
    {"ExecutionTimeout": int, "DelayUntilElbConnectionsDrained": bool},
    total=False,
)

StackCreateLayerLifecycleEventConfigurationTypeDef = TypedDict(
