...
class AppExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [app_exists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.app_exists.wait)
        """
...
class DeploymentSuccessfulWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [deployment_successful.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.deployment_successful.wait)
        """
...
class InstanceOnlineWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_online.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.instance_online.wait)
        """
...
class InstanceRegisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_registered.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.instance_registered.wait)
        """
...
class InstanceStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_stopped.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.instance_stopped.wait)
        """
...
class InstanceTerminatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [instance_terminated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.34/reference/services/opsworks.html#OpsWorks.Waiter.instance_terminated.wait)
        """
