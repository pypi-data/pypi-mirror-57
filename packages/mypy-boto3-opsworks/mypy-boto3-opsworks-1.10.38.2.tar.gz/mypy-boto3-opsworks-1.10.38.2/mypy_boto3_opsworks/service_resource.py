...
class OpsWorksServiceResource(Boto3ServiceResource):
    """
    [OpsWorks.ServiceResource documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource)
    """
    ...
    def Layer(self, id: str) -> service_resource_scope.Layer:
        """
        [ServiceResource.Layer documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.Layer)
        """

    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def Stack(self, id: str) -> service_resource_scope.Stack:
        """
        [ServiceResource.Stack documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.Stack)
        """

    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def StackSummary(self, stack_id: str) -> service_resource_scope.StackSummary:
        """
        [ServiceResource.StackSummary documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.StackSummary)
        """
    ...
    def create_stack(
        ...
        """
        [ServiceResource.create_stack documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.create_stack)
        """

    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_available_subresources(self) -> List[str]:
        """
        [ServiceResource.get_available_subresources documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.get_available_subresources)
        """


class Layer(Boto3ServiceResource):
    """
    [Layer documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.Layer)
    """
...
class Stack(Boto3ServiceResource):
    """
    [Stack documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.Stack)
    """
...
class StackSummary(Boto3ServiceResource):
    """
    [StackSummary documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.StackSummary)
    """
...
class ServiceResourceStacksCollection(ResourceCollection):
    """
    [ServiceResource.stacks documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.ServiceResource.stacks)
    """
...
class StackLayersCollection(ResourceCollection):
    """
    [Stack.layers documentation](https://boto3.amazonaws.com/v1/documentation/api/1.10.38/reference/services/opsworks.html#OpsWorks.Stack.layers)
    """
