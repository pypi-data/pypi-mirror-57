...
from datalogue.models.regex import Regex, RegexShare, SearchOrder, RegexTestSample
...
class _RegexClient:
    ...
    def share(self, regex_id: UUID, target_id: UUID, target_type: Scope, permission: Permission) -> Union[
        ...
        url = f"/scout/regexes/{str(regex_id)}/shares?targetType={str(target_type.value)}&targetId={str(target_id)}&regexPermission={str(permission.value)}"
        ...
        return RegexShare.from_payload(res)
