...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.9.0-alpha.1576158081+gee2a720e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.9.0-alpha.1576158081+gee2a720e`
                """)
            else:
                raise
