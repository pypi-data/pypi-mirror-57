...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.8.0-alpha.1576144934+g57c6dddb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.8.0-alpha.1576144934+g57c6dddb`
                """)
            else:
                raise
