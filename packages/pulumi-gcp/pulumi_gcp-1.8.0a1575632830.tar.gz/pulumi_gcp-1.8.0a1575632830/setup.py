...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.8.0-alpha.1575632830+g9f7c44ed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.8.0-alpha.1575632830+g9f7c44ed`
                """)
            else:
                raise
