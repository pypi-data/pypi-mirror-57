...
def boto3_client(
    ...
    if session is not None:
        return session.client("mediaconnect", **kwargs)
    return boto3.client("mediaconnect", **kwargs)


# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_entitlements_paginator(client: Client) -> ListEntitlementsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_flows_paginator(client: Client) -> ListFlowsPaginator:
    """
