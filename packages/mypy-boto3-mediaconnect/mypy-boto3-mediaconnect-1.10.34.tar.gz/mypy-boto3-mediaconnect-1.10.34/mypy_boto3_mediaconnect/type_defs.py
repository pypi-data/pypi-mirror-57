...
ListEntitlementsPaginatePaginationConfigTypeDef = TypedDict(
    "ListEntitlementsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListEntitlementsPaginateResponseEntitlementsTypeDef = TypedDict(
    "ListEntitlementsPaginateResponseEntitlementsTypeDef",
    {"DataTransferSubscriberFeePercent": int, "EntitlementArn": str, "EntitlementName": str},
    total=False,
)

ListEntitlementsPaginateResponseTypeDef = TypedDict(
    "ListEntitlementsPaginateResponseTypeDef",
    {"Entitlements": List[ListEntitlementsPaginateResponseEntitlementsTypeDef]},
    total=False,
)

ListFlowsPaginatePaginationConfigTypeDef = TypedDict(
    "ListFlowsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListFlowsPaginateResponseFlowsTypeDef = TypedDict(
...
ListFlowsPaginateResponseTypeDef = TypedDict(
