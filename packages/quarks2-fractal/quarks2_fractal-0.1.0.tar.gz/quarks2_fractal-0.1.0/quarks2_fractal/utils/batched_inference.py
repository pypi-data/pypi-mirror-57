...
import pandas as pd
from segmentation_models_pytorch.engine.utils import get_config, get_model
from segmentation_models_pytorch.engine.infer import call_output_activation_func
from segmentation_models_pytorch.datasets.agu import get_transforms
from segmentation_models_pytorch.datasets.datasets import ImageFolder
...
@click.option("-csv", "--csv_path", required=True, help="path to save csv")
