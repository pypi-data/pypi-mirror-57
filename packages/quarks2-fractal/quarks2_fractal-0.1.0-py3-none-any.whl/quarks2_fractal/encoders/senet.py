from segmentation_models_pytorch.pretrainedmodels.models.senet import SENet
from segmentation_models_pytorch.pretrainedmodels.models.senet import SEBottleneck
from segmentation_models_pytorch.pretrainedmodels.models.senet import SEResNetBottleneck
from segmentation_models_pytorch.pretrainedmodels.models.senet import SEResNeXtBottleneck
from segmentation_models_pytorch.pretrainedmodels.models.senet import pretrained_settings
...
class SENetEncoder(SENet):
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        if "last_linear.weight" in state_dict.keys():
