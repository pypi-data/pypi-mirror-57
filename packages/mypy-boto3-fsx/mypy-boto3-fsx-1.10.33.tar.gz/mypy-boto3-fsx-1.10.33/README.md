...
Mypy-friendly auto-generated type annotations for `boto3 fsx 1.10.33` service.
...
client: fsx.Client = boto3.client("fsx")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: fsx.Client = session.client("fsx")
