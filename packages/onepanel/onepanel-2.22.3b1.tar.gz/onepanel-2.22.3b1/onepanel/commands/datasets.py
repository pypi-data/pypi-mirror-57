...
class UploadDataset:
    ...
    def __call__(self, vc, account_uid, dataset_uid, path='/', delete=False, directory=None, quiet=False, source=None):
        """
        :param vc:
...
def datasets_push(ctx, account, dataset, path, message, name, update_version,
                  quiet, background, watch, in_background, delete, source):
