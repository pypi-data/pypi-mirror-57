...
class API:
    ...
    def download_document(self, project_id: str, table_id: str, document_id: str, file_location: str, document_title: str = None):
    ...
    def record_create_withdocument(self, project_id: str, table_id: str, record: str, document_column_name: str, document_location, document_title: str = None):
        if document_title is None:
            document_title = document_location.split("/")[-1]
        ext = document_location.split(".")[-1]
        path = 'record'
