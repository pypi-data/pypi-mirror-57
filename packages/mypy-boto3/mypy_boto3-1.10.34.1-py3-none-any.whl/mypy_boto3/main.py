...
def main() -> None:
    ...
    for submodule in discovered_submodules:
        ...
        imports.append(
            "from mypy_boto3.{} import Client as {}Client".format(
        ...
        if submodule["has_resource"]:
            ...
            imports.append(
                "from mypy_boto3.{} import ServiceResource as {}ServiceResource".format(
                    submodule["import_name"], submodule["class_name"],
                )
            )
    ...
    init_contents = re.sub(r"### CLIENT.+### ENDCLIENT", client_string, init_contents, flags=re.S)
    session_contents = re.sub(
