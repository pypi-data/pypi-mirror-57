...
class Calendar(object):
    ...
    @staticmethod
    def holidayList(calendar, _from, to, includeWeekEnds=False):
        return _QuantLib.Calendar_holidayList(calendar, _from, to, includeWeekEnds)
...
def Calendar_holidayList(calendar, _from, to, includeWeekEnds=False):
    return _QuantLib.Calendar_holidayList(calendar, _from, to, includeWeekEnds)
...
# Register CalibrationHelperBase in _QuantLib:
_QuantLib.CalibrationHelperBase_swigregister(CalibrationHelperBase)
...
class UniformLowDiscrepancySequenceGenerator(object):
    ...
    def __init__(self, dimensionality):
        _QuantLib.UniformLowDiscrepancySequenceGenerator_swiginit(self, _QuantLib.new_UniformLowDiscrepancySequenceGenerator(dimensionality))
...
class FdmSquareRootFwdOp(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
