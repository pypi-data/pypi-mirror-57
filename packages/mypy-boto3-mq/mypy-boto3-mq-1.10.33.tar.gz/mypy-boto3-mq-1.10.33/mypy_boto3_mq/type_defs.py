...
ListBrokersPaginatePaginationConfigTypeDef = TypedDict(
    "ListBrokersPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListBrokersPaginateResponseBrokerSummariesTypeDef = TypedDict(
...
ListBrokersPaginateResponseTypeDef = TypedDict(
