...
Mypy-friendly auto-generated type annotations for `boto3 kinesisvideo 1.10.34` service.
...
client: kinesisvideo.Client = boto3.client("kinesisvideo")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: kinesisvideo.Client = session.client("kinesisvideo")
