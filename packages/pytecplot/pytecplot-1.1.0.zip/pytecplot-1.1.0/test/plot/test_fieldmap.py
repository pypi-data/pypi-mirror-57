...
class TestFieldmapCollection(unittest.TestCase):
    def setUp(self):
        tp.new_layout()
        ...
        self.assertIsInstance(self.fmap, tp.plot.Cartesian3DFieldmapCollection)
...
class TestCartesian2DFieldmapCollection(unittest.TestCase):
    def setUp(self):
        tp.new_layout()
        self.filename, self.dataset = sample_data('2x2x3_overlap')
        frame = tp.active_frame()
...
class TestCartesian3DFieldmapCollection(TestCartesian2DFieldmapCollection):
    def setUp(self):
        tp.new_layout()
        self.filename, self.dataset = sample_data('2x2x3_overlap')
        frame = tp.active_frame()
