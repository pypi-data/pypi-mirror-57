...
class StringWorker:
	...
	def get_info(self, filename, functions):
		...
		res += f"Functions amount     : {len(functions)}\n"
		res += f"Functions fully documentated: {all([1 for _ in functions if _['documentation']])}\n"
