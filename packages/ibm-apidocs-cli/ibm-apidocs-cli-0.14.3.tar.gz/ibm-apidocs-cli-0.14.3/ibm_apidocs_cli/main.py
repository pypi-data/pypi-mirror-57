...
def main():
    ...
    for openapi in args.openapi:
        ...
        process_openapi_file(openapi_file=openapi_abs, frontmatter_cli=frontmatter_cli, sdk_generator_cli=sdk_generator_cli,
                             ...
                             output_frontmatter_config=output_frontmatter_config, sdk_versions=sdk_versions, no_update=args.no_update,
...
def process_openapi_file(openapi_file=None, frontmatter_cli=None, sdk_generator_cli=None, templates_dir=None, output_folder=None, apidocs_dir=None, service_name=None, input_frontmatter_config=None, output_frontmatter_config=None, sdk_versions=None, no_update=None, frontmatter_md_file=None, keep_sdk=None, push=None, commit_msg=None):
    ...
    create_frontmatter_config_file(openapi_file=openapi_file, input_config_file=input_frontmatter_config,
                                   ...
                                   sdk_versions=sdk_versions, no_update=no_update)
...
def create_frontmatter_config_file(openapi_file=None, input_config_file=None, supported_languages=None, output_config_file=None, sdk_versions=None, no_update=False):
    '''
