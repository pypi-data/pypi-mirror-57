...
setup(
    ...
    description="Type annotations for boto3.ComprehendMedical 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 comprehendmedical type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
