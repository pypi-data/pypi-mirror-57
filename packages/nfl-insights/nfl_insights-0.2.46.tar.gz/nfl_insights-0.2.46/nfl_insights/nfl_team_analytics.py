        ...
        for statName, statDef in self.statsDict.items():
            ...
            for season in seasons:
                ...
                for _obj in objects: #, 'defenseTeam']:
                    ...
                    isAscending =  self.generator.is_ascending(obj=_object+'Player', statDef=statDef)
                            ...
                            for dim1 in _dimensionGroupsDict[dimGroup1]:
                                for dim2 in _dimensionGroupsDict[dimGroup2]:
                                    ...
                                    if _df.shape[0]>0:
                                        ...
                                        if statDef['Type']=='stat': # not ratio stat
...
def test():
    ...
    # print (ostats.get_stats_table(statName='CompletionRate', teamObject='kickingTeam', dimension='all', calculation='stat'))
    # return
