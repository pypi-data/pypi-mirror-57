...
def test():
    ...
    # return
    df = generator.pbp_get_stat(statName='yardsReturnedPunt', object='returnTeam', dimensions=['all', 'all'], season=NFL_DEFAULT_SEASON)
    df.sort_values('teamName', ascending=True, inplace=True)
    #df = generator.pbp_get_composed_stat('totalTD', 'offenseTeam', dimensions=['all', 'all'], season=NFL_DEFAULT_SEASON)
