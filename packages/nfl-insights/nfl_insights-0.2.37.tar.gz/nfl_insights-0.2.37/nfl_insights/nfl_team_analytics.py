...
class NFLTeamAnalytics:
    ...
    def get_stats_table(self, statName:str, teamObject: str, dimension: str, calculation: str, season=NFL_DEFAULT_SEASON) -> pd.DataFrame:
        ...
        return self.allStatsDict[_mainkey][_seckey]
...
def test():
    ...
    print (ostats.get_stats_table(statName='Interceptions', teamObject='defenseTeam', dimension='all', calculation='per_game'))
    return
