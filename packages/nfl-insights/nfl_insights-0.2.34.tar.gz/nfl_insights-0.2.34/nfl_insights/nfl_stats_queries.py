...
def test():
    ...
    # return
    df1 = generator.pbp_get_stat(statName='yardsReturnedPunt', object='returnTeam', dimensions=['returned', 'all'], season='2019-regular')
    df2 = generator.pbp_get_stat(statName='yardsReturnedPunt', object='returnTeam', dimensions=['returnedBack', 'all'], season='2019-regular')
    ...
    df['count-neg'] = df2['count']
    df['count-pos'] = df1['count']
    df['count-diff'] = df['count-pos'] - df['count-neg']
    df['count-zero'] = df['count'] - df['count-pos'] - df['count-neg']
