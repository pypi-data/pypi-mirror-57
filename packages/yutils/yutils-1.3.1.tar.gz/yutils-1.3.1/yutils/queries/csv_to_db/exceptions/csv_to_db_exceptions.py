...
class NoTableError(Exception):
    ...
    def __init__(self, table_name, owner):
        super(NoTableError, self).__init__(self._EXCEPTION_STR.format(table_name=table_name, owner=owner))
...
class BadDateFormatError(Exception):
    ...
    def __init__(self, date):
        super(BadDateFormatError, self).__init__(self._EXCEPTION_STR.format(date=date, date_formats=TIMESTAMP_FORMATS))
...
Known encodings:\n{encodings}"""
    ...
    def __init__(self, string):
        super(BadNVarCharFormatError, self).__init__(self._EXCEPTION_STR.format(string=string,
...
class MissingFieldError(Exception):
    ...
    def __init__(self, field_name, table_name):
        super(MissingFieldError, self).__init__(self._EXCEPTION_STR.format(field_name=field_name,
...
class DataInsertionCancelled(Exception):
    ...
    def __init__(self):
        super(DataInsertionCancelled, self).__init__(self._EXCEPTION_STR)
...
class NoTableDataError(Exception):
    ...
    def __init__(self):
        super(NoTableDataError, self).__init__(self._EXCEPTION_STR)
...
class NotThisDatatypeError(Exception):
    ...
    def __init__(self):
        super(NotThisDatatypeError, self).__init__(self._EXCEPTION_STR)
...
class TableCreationCancelled(Exception):
    ...
    def __init__(self):
        super(TableCreationCancelled, self).__init__(self._EXCEPTION_STR)
...
class NoInsertQuery(Exception):
    ...
    def __init__(self):
        super(NoInsertQuery, self).__init__(self._EXCEPTION_STR)
