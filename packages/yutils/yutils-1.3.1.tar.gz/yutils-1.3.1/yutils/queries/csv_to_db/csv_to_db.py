...
def insert_csv_to_db(connection_details, data_to_insert, data_to_insert_type='path', table_name=None, data_fields=None,
    ...
    :type data_to_insert_type: str/unicode
    ...
    :type data_fields: list of str/unicode
    ...
    :type duplicate_field_check: str/unicode
    ...
    :type other_user_for_select_permissions: str/unicode
