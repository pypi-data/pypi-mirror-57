...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_directory_configs_paginator(client: Client) -> DescribeDirectoryConfigsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_describe_image_builders_paginator(client: Client) -> DescribeImageBuildersPaginator:
    """
...
def get_describe_user_stack_associations_paginator(
    ...
    """
    Equivalent of `client.get_paginator('describe_user_stack_associations')`, returns a correct
    type.
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_associated_fleets_paginator(client: Client) -> ListAssociatedFleetsPaginator:
    """
...
# pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
def get_list_associated_stacks_paginator(client: Client) -> ListAssociatedStacksPaginator:
    """
