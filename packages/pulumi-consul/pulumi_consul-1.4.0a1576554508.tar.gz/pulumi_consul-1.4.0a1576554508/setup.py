...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.4.0-alpha.1576554508+g3362d0e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.4.0-alpha.1576554508+g3362d0e`
                """)
            else:
                raise
