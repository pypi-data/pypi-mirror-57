...
Mypy-friendly auto-generated type annotations for `boto3 macie 1.10.33` service.
...
client: macie.Client = boto3.client("macie")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: macie.Client = session.client("macie")
