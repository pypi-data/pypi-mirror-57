...
DescribeAddressesPaginatePaginationConfigTypeDef = TypedDict(
    "DescribeAddressesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

DescribeAddressesPaginateResponseAddressesTypeDef = TypedDict(
...
DescribeAddressesPaginateResponseTypeDef = TypedDict(
    "DescribeAddressesPaginateResponseTypeDef",
    {"Addresses": List[DescribeAddressesPaginateResponseAddressesTypeDef]},
    total=False,
)

ListClusterJobsPaginatePaginationConfigTypeDef = TypedDict(
    "ListClusterJobsPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListClusterJobsPaginateResponseJobListEntriesTypeDef = TypedDict(
...
ListClusterJobsPaginateResponseTypeDef = TypedDict(
...
ListClustersPaginateResponseClusterListEntriesTypeDef = TypedDict(
...
ListCompatibleImagesPaginatePaginationConfigTypeDef = TypedDict(
    "ListCompatibleImagesPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ListCompatibleImagesPaginateResponseCompatibleImagesTypeDef = TypedDict(
    "ListCompatibleImagesPaginateResponseCompatibleImagesTypeDef",
    {"AmiId": str, "Name": str},
    total=False,
)

ListCompatibleImagesPaginateResponseTypeDef = TypedDict(
...
ListJobsPaginateResponseJobListEntriesTypeDef = TypedDict(
