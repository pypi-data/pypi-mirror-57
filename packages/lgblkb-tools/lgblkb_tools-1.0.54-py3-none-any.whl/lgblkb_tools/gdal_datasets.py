...
class DataSet:
	...
	@logger.trace(skimpy=True)
	def to_geotiff(self,filepath,no_data_value='nan',dtype=gdal.GDT_Float32):
...
@logger.trace(level=logging.DEBUG)
def rgb_to_geotiff(tiff_path,*band_paths,no_data_value='nan',dtype=gdal.GDT_Float32,**warp_opts):
