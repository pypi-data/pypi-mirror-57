...
ExecuteProvisionedProductPlanOutputTypeDef = TypedDict(
    "ExecuteProvisionedProductPlanOutputTypeDef", {"RecordDetail": RecordDetailTypeDef}, total=False
)
...
ListProvisioningArtifactsOutputTypeDef = TypedDict(
    ...
    {"ProvisioningArtifactDetails": List[ProvisioningArtifactDetailTypeDef], "NextPageToken": str},
    total=False,
)
