...
setup(
    ...
    description="Type annotations for boto3.ApplicationInsights 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 application-insights type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
