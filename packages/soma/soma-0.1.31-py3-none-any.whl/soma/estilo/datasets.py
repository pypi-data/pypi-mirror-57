...
class Datasets:
    ...
    def create_sales(self):
        ...
        try:
            fixed_tags = pd.read_pickle("animale_tags.pkl")
        except:
        ...
        # throw an error.
        try:
            animale_df = pd.read_pickle(
                "data/animale_sales_{}D.pkl".format(self.n_days)
            )
        except:
            if not os.path.isdir('data'):
                ...
                utils.download_from_bucket(
                    ...
                    "data/animale_sales_{}D.pkl".format(self.n_days),
                    "data/raw/animale_sales_{}D.pkl".format(self.n_days),
                )
