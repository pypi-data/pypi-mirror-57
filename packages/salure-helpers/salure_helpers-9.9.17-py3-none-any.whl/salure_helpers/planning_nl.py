...
class PlanningNl(object):
    ...
    def push_human_recources(self, employee_id, job_number, job, department_number, department, first_name, last_name_prefix, last_name, phone_mobile, phone_fixed, street, zip_code, city, email, birth_date):
        client = Client('https://api.visibox.nl/v1/resource?wsdl')
        request_body = {
            'authentication': {
                'token': self.token
