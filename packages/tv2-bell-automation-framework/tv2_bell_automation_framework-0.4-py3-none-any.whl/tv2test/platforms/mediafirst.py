...
class MediaFirstHelper:
    ...
    def open_bell_app_launcher(self):
        ...
        def validate_bell_app_launcher():
            frame = self.dut.display.get_frame()
            template_support_icon = cv2.imread('templates/mediafirst/template_support_icon.png')
            template_youtube_icon = cv2.imread('templates/mediafirst/template_youtube_icon.png')
            template_netflix_icon = cv2.imread('templates/mediafirst/template_netflix_icon.png')
