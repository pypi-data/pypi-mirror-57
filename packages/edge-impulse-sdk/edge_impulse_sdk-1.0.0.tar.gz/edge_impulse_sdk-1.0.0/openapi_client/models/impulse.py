...
class Impulse(object):
    ...
    def window_increase_ms(self):
        ...
        We use a sliding window to go over the raw data. How many milliseconds to increase the sliding window with during classification for each step.  # noqa: E501
