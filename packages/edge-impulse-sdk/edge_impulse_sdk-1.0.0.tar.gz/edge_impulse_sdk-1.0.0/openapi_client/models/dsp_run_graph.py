...
class DspRunGraph(object):
    ...
    def __init__(self, name=None, image=None, x=None, y=None, suggested_x_min=None, suggested_x_max=None, suggested_y_min=None, suggested_y_max=None, type=None, local_vars_configuration=None):  # noqa: E501
