...
class GetUserResponse(object):
    ...
    def __init__(self, success=None, error=None, id=None, username=None, name=None, photo=None, created=None, email=None, activated=None, local_vars_configuration=None):  # noqa: E501
