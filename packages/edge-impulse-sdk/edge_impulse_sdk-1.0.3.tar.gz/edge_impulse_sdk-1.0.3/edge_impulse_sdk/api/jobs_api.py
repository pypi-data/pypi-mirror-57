...
class JobsApi(object):
    ...
    def build_on_device_model_job(self, project_id, type, build_on_device_model_request, **kwargs):  # noqa: E501
        ...
        Generate code to run the impulse on an embedded device. When this step is complete use `downloadBuild` to download the artefacts.  # noqa: E501
    ...
    def cancel_job(self, project_id, job_id, **kwargs):  # noqa: E501
        ...
        Cancel a running job. This can also be done through the web socket interface.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def generate_features_job(self, project_id, generate_features_request, **kwargs):  # noqa: E501
        ...
        Take the raw training set and generate features from them.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def retrain_job(self, project_id, **kwargs):  # noqa: E501
        """Retrain  # noqa: E501

        Retrains the current impulse with the last known parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrain_job(project_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.retrain_job_with_http_info(project_id, **kwargs)  # noqa: E501

    def retrain_job_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Retrain  # noqa: E501

        Retrains the current impulse with the last known parameters.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrain_job_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('project_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['project_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `project_id` when calling `retrain_job`")  # noqa: E501
    ...
    def train_anomaly_job(self, project_id, learn_id, start_training_request_anomaly, **kwargs):  # noqa: E501
        ...
        Take the output from a DSP block and train an anomaly detection model using K-means.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def train_keras_job(self, project_id, learn_id, start_training_request_keras, **kwargs):  # noqa: E501
        """Train model (Keras)  # noqa: E501

        Take the output from a DSP block and train a neural network using Keras.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.train_keras_job(project_id, learn_id, start_training_request_keras, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int project_id: Project ID (required)
        :param int learn_id: Learn Block ID, use the impulse functions to retrieve the ID (required)
        :param StartTrainingRequestKeras start_training_request_keras: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.train_keras_job_with_http_info(project_id, learn_id, start_training_request_keras, **kwargs)  # noqa: E501

    def train_keras_job_with_http_info(self, project_id, learn_id, start_training_request_keras, **kwargs):  # noqa: E501
        """Train model (Keras)  # noqa: E501

        Take the output from a DSP block and train a neural network using Keras.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.train_keras_job_with_http_info(project_id, learn_id, start_training_request_keras, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_id', 'learn_id', 'start_training_request_keras']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'start_training_request_keras' is set
        if self.api_client.client_side_validation and ('start_training_request_keras' not in local_var_params or  # noqa: E501
                                                        local_var_params['start_training_request_keras'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `start_training_request_keras` when calling `train_keras_job`")  # noqa: E501
        ...
        body_params = None
        if 'start_training_request_keras' in local_var_params:
            body_params = local_var_params['start_training_request_keras']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
