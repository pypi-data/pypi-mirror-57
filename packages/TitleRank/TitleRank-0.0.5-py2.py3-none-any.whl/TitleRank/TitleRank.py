...
from TitleRank.open import STOPWORDS
class TitleRank():
    def __init__(self, stopwords_path='TitleRank/data/stopwords.txt', userstopwords_path='TitleRank/data/user_stopwords.txt'):
        #导入停用词
        ...
        sp_path = 'TitleRank/models/news_title_8w.model'
        if not os.path.isfile(sp_path):
            raise Exception("news_title_8w.model: file does not exist: " + sp_path)
        self.sp.load(sp_path)
        self.sp_emb = self.load_models("TitleRank/embeddings/sp_title.emb")
