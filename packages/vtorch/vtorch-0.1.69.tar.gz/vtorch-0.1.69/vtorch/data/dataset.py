...
class Batch(Iterable):
    ...
    def index_instances(self, vocab: Vocabulary, fields_with_pretrained_tokenizers: List[str]) -> None:
        for instance in self.instances:
            instance.index_fields(vocab, fields_with_pretrained_tokenizers)
