...
Mypy-friendly auto-generated type annotations for `boto3 iot-data 1.10.33` service.
...
client: iot_data.Client = boto3.client("iot-data")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: iot_data.Client = session.client("iot-data")
