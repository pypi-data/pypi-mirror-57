...
-  Fixes
   `urlman <https://github.com/andrewgodwin/urlman>`__-compatability.

0.4.0 (May 2019)
----------------

-  Fixes ``initial_value(field_name)`` behavior - should return value
   even if no change. Thanks @adamJLev!
