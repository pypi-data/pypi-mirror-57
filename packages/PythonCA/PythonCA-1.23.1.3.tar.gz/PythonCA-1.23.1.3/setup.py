...
Version Info: (before 1.22)
  $HGTagShort: 1.23.1.3 $
  $lastlog: import new cas module from T.T.Nakamura $
...
CVSDate="$Date: 2019/11/26 01:31:30 $"
CVSRev="$Revision: 138f643a5b51 $"
CVSSource="$Header: /opt/epics/R314/modules/soft/kekb/python/PythonCA-dev/setup.py 138f643a5b51 2019/11/26 01:31:30 noboru $"
CVSFile="$Source: /opt/epics/R314/modules/soft/kekb/python/PythonCA-dev/setup.py $"
CVSId="$Id: setup.py 138f643a5b51 2019/11/26 01:31:30 noboru $"
#
HGTag="$HGTag: 1.23.1.3-138f643a5b51 $"
HGdate="$HGdate: Tue, 26 Nov 2019 10:31:30 +0900 $"
HGTagShort="$HGTagShort: 1.23.1.3 $"
HGlastlog="$lastlog: import new cas module from T.T.Nakamura $"
#
