...
class TSInsertReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i152 in range(_size148):
                        ...
                        self.measurements.append(_elem153)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.measurements is not None:
            oprot.writeFieldBegin('measurements', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.measurements))
            for iter160 in self.measurements:
...
class ServerProperties(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i173 in range(_size169):
                        ...
                        self.supportedTimeAggregationOperations.append(_elem174)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.supportedTimeAggregationOperations is not None:
            ...
            for iter175 in self.supportedTimeAggregationOperations:
