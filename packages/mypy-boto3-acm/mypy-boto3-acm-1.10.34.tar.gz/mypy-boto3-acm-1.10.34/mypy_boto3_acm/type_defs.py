...
CertificateValidatedWaitWaiterConfigTypeDef = TypedDict(
    "CertificateValidatedWaitWaiterConfigTypeDef", {"Delay": int, "MaxAttempts": int}, total=False
)
...
ListCertificatesPaginateIncludesTypeDef = TypedDict(
...
ListCertificatesPaginateResponseCertificateSummaryListTypeDef = TypedDict(
