...
Mypy-friendly auto-generated type annotations for `boto3 acm 1.10.34` service.
...
client: acm.Client = boto3.client("acm")

# works for session as well
session = boto3.session.Session(region="us-west-1")
session_client: acm.Client = session.client("acm")
