...
def run_example(device_ids, do_plot=False, synchronize=True):
    ...
    if do_plot:
        ...
        plt.plot(master_time*1E3, demod_r_master*1E3, color='blue')
        ...
        for prop in props[1:]:
            ...
            plt.plot(slave_time*1E3, slave_demod_r*1E3, color='red')
            axes2.legend(['Slaves'])
        ...
        for prop in props[1:]:
            ...
            slave_timestamp = result[slave_subscribe_node][0]['timestamp']
            slave_time = (slave_timestamp[0] - float(slave_timestamp[0][0])) / slave_clockbase
            plt.plot(slave_time*1E3, (master_time - slave_time)*1E3, color='green')
