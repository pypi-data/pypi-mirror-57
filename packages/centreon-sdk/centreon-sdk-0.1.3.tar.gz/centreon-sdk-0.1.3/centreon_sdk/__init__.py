...
from centreon_sdk.objects.base.service import ServiceParam

if __name__ == '__main__':
    import requests
    from requests.packages.urllib3.exceptions import InsecureRequestWarning
    requests.packages.urllib3.disable_warnings(InsecureRequestWarning)
    centreon = Centreon("REST", "fNAATYc4", "https://centreon.omikron.pw/centreon/api/index.php", verify=False)
    result = centreon.host_set_param("omikron.pw", HostParam.FLAP_DETECTION_OPTIONS, "")
