...
_Resp = Union[requests.Response, str]
...
def tranResponse(response: _Resp) -> NewResponse:
    newResp = NewResponse()
...
def request(method:str, url:str, adapter:HTTPAdapter=None, max_count:int=None,retry:int=None,
