...
setup(
    ...
    description="Type annotations for boto3.Route53Domains 1.10.40 service.",
    classifiers=[
    ...
    keywords="boto3 route53domains type-annotations boto3-stubs mypy mypy-stubs typeshed autocomplete auto-generated",
