...
ViewBillingPaginatePaginationConfigTypeDef = TypedDict(
    "ViewBillingPaginatePaginationConfigTypeDef",
    {"MaxItems": int, "PageSize": int, "StartingToken": str},
    total=False,
)

ViewBillingPaginateResponseBillingRecordsTypeDef = TypedDict(
...
ViewBillingPaginateResponseTypeDef = TypedDict(
