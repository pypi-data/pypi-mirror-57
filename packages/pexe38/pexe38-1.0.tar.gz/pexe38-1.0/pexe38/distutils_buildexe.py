...
##     #print "pexe38 extension module", __name__, "->", path
...
##         from pexe38.mf import ModuleFinder
...
##         thisfile = sys.modules['pexe38.build_exe'].__file__
...
##         cmdline_style = getattr(target, "cmdline_style", "pexe38")
##         if cmdline_style not in ["pexe38", "pywin32", "custom"]:
...
##             </assembly>
##         """
##         from pexe38_util import load_resource
...
##         from pexe38_util import add_resource, add_icon
...
##         from pexe38.resources.VersionInfo import Version, RT_VERSION, VersionError
...
##         from pexe38_util import add_resource
##         add_resource(ensure_unicode(exe_path), bytes, RT_VERSION, 1, False)

##     def patch_python_dll_winver(self, dll_name, new_winver = None):
##         from pexe38.resources.StringTables import StringTable, RT_STRING
##         from pexe38_util import add_resource, load_resource
##         from pexe38.resources.VersionInfo import RT_VERSION

##         new_winver = new_winver or self.distribution.metadata.name or "pexe38"
##         if self.verbose:
...
##         import pexe38_util
##         sysdir = pexe38_util.get_sysdir()
##         windir = pexe38_util.get_windir()
...
##         # imports done from builtin modules in C code (untrackable by pexe38)
...
##             # help pexe38 to include the dlls:
...
##                 for f in files:
##                     if self.bundle_files == 1 \
##                            and not os.path.splitext(f)[1].lower() in _py_suffixes + _c_suffixes:
##                         print "\tEXCLUDE:", f
##                         copy_file(os.path.join(base_dir, f),
##                                   os.path.join(self.dist_dir, f),
##                                   preserve_mode=0,
##                                   verbose=verbose,
##                                   dry_run=dry_run
##                                   )
...
##                 for result in pexe38_util.depends(image, loadpath).iteritems():
...
##             script.write("""\
## from pexe38.build_exe import byte_compile
## from modulefinder import Module
## files = [
## """)
