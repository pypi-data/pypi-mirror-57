...
pexe38 options, to be specified in the options keyword to the setup function:
...
"""
# 'import pexe38' imports this package, and two magic things happen:
#
# - the 'pexe38.build_exe' submodule is imported and installed as
#   'distutils.commands.pexe38' command
#
...
def patch_distutils():
    ...
    distutils.command.__all__.append('pexe38')

    sys.modules['distutils.command.pexe38'] = distutils_buildexe
