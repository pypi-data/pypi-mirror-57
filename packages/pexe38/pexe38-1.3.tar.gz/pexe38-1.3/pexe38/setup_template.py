...
#
# The pexe38 runtime *can* use extension module by directly importing
...
def write_setup(args):
    with open(args.setup_path, "w", encoding="utf-8") as ofi:
        ...
        created_by = " ".join([os.path.basename(sys.executable), "-m", "pexe38"] + sys.argv[1:])
