...
Mypy-friendly auto-generated type annotations for `boto3 kinesis-video-signaling 1.10.34` service.
...
```bash
pip install boto3-stubs[mypy-boto3-kinesis-video-signaling]
```
