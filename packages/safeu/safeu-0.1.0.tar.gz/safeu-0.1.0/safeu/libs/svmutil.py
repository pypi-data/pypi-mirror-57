...
__all__ = ['svm_load_model', 'svm_predict',
	'svm_save_model', 'svm_train'] + svm_all + common_all
...
def svm_train(arg1, arg2=None, arg3=None, arg4=None):
	...
	if isinstance(arg1, (list, tuple)) or (scipy and isinstance(arg1, scipy.ndarray)):
		...
		y, x, upbound, options = arg1, arg2, arg3, arg4
	...
	if predict_probability:
		...
		for i in range(nr_instance):
			if scipy and isinstance(x, sparse.spmatrix):
				...
				xi, idx = gen_svm_nodearray((x.indices[indslice], x.data[indslice]), isKernel=(
